...
struct X86MemInfo_T {
  enum {
    ...
    k67H   = ((B == X86Reg::kRegGpw  && I == X86Reg::kRegNone) ? kX86MemInfo_67H_X86   :
              ...
              (B == AsmLabel::kLabelTag && I == X86Reg::kRegGpw ) ? kX86MemInfo_67H_X86   :
              (B == AsmLabel::kLabelTag && I == X86Reg::kRegGpd ) ? kX86MemInfo_67H_X64   : 0),
...
EmitJmpCall:
  {
    ...
    if (rmRel->isLabel()) {
      label = _code->getLabelEntry(rmRel->as<AsmLabel>());
      if (!label) goto InvalidLabel;
