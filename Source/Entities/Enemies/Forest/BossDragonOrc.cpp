...
BossDragonOrc::BossDragonOrc() : Entity::Entity()
{
...
void BossDragonOrc::update(float dt)
{
	Entity::update(dt);
...
bool BossDragonOrc::contactBegin(CollisionData data)
{
	return false;
}

bool BossDragonOrc::contactUpdate(CollisionData data)
{
...
bool BossDragonOrc::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
