...
GoblinShaman::GoblinShaman() : Entity::Entity()
{
...
void GoblinShaman::update(float dt)
{
	Entity::update(dt);
...
bool GoblinShaman::contactBegin(CollisionData data)
{
	return false;
}

bool GoblinShaman::contactUpdate(CollisionData data)
{
...
bool GoblinShaman::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
