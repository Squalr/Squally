...
BoarGoblin::BoarGoblin() : Entity::Entity()
{
...
void BoarGoblin::update(float dt)
{
	Entity::update(dt);
...
bool BoarGoblin::contactBegin(CollisionData data)
{
	return false;
}

bool BoarGoblin::contactUpdate(CollisionData data)
{
...
bool BoarGoblin::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
