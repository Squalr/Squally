...
GoblinGrunt::GoblinGrunt() : Entity::Entity()
{
...
void GoblinGrunt::update(float dt)
{
	Entity::update(dt);
...
bool GoblinGrunt::contactBegin(CollisionData data)
{
	return false;
}

bool GoblinGrunt::contactUpdate(CollisionData data)
{
...
bool GoblinGrunt::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
