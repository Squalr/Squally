...
PigGoblin::PigGoblin() : Entity::Entity()
{
...
void PigGoblin::update(float dt)
{
	Entity::update(dt);
...
bool PigGoblin::contactBegin(CollisionData data)
{
	return false;
}

bool PigGoblin::contactUpdate(CollisionData data)
{
...
bool PigGoblin::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
