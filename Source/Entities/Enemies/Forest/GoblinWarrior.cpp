...
GoblinWarrior::GoblinWarrior() : Entity::Entity()
{
...
void GoblinWarrior::update(float dt)
{
	Entity::update(dt);
...
bool GoblinWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool GoblinWarrior::contactUpdate(CollisionData data)
{
...
bool GoblinWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
