...
OrcWarrior::OrcWarrior() : Entity::Entity()
{
...
void OrcWarrior::update(float dt)
{
	Entity::update(dt);
...
bool OrcWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool OrcWarrior::contactUpdate(CollisionData data)
{
...
bool OrcWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
