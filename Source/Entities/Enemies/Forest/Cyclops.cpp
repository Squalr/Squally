...
bool Cyclops::contactBegin(CollisionData data)
{
	return false;
}

bool Cyclops::contactUpdate(CollisionData data)
{
...
bool Cyclops::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
