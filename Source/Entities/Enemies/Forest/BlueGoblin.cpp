...
BlueGoblin::BlueGoblin() : Entity::Entity()
{
...
void BlueGoblin::update(float dt)
{
	Entity::update(dt);
...
bool BlueGoblin::contactBegin(CollisionData data)
{
	return false;
}

bool BlueGoblin::contactUpdate(CollisionData data)
{
...
bool BlueGoblin::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
