...
OrcGrunt::OrcGrunt() : Entity::Entity()
{
...
bool OrcGrunt::contactBegin(CollisionData data)
{
	return false;
}

bool OrcGrunt::contactUpdate(CollisionData data)
{
...
bool OrcGrunt::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
