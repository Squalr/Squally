...
bool Troll::contactBegin(CollisionData data)
{
	return false;
}

bool Troll::contactUpdate(CollisionData data)
{
...
bool Troll::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
