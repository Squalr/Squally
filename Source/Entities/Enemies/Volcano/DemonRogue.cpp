...
DemonRogue::DemonRogue() : Entity::Entity()
{
...
void DemonRogue::update(float dt)
{
	Entity::update(dt);
...
bool DemonRogue::contactBegin(CollisionData data)
{
	return false;
}

bool DemonRogue::contactUpdate(CollisionData data)
{
...
bool DemonRogue::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
