...
CritterDemon::CritterDemon() : Entity::Entity()
{
...
void CritterDemon::update(float dt)
{
	Entity::update(dt);
...
bool CritterDemon::contactBegin(CollisionData data)
{
	return false;
}

bool CritterDemon::contactUpdate(CollisionData data)
{
...
bool CritterDemon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
