...
BossDemon::BossDemon() : Entity::Entity()
{
...
void BossDemon::update(float dt)
{
	Entity::update(dt);
...
bool BossDemon::contactBegin(CollisionData data)
{
	return false;
}

bool BossDemon::contactUpdate(CollisionData data)
{
...
bool BossDemon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
