...
DemonWarrior2::DemonWarrior2() : Entity::Entity()
{
...
void DemonWarrior2::update(float dt)
{
	Entity::update(dt);
...
bool DemonWarrior2::contactBegin(CollisionData data)
{
	return false;
}

bool DemonWarrior2::contactUpdate(CollisionData data)
{
...
bool DemonWarrior2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
