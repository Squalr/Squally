...
DemonWarrior3::DemonWarrior3() : Entity::Entity()
{
...
void DemonWarrior3::update(float dt)
{
	Entity::update(dt);
...
bool DemonWarrior3::contactBegin(CollisionData data)
{
	return false;
}

bool DemonWarrior3::contactUpdate(CollisionData data)
{
...
bool DemonWarrior3::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
