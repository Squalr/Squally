...
RedWyvern2::RedWyvern2() : Entity::Entity()
{
...
void RedWyvern2::update(float dt)
{
	Entity::update(dt);
...
bool RedWyvern2::contactBegin(CollisionData data)
{
	return false;
}

bool RedWyvern2::contactUpdate(CollisionData data)
{
...
bool RedWyvern2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
