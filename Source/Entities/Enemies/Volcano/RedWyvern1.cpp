...
RedWyvern1::RedWyvern1() : Entity::Entity()
{
...
void RedWyvern1::update(float dt)
{
	Entity::update(dt);
...
bool RedWyvern1::contactBegin(CollisionData data)
{
	return false;
}

bool RedWyvern1::contactUpdate(CollisionData data)
{
...
bool RedWyvern1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
