...
RedDragon2::RedDragon2() : Entity::Entity()
{
...
void RedDragon2::update(float dt)
{
	Entity::update(dt);
...
bool RedDragon2::contactBegin(CollisionData data)
{
	return false;
}

bool RedDragon2::contactUpdate(CollisionData data)
{
...
bool RedDragon2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
