...
RedDragon1::RedDragon1() : Entity::Entity()
{
...
void RedDragon1::update(float dt)
{
	Entity::update(dt);
...
bool RedDragon1::contactBegin(CollisionData data)
{
	return false;
}

bool RedDragon1::contactUpdate(CollisionData data)
{
...
bool RedDragon1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
