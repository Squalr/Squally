...
LavaGolem::LavaGolem() : Entity::Entity()
{
...
void LavaGolem::update(float dt)
{
	Entity::update(dt);
...
bool LavaGolem::contactBegin(CollisionData data)
{
	return false;
}

bool LavaGolem::contactUpdate(CollisionData data)
{
...
bool LavaGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
