...
DemonWarrior::DemonWarrior() : Entity::Entity()
{
...
void DemonWarrior::update(float dt)
{
	Entity::update(dt);
...
bool DemonWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool DemonWarrior::contactUpdate(CollisionData data)
{
...
bool DemonWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
