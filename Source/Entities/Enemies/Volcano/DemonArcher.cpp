...
DemonArcher::DemonArcher() : Entity::Entity()
{
...
void DemonArcher::update(float dt)
{
	Entity::update(dt);
...
bool DemonArcher::contactBegin(CollisionData data)
{
	return false;
}

bool DemonArcher::contactUpdate(CollisionData data)
{
...
bool DemonArcher::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
