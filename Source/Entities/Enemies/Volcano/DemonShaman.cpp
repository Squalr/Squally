...
DemonShaman::DemonShaman() : Entity::Entity()
{
...
void DemonShaman::update(float dt)
{
	Entity::update(dt);
...
bool DemonShaman::contactBegin(CollisionData data)
{
	return false;
}

bool DemonShaman::contactUpdate(CollisionData data)
{
...
bool DemonShaman::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
