...
DemonWarrior1::DemonWarrior1() : Entity::Entity()
{
...
void DemonWarrior1::update(float dt)
{
	Entity::update(dt);
...
bool DemonWarrior1::contactBegin(CollisionData data)
{
	return false;
}

bool DemonWarrior1::contactUpdate(CollisionData data)
{
...
bool DemonWarrior1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
