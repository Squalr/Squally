...
DragonDemon::DragonDemon() : Entity::Entity()
{
...
void DragonDemon::update(float dt)
{
	Entity::update(dt);
...
bool DragonDemon::contactBegin(CollisionData data)
{
	return false;
}

bool DragonDemon::contactUpdate(CollisionData data)
{
...
bool DragonDemon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
