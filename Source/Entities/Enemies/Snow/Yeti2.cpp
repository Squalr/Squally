...
bool Yeti2::contactBegin(CollisionData data)
{
	return false;
}

bool Yeti2::contactUpdate(CollisionData data)
{
...
bool Yeti2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
