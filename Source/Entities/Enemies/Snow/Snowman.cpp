...
bool Snowman::contactBegin(CollisionData data)
{
	return false;
}

bool Snowman::contactUpdate(CollisionData data)
{
...
bool Snowman::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
