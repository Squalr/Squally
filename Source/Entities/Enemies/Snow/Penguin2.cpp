...
Penguin2::Penguin2() : Entity::Entity()
{
...
bool Penguin2::contactBegin(CollisionData data)
{
	return false;
}

bool Penguin2::contactUpdate(CollisionData data)
{
...
bool Penguin2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
