...
bool Yeti1::contactBegin(CollisionData data)
{
	return false;
}

bool Yeti1::contactUpdate(CollisionData data)
{
...
bool Yeti1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
