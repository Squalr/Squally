...
IceGolem::IceGolem() : Entity::Entity()
{
...
bool IceGolem::contactBegin(CollisionData data)
{
	return false;
}

bool IceGolem::contactUpdate(CollisionData data)
{
...
bool IceGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
