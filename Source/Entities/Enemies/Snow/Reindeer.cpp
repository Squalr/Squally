...
Reindeer::Reindeer() : Entity::Entity()
{
...
bool Reindeer::contactBegin(CollisionData data)
{
	return false;
}

bool Reindeer::contactUpdate(CollisionData data)
{
...
bool Reindeer::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
