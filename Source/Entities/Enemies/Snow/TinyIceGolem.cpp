...
TinyIceGolem::TinyIceGolem() : Entity::Entity()
{
...
void TinyIceGolem::update(float dt)
{
	Entity::update(dt);
...
bool TinyIceGolem::contactBegin(CollisionData data)
{
	return false;
}

bool TinyIceGolem::contactUpdate(CollisionData data)
{
...
bool TinyIceGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
