...
FrostGunman::FrostGunman() : Entity::Entity()
{
...
void FrostGunman::update(float dt)
{
	Entity::update(dt);
...
bool FrostGunman::contactBegin(CollisionData data)
{
	return false;
}

bool FrostGunman::contactUpdate(CollisionData data)
{
...
bool FrostGunman::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
