...
Penguin1::Penguin1() : Entity::Entity()
{
...
bool Penguin1::contactBegin(CollisionData data)
{
	return false;
}

bool Penguin1::contactUpdate(CollisionData data)
{
...
bool Penguin1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
