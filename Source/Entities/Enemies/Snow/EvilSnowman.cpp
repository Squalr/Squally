...
EvilSnowman::EvilSnowman() : Entity::Entity()
{
...
void EvilSnowman::update(float dt)
{
	Entity::update(dt);
...
bool EvilSnowman::contactBegin(CollisionData data)
{
	return false;
}

bool EvilSnowman::contactUpdate(CollisionData data)
{
...
bool EvilSnowman::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
