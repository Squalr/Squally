...
FrostDragon::FrostDragon() : Entity::Entity()
{
...
void FrostDragon::update(float dt)
{
	Entity::update(dt);
...
bool FrostDragon::contactBegin(CollisionData data)
{
	return false;
}

bool FrostDragon::contactUpdate(CollisionData data)
{
...
bool FrostDragon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
