...
bool Yeti3::contactBegin(CollisionData data)
{
	return false;
}

bool Yeti3::contactUpdate(CollisionData data)
{
...
bool Yeti3::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
