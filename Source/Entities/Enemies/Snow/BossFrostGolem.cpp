...
BossFrostGolem::BossFrostGolem() : Entity::Entity()
{
...
void BossFrostGolem::update(float dt)
{
	Entity::update(dt);
...
bool BossFrostGolem::contactBegin(CollisionData data)
{
	return false;
}

bool BossFrostGolem::contactUpdate(CollisionData data)
{
...
bool BossFrostGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
