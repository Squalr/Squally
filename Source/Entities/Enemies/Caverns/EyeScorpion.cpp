...
EyeScorpion::EyeScorpion() : Entity::Entity()
{
...
void EyeScorpion::update(float dt)
{
	Entity::update(dt);
...
bool EyeScorpion::contactBegin(CollisionData data)
{
	return false;
}

bool EyeScorpion::contactUpdate(CollisionData data)
{
...
bool EyeScorpion::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
