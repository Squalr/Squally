...
bool Beetle::contactBegin(CollisionData data)
{
	return false;
}

bool Beetle::contactUpdate(CollisionData data)
{
...
bool Beetle::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
