...
BossKrampus::BossKrampus() : Entity::Entity()
{
...
void BossKrampus::update(float dt)
{
	Entity::update(dt);
...
bool BossKrampus::contactBegin(CollisionData data)
{
	return false;
}

bool BossKrampus::contactUpdate(CollisionData data)
{
...
bool BossKrampus::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
