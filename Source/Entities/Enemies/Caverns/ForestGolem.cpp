...
ForestGolem::ForestGolem() : Entity::Entity()
{
...
void ForestGolem::update(float dt)
{
	Entity::update(dt);
...
bool ForestGolem::contactBegin(CollisionData data)
{
	return false;
}

bool ForestGolem::contactUpdate(CollisionData data)
{
...
bool ForestGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
