...
BlackWidow::BlackWidow() : Entity::Entity()
{
...
void BlackWidow::update(float dt)
{
	Entity::update(dt);
...
bool BlackWidow::contactBegin(CollisionData data)
{
	return false;
}

bool BlackWidow::contactUpdate(CollisionData data)
{
...
bool BlackWidow::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
