...
CavernSpider::CavernSpider() : Entity::Entity()
{
...
void CavernSpider::update(float dt)
{
	Entity::update(dt);
...
bool CavernSpider::contactBegin(CollisionData data)
{
	return false;
}

bool CavernSpider::contactUpdate(CollisionData data)
{
...
bool CavernSpider::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
