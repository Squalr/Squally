...
TinyRockGolem::TinyRockGolem() : Entity::Entity()
{
...
void TinyRockGolem::update(float dt)
{
	Entity::update(dt);
...
bool TinyRockGolem::contactBegin(CollisionData data)
{
	return false;
}

bool TinyRockGolem::contactUpdate(CollisionData data)
{
...
bool TinyRockGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
