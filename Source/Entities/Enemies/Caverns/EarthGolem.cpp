...
EarthGolem::EarthGolem() : Entity::Entity()
{
...
void EarthGolem::update(float dt)
{
	Entity::update(dt);
...
bool EarthGolem::contactBegin(CollisionData data)
{
	return false;
}

bool EarthGolem::contactUpdate(CollisionData data)
{
...
bool EarthGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
