...
RockGolem::RockGolem() : Entity::Entity()
{
...
void RockGolem::update(float dt)
{
	Entity::update(dt);
...
bool RockGolem::contactBegin(CollisionData data)
{
	return false;
}

bool RockGolem::contactUpdate(CollisionData data)
{
...
bool RockGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
