...
AnubisWarrior::AnubisWarrior() : Entity::Entity()
{
...
void AnubisWarrior::update(float dt)
{
	Entity::update(dt);
...
bool AnubisWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool AnubisWarrior::contactUpdate(CollisionData data)
{
...
bool AnubisWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
