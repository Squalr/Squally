...
MummyPharoh::MummyPharoh() : Entity::Entity()
{
...
void MummyPharoh::update(float dt)
{
	Entity::update(dt);
...
bool MummyPharoh::contactBegin(CollisionData data)
{
	return false;
}

bool MummyPharoh::contactUpdate(CollisionData data)
{
...
bool MummyPharoh::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
