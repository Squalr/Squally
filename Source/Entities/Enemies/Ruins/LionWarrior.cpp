...
LionWarrior::LionWarrior() : Entity::Entity()
{
...
void LionWarrior::update(float dt)
{
	Entity::update(dt);
...
bool LionWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool LionWarrior::contactUpdate(CollisionData data)
{
...
bool LionWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
