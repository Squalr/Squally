...
bool Mermaid::contactBegin(CollisionData data)
{
	return false;
}

bool Mermaid::contactUpdate(CollisionData data)
{
...
bool Mermaid::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
