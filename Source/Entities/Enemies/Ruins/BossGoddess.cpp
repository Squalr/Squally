...
BossGoddess::BossGoddess() : Entity::Entity()
{
...
void BossGoddess::update(float dt)
{
	Entity::update(dt);
...
bool BossGoddess::contactBegin(CollisionData data)
{
	return false;
}

bool BossGoddess::contactUpdate(CollisionData data)
{
...
bool BossGoddess::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
