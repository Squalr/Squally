...
TigerWarrior2::TigerWarrior2() : Entity::Entity()
{
...
void TigerWarrior2::update(float dt)
{
	Entity::update(dt);
...
bool TigerWarrior2::contactBegin(CollisionData data)
{
	return false;
}

bool TigerWarrior2::contactUpdate(CollisionData data)
{
...
bool TigerWarrior2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
