...
LionWarrior2::LionWarrior2() : Entity::Entity()
{
...
void LionWarrior2::update(float dt)
{
	Entity::update(dt);
...
bool LionWarrior2::contactBegin(CollisionData data)
{
	return false;
}

bool LionWarrior2::contactUpdate(CollisionData data)
{
...
bool LionWarrior2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
