...
MedusaWarrior::MedusaWarrior() : Entity::Entity()
{
...
void MedusaWarrior::update(float dt)
{
	Entity::update(dt);
...
bool MedusaWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool MedusaWarrior::contactUpdate(CollisionData data)
{
...
bool MedusaWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
