...
bool Medusa::contactBegin(CollisionData data)
{
	return false;
}

bool Medusa::contactUpdate(CollisionData data)
{
...
bool Medusa::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
