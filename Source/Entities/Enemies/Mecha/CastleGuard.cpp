...
CastleGuard::CastleGuard() : Entity::Entity()
{
...
void CastleGuard::update(float dt)
{
	Entity::update(dt);
...
bool CastleGuard::contactBegin(CollisionData data)
{
	return false;
}

bool CastleGuard::contactUpdate(CollisionData data)
{
...
bool CastleGuard::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
