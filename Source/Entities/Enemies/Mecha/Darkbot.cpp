...
bool DarkBot::contactBegin(CollisionData data)
{
	return false;
}

bool DarkBot::contactUpdate(CollisionData data)
{
...
bool DarkBot::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
