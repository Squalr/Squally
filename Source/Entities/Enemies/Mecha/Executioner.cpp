...
Executioner::Executioner() : Entity::Entity()
{
...
void Executioner::update(float dt)
{
	Entity::update(dt);
...
bool Executioner::contactBegin(CollisionData data)
{
	return false;
}

bool Executioner::contactUpdate(CollisionData data)
{
...
bool Executioner::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
