...
SmallBotSpider::SmallBotSpider() : Entity::Entity()
{
...
void SmallBotSpider::update(float dt)
{
	Entity::update(dt);
...
bool SmallBotSpider::contactBegin(CollisionData data)
{
	return false;
}

bool SmallBotSpider::contactUpdate(CollisionData data)
{
...
bool SmallBotSpider::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
