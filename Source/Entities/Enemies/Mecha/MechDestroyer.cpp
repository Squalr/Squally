...
MechDestroyer::MechDestroyer() : Entity::Entity()
{
...
void MechDestroyer::update(float dt)
{
	Entity::update(dt);
...
bool MechDestroyer::contactBegin(CollisionData data)
{
	return false;
}

bool MechDestroyer::contactUpdate(CollisionData data)
{
...
bool MechDestroyer::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
