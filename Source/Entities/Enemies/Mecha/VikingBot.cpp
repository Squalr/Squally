...
VikingBot::VikingBot() : Entity::Entity()
{
...
void VikingBot::update(float dt)
{
	Entity::update(dt);
...
bool VikingBot::contactBegin(CollisionData data)
{
	return false;
}

bool VikingBot::contactUpdate(CollisionData data)
{
...
bool VikingBot::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
