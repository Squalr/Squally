...
MechGolem::MechGolem() : Entity::Entity()
{
...
void MechGolem::update(float dt)
{
	Entity::update(dt);
...
bool MechGolem::contactBegin(CollisionData data)
{
	return false;
}

bool MechGolem::contactUpdate(CollisionData data)
{
...
bool MechGolem::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
