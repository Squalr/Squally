...
bool MechDog::contactBegin(CollisionData data)
{
	return false;
}

bool MechDog::contactUpdate(CollisionData data)
{
...
bool MechDog::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
