...
VikingBotSmall::VikingBotSmall() : Entity::Entity()
{
...
void VikingBotSmall::update(float dt)
{
	Entity::update(dt);
...
bool VikingBotSmall::contactBegin(CollisionData data)
{
	return false;
}

bool VikingBotSmall::contactUpdate(CollisionData data)
{
...
bool VikingBotSmall::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
