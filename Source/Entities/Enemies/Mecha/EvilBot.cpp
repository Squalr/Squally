...
bool EvilBot::contactBegin(CollisionData data)
{
	return false;
}

bool EvilBot::contactUpdate(CollisionData data)
{
...
bool EvilBot::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
