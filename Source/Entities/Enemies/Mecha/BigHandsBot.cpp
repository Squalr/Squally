...
BigHandsBot::BigHandsBot() : Entity::Entity()
{
...
void BigHandsBot::update(float dt)
{
	Entity::update(dt);
...
bool BigHandsBot::contactBegin(CollisionData data)
{
	return false;
}

bool BigHandsBot::contactUpdate(CollisionData data)
{
...
bool BigHandsBot::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
