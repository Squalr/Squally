...
BossEvilEye::BossEvilEye() : Entity::Entity()
{
...
void BossEvilEye::update(float dt)
{
	Entity::update(dt);
...
bool BossEvilEye::contactBegin(CollisionData data)
{
	return false;
}

bool BossEvilEye::contactUpdate(CollisionData data)
{
...
bool BossEvilEye::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
