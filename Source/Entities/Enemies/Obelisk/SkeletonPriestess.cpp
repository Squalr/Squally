...
SkeletonPriestess::SkeletonPriestess() : Entity::Entity()
{
...
void SkeletonPriestess::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonPriestess::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonPriestess::contactUpdate(CollisionData data)
{
...
bool SkeletonPriestess::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
