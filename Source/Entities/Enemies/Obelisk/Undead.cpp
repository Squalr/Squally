...
bool Undead::contactBegin(CollisionData data)
{
	return false;
}

bool Undead::contactUpdate(CollisionData data)
{
...
bool Undead::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
