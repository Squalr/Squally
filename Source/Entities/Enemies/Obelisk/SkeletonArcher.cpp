...
SkeletonArcher::SkeletonArcher() : Entity::Entity()
{
...
void SkeletonArcher::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonArcher::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonArcher::contactUpdate(CollisionData data)
{
...
bool SkeletonArcher::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
