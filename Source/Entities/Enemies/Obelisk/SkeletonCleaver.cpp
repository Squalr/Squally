...
SkeletonCleaver::SkeletonCleaver() : Entity::Entity()
{
...
void SkeletonCleaver::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonCleaver::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonCleaver::contactUpdate(CollisionData data)
{
...
bool SkeletonCleaver::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
