...
Abomination::Abomination() : Entity::Entity()
{
...
void Abomination::update(float dt)
{
	Entity::update(dt);
...
bool Abomination::contactBegin(CollisionData data)
{
	return false;
}

bool Abomination::contactUpdate(CollisionData data)
{
...
bool Abomination::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
