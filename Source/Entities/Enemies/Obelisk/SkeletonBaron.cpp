...
SkeletonBaron::SkeletonBaron() : Entity::Entity()
{
...
void SkeletonBaron::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonBaron::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonBaron::contactUpdate(CollisionData data)
{
...
bool SkeletonBaron::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
