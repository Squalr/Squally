...
SkeletonWarrior::SkeletonWarrior() : Entity::Entity()
{
...
void SkeletonWarrior::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonWarrior::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonWarrior::contactUpdate(CollisionData data)
{
...
bool SkeletonWarrior::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
