...
SkeletonMage::SkeletonMage() : Entity::Entity()
{
...
void SkeletonMage::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonMage::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonMage::contactUpdate(CollisionData data)
{
...
bool SkeletonMage::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
