...
BossSkeletonKing::BossSkeletonKing() : Entity::Entity()
{
...
void BossSkeletonKing::update(float dt)
{
	Entity::update(dt);
...
bool BossSkeletonKing::contactBegin(CollisionData data)
{
	return false;
}

bool BossSkeletonKing::contactUpdate(CollisionData data)
{
...
bool BossSkeletonKing::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
