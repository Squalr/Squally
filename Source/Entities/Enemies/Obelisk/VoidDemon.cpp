...
VoidDemon::VoidDemon() : Entity::Entity()
{
...
void VoidDemon::update(float dt)
{
	Entity::update(dt);
...
bool VoidDemon::contactBegin(CollisionData data)
{
	return false;
}

bool VoidDemon::contactUpdate(CollisionData data)
{
...
bool VoidDemon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
