...
SkeletonGhost::SkeletonGhost() : Entity::Entity()
{
...
void SkeletonGhost::update(float dt)
{
	Entity::update(dt);
...
bool SkeletonGhost::contactBegin(CollisionData data)
{
	return false;
}

bool SkeletonGhost::contactUpdate(CollisionData data)
{
...
bool SkeletonGhost::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
