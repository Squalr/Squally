...
DarkDragon::DarkDragon() : Entity::Entity()
{
...
void DarkDragon::update(float dt)
{
	Entity::update(dt);
...
bool DarkDragon::contactBegin(CollisionData data)
{
	return false;
}

bool DarkDragon::contactUpdate(CollisionData data)
{
...
bool DarkDragon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
