...
bool Harpy::contactBegin(CollisionData data)
{
	return false;
}

bool Harpy::contactUpdate(CollisionData data)
{
...
bool Harpy::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
