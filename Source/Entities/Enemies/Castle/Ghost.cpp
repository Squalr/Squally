...
bool Ghost::contactBegin(CollisionData data)
{
	return false;
}

bool Ghost::contactUpdate(CollisionData data)
{
...
bool Ghost::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
