...
BossWitch::BossWitch() : Entity::Entity()
{
...
void BossWitch::update(float dt)
{
	Entity::update(dt);
...
bool BossWitch::contactBegin(CollisionData data)
{
	return false;
}

bool BossWitch::contactUpdate(CollisionData data)
{
...
bool BossWitch::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
