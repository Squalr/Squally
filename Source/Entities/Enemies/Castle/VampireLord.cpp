...
VampireLord::VampireLord() : Entity::Entity()
{
...
void VampireLord::update(float dt)
{
	Entity::update(dt);
...
bool VampireLord::contactBegin(CollisionData data)
{
	return false;
}

bool VampireLord::contactUpdate(CollisionData data)
{
...
bool VampireLord::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
