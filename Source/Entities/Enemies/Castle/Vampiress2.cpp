...
Vampiress2::Vampiress2() : Entity::Entity()
{
...
void Vampiress2::update(float dt)
{
	Entity::update(dt);
...
bool Vampiress2::contactBegin(CollisionData data)
{
	return false;
}

bool Vampiress2::contactUpdate(CollisionData data)
{
...
bool Vampiress2::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
