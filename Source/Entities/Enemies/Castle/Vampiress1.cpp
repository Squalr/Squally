...
Vampiress1::Vampiress1() : Entity::Entity()
{
...
void Vampiress1::update(float dt)
{
	Entity::update(dt);
...
bool Vampiress1::contactBegin(CollisionData data)
{
	return false;
}

bool Vampiress1::contactUpdate(CollisionData data)
{
...
bool Vampiress1::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
