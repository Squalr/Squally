...
MantisDragon::MantisDragon() : Entity::Entity()
{
...
void MantisDragon::update(float dt)
{
	Entity::update(dt);
...
bool MantisDragon::contactBegin(CollisionData data)
{
	return false;
}

bool MantisDragon::contactUpdate(CollisionData data)
{
...
bool MantisDragon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
