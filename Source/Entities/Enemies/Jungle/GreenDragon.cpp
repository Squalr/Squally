...
GreenDragon::GreenDragon() : Entity::Entity()
{
...
void GreenDragon::update(float dt)
{
	Entity::update(dt);
...
bool GreenDragon::contactBegin(CollisionData data)
{
	return false;
}

bool GreenDragon::contactUpdate(CollisionData data)
{
...
bool GreenDragon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
