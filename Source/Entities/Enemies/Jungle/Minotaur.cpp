...
Minotaur::Minotaur() : Entity::Entity()
{
...
bool Minotaur::contactBegin(CollisionData data)
{
	return false;
}

bool Minotaur::contactUpdate(CollisionData data)
{
...
bool Minotaur::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
