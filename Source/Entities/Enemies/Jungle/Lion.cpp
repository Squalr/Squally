...
bool Lion::contactBegin(CollisionData data)
{
	return false;
}

bool Lion::contactUpdate(CollisionData data)
{
...
bool Lion::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
