...
PurpleDino::PurpleDino() : Entity::Entity()
{
...
void PurpleDino::update(float dt)
{
	Entity::update(dt);
...
bool PurpleDino::contactBegin(CollisionData data)
{
	return false;
}

bool PurpleDino::contactUpdate(CollisionData data)
{
...
bool PurpleDino::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
