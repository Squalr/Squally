...
JungleDragon::JungleDragon() : Entity::Entity()
{
...
void JungleDragon::update(float dt)
{
	Entity::update(dt);
...
bool JungleDragon::contactBegin(CollisionData data)
{
	return false;
}

bool JungleDragon::contactUpdate(CollisionData data)
{
...
bool JungleDragon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
