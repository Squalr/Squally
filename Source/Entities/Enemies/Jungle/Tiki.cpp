...
bool Tiki::contactBegin(CollisionData data)
{
	return false;
}

bool Tiki::contactUpdate(CollisionData data)
{
...
bool Tiki::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
