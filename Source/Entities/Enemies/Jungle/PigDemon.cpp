...
PigDemon::PigDemon() : Entity::Entity()
{
...
bool PigDemon::contactBegin(CollisionData data)
{
	return false;
}

bool PigDemon::contactUpdate(CollisionData data)
{
...
bool PigDemon::contactEnd(CollisionData data)
{
	switch (data.other->getCategoryGroup())
	{
	case CategoryGroup::G_Solid:
