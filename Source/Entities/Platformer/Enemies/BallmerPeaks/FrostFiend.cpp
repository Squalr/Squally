...
FrostFiend::FrostFiend(ValueMap& properties) : super(properties,
	FrostFiend::MapKey,
	EntityResources::Enemies_BallmerPeaks_FrostFiend_Animations,
	EntityResources::Enemies_BallmerPeaks_FrostFiend_Emblem,
	Size(212.0f, 296.0f),
	1.0f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Enemies_BallmerPeaks_FrostFiend::create();
}
