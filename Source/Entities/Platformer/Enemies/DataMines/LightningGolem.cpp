...
LightningGolem::LightningGolem(ValueMap& properties) : super(properties,
	...
	EntityResources::Enemies_DataMines_LightningGolem_Animations,
	EntityResources::Enemies_DataMines_LightningGolem_Emblem,
	Size(768.0f, 840.0f),
	1.0f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Enemies_DataMines_LightningGolem::create();
}
