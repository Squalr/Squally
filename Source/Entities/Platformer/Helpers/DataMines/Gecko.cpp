...
Gecko::Gecko(ValueMap& properties) : super(properties,
	Gecko::MapKey,
	EntityResources::Helpers_DataMines_Gecko_Animations,
	EntityResources::Helpers_DataMines_Gecko_Emblem,
	Size(224.0f, 440.0f),
	0.3f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Helpers_DataMines_Gecko::create();
}
