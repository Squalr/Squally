...
Burch::Burch(ValueMap& properties) : super(properties,
	Burch::MapKey,
	EntityResources::Npcs_DataMines_Burch_Animations,
	EntityResources::Npcs_DataMines_Burch_Emblem,
	Size(112.0f, 160.0f),
	1.05f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_DataMines_Burch::create();
}
