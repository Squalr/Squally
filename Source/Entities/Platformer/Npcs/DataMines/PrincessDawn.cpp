...
PrincessDawn::PrincessDawn(ValueMap& properties) : super(properties,
	PrincessDawn::MapKey,
	EntityResources::Npcs_DataMines_PrincessDawn_Animations,
	EntityResources::Npcs_DataMines_PrincessDawn_Emblem,
	Size(112.0f, 160.0f),
	1.0f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_DataMines_PrincessDawn::create();
}
