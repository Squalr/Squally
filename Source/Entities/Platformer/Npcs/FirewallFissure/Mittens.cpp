...
Mittens::Mittens(ValueMap& properties) : super(properties,
	Mittens::MapKey,
	EntityResources::Npcs_FirewallFissure_Mittens_Animations,
	EntityResources::Npcs_FirewallFissure_Mittens_Emblem,
	CSize(112.0f, 160.0f),
	1.05f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_FirewallFissure_Mittens::create();
}
