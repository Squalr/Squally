...
Ragnis::Ragnis(ValueMap& properties) : super(properties,
	Ragnis::MapKey,
	EntityResources::Npcs_FirewallFissure_Ragnis_Animations,
	EntityResources::Npcs_FirewallFissure_Ragnis_Emblem,
	CSize(112.0f, 160.0f),
	0.85f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_FirewallFissure_Ragnis::create();
}
