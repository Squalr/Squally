...
Ash::Ash(ValueMap& properties) : super(properties,
	Ash::MapKey,
	EntityResources::Npcs_FirewallFissure_Ash_Animations,
	EntityResources::Npcs_FirewallFissure_Ash_Emblem,
	CSize(112.0f, 160.0f),
	1.0f)
{
}
...
{
	return Strings::Platformer_Entities_Names_Npcs_FirewallFissure_Ash::create();
}
