...
Pan::Pan(ValueMap& properties) : super(properties,
	Pan::MapKey,
	EntityResources::Npcs_FirewallFissure_Pan_Animations,
	EntityResources::Npcs_FirewallFissure_Pan_Emblem,
	CSize(112.0f, 160.0f),
	1.0f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_FirewallFissure_Pan::create();
}
