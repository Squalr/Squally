...
Thatcher::Thatcher(ValueMap& properties) : super(properties,
	Thatcher::MapKey,
	EntityResources::Npcs_BallmerPeaks_Thatcher_Animations,
	EntityResources::Npcs_BallmerPeaks_Thatcher_Emblem,
	Size(112.0f, 160.0f),
	0.9f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_BallmerPeaks_Thatcher::create();
}
