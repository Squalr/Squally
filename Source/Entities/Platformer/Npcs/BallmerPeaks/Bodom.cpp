...
Bodom::Bodom(ValueMap& properties) : super(properties,
	Bodom::MapKey,
	EntityResources::Npcs_BallmerPeaks_Bodom_Animations,
	EntityResources::Npcs_BallmerPeaks_Bodom_Emblem,
	Size(112.0f, 160.0f),
	1.0f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_BallmerPeaks_Bodom::create();
}
