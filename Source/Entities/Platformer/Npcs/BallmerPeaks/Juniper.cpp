...
Juniper::Juniper(ValueMap& properties) : super(properties,
	Juniper::MapKey,
	EntityResources::Npcs_BallmerPeaks_Juniper_Animations,
	EntityResources::Npcs_BallmerPeaks_Juniper_Emblem,
	Size(112.0f, 160.0f),
	0.85f,
	Vec2(0.0f, 0.0f))
{
...
{
	return Strings::Platformer_Entities_Names_Npcs_BallmerPeaks_Juniper::create();
}
