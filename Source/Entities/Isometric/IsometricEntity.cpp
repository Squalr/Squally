...
IsometricEntity::IsometricEntity(ValueMap& properties, std::string scmlResource, float scale, Vec2 offset, Size size) : super(properties)
{
	...
	this->animationNode->playAnimation("Idle_NE", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
...
void IsometricEntity::update(float dt)
{
	...
	if (this->movement != Vec2::ZERO)
	{
		...
		switch (octant)
		{
			case 0:
			{
				this->animationNode->playAnimation("Idle_E", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 1:
			{
			...
			case 2:
			{
				this->animationNode->playAnimation("Idle_N", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 3:
			{
				this->animationNode->playAnimation("Idle_NW", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 4:
			{
				this->animationNode->playAnimation("Idle_W", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 5:
			{
				this->animationNode->playAnimation("Idle_SW", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 6:
			{
				this->animationNode->playAnimation("Idle_S", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			case 7:
			{
				this->animationNode->playAnimation("Idle_SE", SmartAnimationNode::AnimationPlayMode::Repeat, 0.5f);
				break;
			}
			default:
			{
