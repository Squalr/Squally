			...
			HackableCode::HackableCodeInfo(
				...
				0.0f,
				{
					HackableCode::ReadOnlyScript(
						...
						// x86
						ConcatString::create({
							Strings::Menus_Hacking_Objects_FireBird_UpdateTimer_CommentAddss::create(),
							Strings::Menus_Hacking_Objects_FireBird_UpdateTimer_CommentChangeTo::create(),
							ConstantString::create("addss xmm2, xmm4\n\n"),
							Strings::Menus_Hacking_Abilities_Generic_CommentBreak::create(),
							Strings::Menus_Hacking_Objects_FireBird_UpdateTimer_CommentSSEInstructionsPt1::create(),
							Strings::Menus_Hacking_Objects_FireBird_UpdateTimer_CommentSSEInstructionsPt2::create(),
							Strings::Menus_Hacking_Objects_FireBird_UpdateTimer_CommentSSEInstructionsPt3::create(),
							Strings::Menus_Hacking_Abilities_Generic_CommentBreak::create()
						})
						, // x64
						ConcatString::create({
