#include "FloatingCrateGetDensityPreview.h"
...
FloatingCrateGetDensityPreview* FloatingCrateGetDensityPreview::create()
{
	FloatingCrateGetDensityPreview* instance = new FloatingCrateGetDensityPreview();
...
void FloatingCrateGetDensityPreview::onEnter()
{
	super::onEnter();
...
void FloatingCrateGetDensityPreview::initializePositions()
{
