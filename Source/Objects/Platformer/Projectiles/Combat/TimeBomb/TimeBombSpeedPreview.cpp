#include "TimeBombSpeedPreview.h"
...
TimeBombSpeedPreview* TimeBombSpeedPreview::create()
{
	TimeBombSpeedPreview* instance = new TimeBombSpeedPreview();
...
TimeBombSpeedPreview::TimeBombSpeedPreview()
{
...
HackablePreview* TimeBombSpeedPreview::clone()
{
	return TimeBombSpeedPreview::create();
}

void TimeBombSpeedPreview::onEnter()
{
	super::onEnter();
...
void TimeBombSpeedPreview::initializePositions()
{
