...
CardPoolTier7* CardPoolTier7::create(SampleMethod sampleMethod, int min, int max)
{
	CardPoolTier7* instance = new CardPoolTier7(sampleMethod, min, max);
...
CardPoolTier7::CardPoolTier7(SampleMethod sampleMethod, int min, int max) : super(ValueMap(), "card-pool-t7", sampleMethod, min, max)
{
