...
CardPoolTier5* CardPoolTier5::create(SampleMethod sampleMethod, int min, int max)
{
	CardPoolTier5* instance = new CardPoolTier5(sampleMethod, min, max);
...
CardPoolTier5::CardPoolTier5(SampleMethod sampleMethod, int min, int max) : super(ValueMap(), "card-pool-t5", sampleMethod, min, max)
{
