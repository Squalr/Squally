...
CardPoolTier4* CardPoolTier4::create(SampleMethod sampleMethod, int min, int max)
{
	CardPoolTier4* instance = new CardPoolTier4(sampleMethod, min, max);
...
CardPoolTier4::CardPoolTier4(SampleMethod sampleMethod, int min, int max) : super(ValueMap(), "card-pool-t4", sampleMethod, min, max)
{
	...
	this->addItemToPool(ItemChance::create(Binary4::create(), ItemChance::Probability::Legendary));
