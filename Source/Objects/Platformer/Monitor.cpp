...
Monitor::Monitor(ValueMap* initProperties) : HackableObject(initProperties)
{
	...
	this->monitorSprite = MenuSprite::create(this->monitorSpriteFloating, Sprite::create(Resources::Objects_MonitorSelected), Sprite::create(Resources::Objects_MonitorSelected));
