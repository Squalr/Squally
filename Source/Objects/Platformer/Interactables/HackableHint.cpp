...
HackableHint::HackableHint(ValueMap& properties) : super(properties)
{
	...
	this->hintCollision = CollisionObject::create(CollisionObject::createBox(collisionSize), (CollisionType)PlatformerCollisionType::Trigger, CollisionObject::Properties(false, false));
