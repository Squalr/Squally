...
{
	this->interactCollision = CollisionObject::create(CollisionObject::createBox(Size(128.0f, 96.0f)), (CollisionType)PlatformerCollisionType::Collectable, CollisionObject::Properties(false, false));
