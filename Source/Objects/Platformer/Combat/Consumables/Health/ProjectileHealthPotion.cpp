...
ProjectileHealthPotion* ProjectileHealthPotion::create()
{
	ProjectileHealthPotion* instance = new ProjectileHealthPotion();
...
{
	int healing = float(target->getMaxHealth()) * ProjectileHealthPotion::HealPercentage;
