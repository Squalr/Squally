	...
	{
		{
			...
			HackableCode::HackableCodeInfo(
				...
				{
					{
						HackableCode::Register::zax, Strings::Menus_Hacking_Abilities_Abilities_Fireball_ApplySpeed_RegisterEax::create(), HackableDataType::Float
					},
					{
						HackableCode::Register::xmm0, Strings::Menus_Hacking_Abilities_Abilities_Fireball_ApplySpeed_RegisterXmm0::create(), HackableDataType::Float
					},
					{
						HackableCode::Register::xmm1, Strings::Menus_Hacking_Abilities_Abilities_Fireball_ApplySpeed_RegisterXmm1::create(), HackableDataType::Float
					}
				},
				int(HackFlags::None),
				3.0f,
