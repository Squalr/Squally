			...
			HackableCode::HackableCodeInfo(
				...
				0.0f,
				{
					HackableCode::ReadOnlyScript(
						...
						// x86
						ConcatString::create({
							Strings::Menus_Hacking_Abilities_Abilities_Fireball_ApplySpeed_CommentXmmLoading::create()->
								setStringReplacementVariables(Strings::Common_Brackets::create()->
								setStringReplacementVariables(Strings::Menus_Hacking_Lexicon_Assembly_RegisterEax::create())),
							Strings::Menus_Hacking_Abilities_Abilities_Fireball_ApplySpeed_CommentAlterSpeed::create(),
