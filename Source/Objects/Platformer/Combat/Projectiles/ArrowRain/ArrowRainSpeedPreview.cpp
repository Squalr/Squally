#include "ArrowRainSpeedPreview.h"
...
ArrowRainSpeedPreview* ArrowRainSpeedPreview::create()
{
	ArrowRainSpeedPreview* instance = new ArrowRainSpeedPreview();
...
ArrowRainSpeedPreview::ArrowRainSpeedPreview()
{
...
HackablePreview* ArrowRainSpeedPreview::clone()
{
	return ArrowRainSpeedPreview::create();
}

void ArrowRainSpeedPreview::onEnter()
{
	super::onEnter();
...
void ArrowRainSpeedPreview::initializePositions()
{
