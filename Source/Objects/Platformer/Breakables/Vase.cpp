...
const std::string Vase::MapKeyVase = "vase";
const std::string Vase::MapPropertyColor = "color";
...
Vase::Vase(ValueMap& properties, int requiredHits) : super(properties, Size(113.0f, 160.0f), requiredHits)
{
	...
	this->vaseBroken = CollisionObject::create(CollisionObject::createBox(Size(113.0f, 92.0f)), (CollisionType)PlatformerCollisionType::Physics, CollisionObject::Properties(true, true));
