...
CagedBear* CagedBear::create(ValueMap& initProperties)
{
	CagedBear* instance = new CagedBear(initProperties);
...
CagedBear::CagedBear(ValueMap& initProperties) : super(initProperties, SaveKeys::SaveKeyCollectableAnimalBear)
{
