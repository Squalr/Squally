...
void PlushieMonkey::update(float dt)
{
	...
	this->puzzleData->registerCode(assemblyAddressStart, assemblyAddressEnd, "Puzzle Increment", Resources::Menus_HackerModeMenu_Icons_Safe);
...
void PlushieMonkey::registerHackables()
{
	...
	this->puzzleData = HackableData::create("Key", &PlushieMonkey::puzzleLock, &typeid(PlushieMonkey::puzzleLock), Resources::Menus_HackerModeMenu_Icons_Lock);
