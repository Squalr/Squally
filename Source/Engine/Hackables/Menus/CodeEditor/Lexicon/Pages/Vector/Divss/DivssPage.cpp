...
const std::string DivssPage::Identifier = "DIVSS_PAGE";

DivssPage* DivssPage::create()
{
	DivssPage* instance = new DivssPage();
...
DivssPage::DivssPage() : super(DivssPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_Vector_Divss::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_Vector_Divss_Intro::create(),
...
void DivssPage::initializePositions()
{
...
void DivssPage::initializeListeners()
{
