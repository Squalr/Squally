...
const std::string ComissPage::Identifier = "COMISS_PAGE";

ComissPage* ComissPage::create()
{
	ComissPage* instance = new ComissPage();
...
ComissPage::ComissPage() : super(ComissPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_Vector_Comiss::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_Vector_Comiss_Intro::create(),
...
ComissPage::~ComissPage()
{
}

void ComissPage::initializePositions()
{
...
void ComissPage::initializeListeners()
{
