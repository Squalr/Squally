...
const std::string SubssPage::Identifier = "SUBSS_PAGE";

SubssPage* SubssPage::create()
{
	SubssPage* instance = new SubssPage();
...
SubssPage::SubssPage() : super(SubssPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_Vector_Subss::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_Vector_Subss_Intro::create(),
...
void SubssPage::initializePositions()
{
...
void SubssPage::initializeListeners()
{
