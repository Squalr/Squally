...
const std::string MinssPage::Identifier = "MINSS_PAGE";

MinssPage* MinssPage::create()
{
	MinssPage* instance = new MinssPage();
...
MinssPage::MinssPage() : super(MinssPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_Vector_Minss::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_Vector_Minss_Intro::create(),
...
void MinssPage::initializePositions()
{
...
void MinssPage::initializeListeners()
{
