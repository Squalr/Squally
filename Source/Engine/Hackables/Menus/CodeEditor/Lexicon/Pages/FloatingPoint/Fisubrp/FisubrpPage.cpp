...
const std::string FisubrpPage::Identifier = "FISUBRP_PAGE";

FisubrpPage* FisubrpPage::create()
{
	FisubrpPage* instance = new FisubrpPage();
...
FisubrpPage::FisubrpPage() : super(FisubrpPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fisubrp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fisubrp_Intro::create(),
...
FisubrpPage::~FisubrpPage()
{
}

void FisubrpPage::initializePositions()
{
...
void FisubrpPage::initializeListeners()
{
