...
const std::string FsinPage::Identifier = "FSIN_PAGE";

FsinPage* FsinPage::create()
{
	FsinPage* instance = new FsinPage();
...
FsinPage::FsinPage() : super(FsinPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fsin::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fsin_Intro::create(),
...
void FsinPage::initializePositions()
{
...
void FsinPage::initializeListeners()
{
