...
const std::string FidivrpPage::Identifier = "FIDVRP_PAGE";

FidivrpPage* FidivrpPage::create()
{
	FidivrpPage* instance = new FidivrpPage();
...
FidivrpPage::FidivrpPage() : super(FidivrpPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fidivrp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fidivrp_Intro::create(),
...
FidivrpPage::~FidivrpPage()
{
}

void FidivrpPage::initializePositions()
{
...
void FidivrpPage::initializeListeners()
{
