...
const std::string FicomppPage::Identifier = "FICOMPP_PAGE";

FicomppPage* FicomppPage::create()
{
	FicomppPage* instance = new FicomppPage();
...
FicomppPage::FicomppPage() : super(FicomppPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Ficompp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Ficompp_Intro::create(),
...
FicomppPage::~FicomppPage()
{
}

void FicomppPage::initializePositions()
{
...
void FicomppPage::initializeListeners()
{
