...
const std::string FcmovnbePage::Identifier = "FCMOVNBE_PAGE";

FcmovnbePage* FcmovnbePage::create()
{
	FcmovnbePage* instance = new FcmovnbePage();
...
FcmovnbePage::FcmovnbePage() : super(FcmovnbePage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnbe::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fcmovnbe_Intro::create(),
...
FcmovnbePage::~FcmovnbePage()
{
}

void FcmovnbePage::initializePositions()
{
...
void FcmovnbePage::initializeListeners()
{
