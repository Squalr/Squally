...
const std::string FsqrtPage::Identifier = "FSQRT_PAGE";

FsqrtPage* FsqrtPage::create()
{
	FsqrtPage* instance = new FsqrtPage();
...
FsqrtPage::FsqrtPage() : super(FsqrtPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fsqrt::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fsqrt_Intro::create(),
...
void FsqrtPage::initializePositions()
{
...
void FsqrtPage::initializeListeners()
{
