...
const std::string FcosPage::Identifier = "FCOS_PAGE";

FcosPage* FcosPage::create()
{
	FcosPage* instance = new FcosPage();
...
FcosPage::FcosPage() : super(FcosPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fcos::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fcos_Intro::create(),
...
void FcosPage::initializePositions()
{
...
void FcosPage::initializeListeners()
{
