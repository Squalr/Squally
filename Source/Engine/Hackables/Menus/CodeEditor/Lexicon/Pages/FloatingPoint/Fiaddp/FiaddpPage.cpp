...
const std::string FiaddpPage::Identifier = "FIADDP_PAGE";

FiaddpPage* FiaddpPage::create()
{
	FiaddpPage* instance = new FiaddpPage();
...
FiaddpPage::FiaddpPage() : super(FiaddpPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fiaddp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fiaddp_Intro::create(),
...
FiaddpPage::~FiaddpPage()
{
}

void FiaddpPage::initializePositions()
{
...
void FiaddpPage::initializeListeners()
{
