...
const std::string FldpiPage::Identifier = "FLDPI_PAGE";

FldpiPage* FldpiPage::create()
{
	FldpiPage* instance = new FldpiPage();
...
FldpiPage::FldpiPage() : super(FldpiPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fldpi::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fldpi_Intro::create(),
...
void FldpiPage::initializePositions()
{
...
void FldpiPage::initializeListeners()
{
