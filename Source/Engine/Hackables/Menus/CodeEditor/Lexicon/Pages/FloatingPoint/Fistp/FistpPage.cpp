...
const std::string FistpPage::Identifier = "FISTP_PAGE";

FistpPage* FistpPage::create()
{
	FistpPage* instance = new FistpPage();
...
FistpPage::FistpPage() : super(FistpPage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_FloatingPoint_Fistp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_FloatingPoint_Fistp_Intro::create(),
...
void FistpPage::initializePositions()
{
...
void FistpPage::initializeListeners()
{
