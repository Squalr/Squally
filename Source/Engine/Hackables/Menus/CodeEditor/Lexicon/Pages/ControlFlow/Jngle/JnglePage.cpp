...
const std::string JnglePage::Identifier = "JNGLE_PAGE";

JnglePage* JnglePage::create()
{
	JnglePage* instance = new JnglePage();
...
JnglePage::JnglePage() : super(JnglePage::Identifier, PageType::Full)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jngle::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Jngle_Intro::create(),
...
void JnglePage::initializePositions()
{
...
void JnglePage::initializeListeners()
{
