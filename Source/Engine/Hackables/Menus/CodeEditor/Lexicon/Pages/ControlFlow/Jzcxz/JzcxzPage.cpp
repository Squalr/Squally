...
const std::string JzcxzPage::Identifier = "JZCXZ_PAGE";

JzcxzPage* JzcxzPage::create()
{
	JzcxzPage* instance = new JzcxzPage();
...
JzcxzPage::JzcxzPage() : super(JzcxzPage::Identifier, PageType::Full)
{
	...
	if (sizeof(void*) == 4)
	{
		this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jecxz::create());
	}
	else
	{
		this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jrcxz::create());
	}
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Jzcxz_Intro::create(),
...
void JzcxzPage::initializePositions()
{
...
void JzcxzPage::initializeListeners()
{
