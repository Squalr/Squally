...
const std::string RetPage::Identifier = "RET_PAGE";

RetPage* RetPage::create()
{
	RetPage* instance = new RetPage();
...
RetPage::RetPage() : super(RetPage::Identifier, PageType::Left)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Ret::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Ret_Intro::create(),
...
void RetPage::initializePositions()
{
...
void RetPage::initializeListeners()
{
