...
const std::string JnePage::Identifier = "JNE_PAGE";

JnePage* JnePage::create()
{
	JnePage* instance = new JnePage();
...
JnePage::JnePage() : super(JnePage::Identifier, PageType::Full)
{
	this->decorSprite = Sprite::create(UIResources::Menus_LexiconMenu_BookArt_Bread);
	this->chapterSprite = Sprite::create(UIResources::Menus_LexiconMenu_Chapter);
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jne::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Jne_Intro::create(),
...
void JnePage::initializePositions()
{
...
void JnePage::initializeListeners()
{
