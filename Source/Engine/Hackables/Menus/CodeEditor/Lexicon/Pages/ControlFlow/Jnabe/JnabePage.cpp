...
const std::string JnabePage::Identifier = "JNABE_PAGE";

JnabePage* JnabePage::create()
{
	JnabePage* instance = new JnabePage();
...
JnabePage::JnabePage() : super(JnabePage::Identifier, PageType::Full)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jnabe::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Jnabe_Intro::create(),
...
void JnabePage::initializePositions()
{
...
void JnabePage::initializeListeners()
{
