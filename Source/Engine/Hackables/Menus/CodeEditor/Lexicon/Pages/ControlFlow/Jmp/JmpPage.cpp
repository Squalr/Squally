...
const std::string JmpPage::Identifier = "JMP_PAGE";

JmpPage* JmpPage::create()
{
	JmpPage* instance = new JmpPage();
...
JmpPage::JmpPage() : super(JmpPage::Identifier, PageType::Full)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_ControlFlow_Jmp::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_ControlFlow_Jmp_Intro::create(),
...
void JmpPage::initializePositions()
{
...
void JmpPage::initializeListeners()
{
