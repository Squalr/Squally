...
#include "Strings/Hacking/Lexicon/Pages/Data/Sub/Intro.h"

using namespace cocos2d;

const std::string SubPage::Identifier = "SUB_PAGE";

SubPage* SubPage::create()
{
	SubPage* instance = new SubPage();
...
SubPage::SubPage() : super(SubPage::Identifier, PageType::Full)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Hacking_Lexicon_Instructions_Data_Sub::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Hacking_Lexicon_Pages_Data_Sub_Intro::create(),
...
void SubPage::initializePositions()
{
...
void SubPage::initializeListeners()
{
