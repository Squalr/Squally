...
#include "Strings/Menus/Hacking/Lexicon/Pages/Binary/Shr/Intro.h"
...
ShrPage::ShrPage() : super(ShrPage::Identifier, PageType::Full)
{
	...
	this->titleLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H2, Strings::Menus_Hacking_Lexicon_Instructions_Binary_Shr::create());
	this->introText = LocalizedLabel::create(
		LocalizedLabel::FontStyle::Main,
		LocalizedLabel::FontSize::P,
		Strings::Menus_Hacking_Lexicon_Pages_Binary_Shr_Intro::create(),
