...
namespace Strings
{
	PointerTrace_Assembly_Mov* PointerTrace_Assembly_Mov::create()
	{
		PointerTrace_Assembly_Mov* instance = new PointerTrace_Assembly_Mov();
	...
	LocalizedString* PointerTrace_Assembly_Mov::clone()
	{
		LocalizedString* clonedString = PointerTrace_Assembly_Mov::create();
	...
	PointerTrace_Assembly_Mov::PointerTrace_Assembly_Mov() : LocalizedString()
	{
	}

	PointerTrace_Assembly_Mov::~PointerTrace_Assembly_Mov()
	{
	}

	std::string PointerTrace_Assembly_Mov::getStringIdentifier()
	{
		return "PointerTrace_Assembly_Mov";
	}
