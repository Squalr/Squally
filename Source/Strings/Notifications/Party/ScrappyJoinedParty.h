...
namespace Strings
{
	class Notifications_Party_ScrappyJoinedParty : public LocalizedString
	{
	public:
		static Notifications_Party_ScrappyJoinedParty* create();
	...
	private:
		Notifications_Party_ScrappyJoinedParty();
		~Notifications_Party_ScrappyJoinedParty();
	};
}
