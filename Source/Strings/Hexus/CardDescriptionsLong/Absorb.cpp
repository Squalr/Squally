...
namespace Strings
{
	Hexus_CardDescriptionsLong_Absorb* Hexus_CardDescriptionsLong_Absorb::create()
	{
		Hexus_CardDescriptionsLong_Absorb* instance = new Hexus_CardDescriptionsLong_Absorb();
	...
	LocalizedString* Hexus_CardDescriptionsLong_Absorb::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptionsLong_Absorb::create();
	...
	Hexus_CardDescriptionsLong_Absorb::Hexus_CardDescriptionsLong_Absorb() : LocalizedString()
	{
	}

	Hexus_CardDescriptionsLong_Absorb::~Hexus_CardDescriptionsLong_Absorb()
	{
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringIdentifier()
	{
		return "Hexus_CardDescriptionsLong_Absorb";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringAr()
	{
		return "ضع في أي صف. ستحظر هذه البطاقة البطاقة الخاصة التالية التي يلعبها خصمك ، إذا كانت تستهدف بطاقة في ذلك الصف.";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringBg()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringCs()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringDa()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringDe()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringEl()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringEn()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringEs()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringEs419()
	{
		return "Colocar en cualquier fila. Esta carta bloqueará la siguiente carta especial que juegue tu oponente, si se dirige a una carta en esa fila.";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringFi()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringFr()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringHu()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringIt()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringJa()
	{
		return "任意の行に配置してください。それがその列のカードを対象にしている場合、このカードはあなたの対戦相手によってプレイされる次の特別なカードをブロックします。";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringKo()
	{
		return "행에 배치하십시오. 이 카드는 그 행의 카드를 대상으로하는 경우, 상대방이 다음에 플레이하는 특수 카드를 블록합니다.";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringNl()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringNo()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringPl()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringPt()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringPtBr()
	{
		return "Coloque em qualquer linha. Esta carta irá bloquear a próxima carta especial jogada pelo seu oponente, se ela atingir uma carta nessa linha.";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringRo()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringRu()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringSv()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringTh()
	{
		return "วางลงในแถวใดก็ได้ การ์ดใบนี้จะบล็อกการ์ดพิเศษใบถัดไปที่ฝ่ายตรงข้ามของคุณเล่นหากการ์ดเป้าหมายในแถวนั้น";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringTr()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringUk()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringVi()
	{
	...
	std::string Hexus_CardDescriptionsLong_Absorb::getStringZhCn()
	{
		return "放入任何一行。如果该对象针对该行中的一张牌，则此卡将阻止对手播放的下一张特殊牌。";
	}

	std::string Hexus_CardDescriptionsLong_Absorb::getStringZhTw()
	{
