...
namespace Strings
{
	Hexus_CardDescriptionsLong_Flip1* Hexus_CardDescriptionsLong_Flip1::create()
	{
		Hexus_CardDescriptionsLong_Flip1* instance = new Hexus_CardDescriptionsLong_Flip1();
	...
	LocalizedString* Hexus_CardDescriptionsLong_Flip1::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptionsLong_Flip1::create();
	...
	Hexus_CardDescriptionsLong_Flip1::Hexus_CardDescriptionsLong_Flip1() : LocalizedString()
	{
	}

	Hexus_CardDescriptionsLong_Flip1::~Hexus_CardDescriptionsLong_Flip1()
	{
	}

	std::string Hexus_CardDescriptionsLong_Flip1::getStringIdentifier()
	{
		return "Hexus_CardDescriptionsLong_Flip1";
	}
