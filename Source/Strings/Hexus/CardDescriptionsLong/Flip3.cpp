...
namespace Strings
{
	Hexus_CardDescriptionsLong_Flip3* Hexus_CardDescriptionsLong_Flip3::create()
	{
		Hexus_CardDescriptionsLong_Flip3* instance = new Hexus_CardDescriptionsLong_Flip3();
	...
	LocalizedString* Hexus_CardDescriptionsLong_Flip3::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptionsLong_Flip3::create();
	...
	Hexus_CardDescriptionsLong_Flip3::Hexus_CardDescriptionsLong_Flip3() : LocalizedString()
	{
	}

	Hexus_CardDescriptionsLong_Flip3::~Hexus_CardDescriptionsLong_Flip3()
	{
	}

	std::string Hexus_CardDescriptionsLong_Flip3::getStringIdentifier()
	{
		return "Hexus_CardDescriptionsLong_Flip3";
	}
