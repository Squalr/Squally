...
#include "DecimalCards.h"

namespace LocaleStrings
{
	DecimalCards* DecimalCards::create()
	{
		DecimalCards* instance = new DecimalCards();
	...
	LocalizedString* DecimalCards::clone()
	{
		return DecimalCards::create();
	}

	DecimalCards::DecimalCards() : LocalizedString()
	{
	}

	DecimalCards::~DecimalCards()
	{
	}
