...
namespace Strings
{
	Hexus_CardDescriptions_Heal* Hexus_CardDescriptions_Heal::create()
	{
		Hexus_CardDescriptions_Heal* instance = new Hexus_CardDescriptions_Heal();
	...
	LocalizedString* Hexus_CardDescriptions_Heal::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Heal::create();
	...
	Hexus_CardDescriptions_Heal::Hexus_CardDescriptions_Heal() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Heal::~Hexus_CardDescriptions_Heal()
	{
	}

	std::string Hexus_CardDescriptions_Heal::getStringIdentifier()
	{
		return "Hexus_CardDescriptions_Heal";
	}
