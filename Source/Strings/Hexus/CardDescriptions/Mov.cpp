...
namespace Strings
{
	Hexus_CardDescriptions_Mov* Hexus_CardDescriptions_Mov::create()
	{
		Hexus_CardDescriptions_Mov* instance = new Hexus_CardDescriptions_Mov();
	...
	LocalizedString* Hexus_CardDescriptions_Mov::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Mov::create();
	...
	Hexus_CardDescriptions_Mov::Hexus_CardDescriptions_Mov() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Mov::~Hexus_CardDescriptions_Mov()
	{
	}
