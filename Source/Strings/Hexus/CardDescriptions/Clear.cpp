...
namespace Strings
{
	Hexus_CardDescriptions_Clear* Hexus_CardDescriptions_Clear::create()
	{
		Hexus_CardDescriptions_Clear* instance = new Hexus_CardDescriptions_Clear();
	...
	LocalizedString* Hexus_CardDescriptions_Clear::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Clear::create();
	...
	Hexus_CardDescriptions_Clear::Hexus_CardDescriptions_Clear() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Clear::~Hexus_CardDescriptions_Clear()
	{
	}
