...
namespace Strings
{
	Hexus_CardDescriptions_Drank* Hexus_CardDescriptions_Drank::create()
	{
		Hexus_CardDescriptions_Drank* instance = new Hexus_CardDescriptions_Drank();
	...
	LocalizedString* Hexus_CardDescriptions_Drank::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Drank::create();
	...
	Hexus_CardDescriptions_Drank::Hexus_CardDescriptions_Drank() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Drank::~Hexus_CardDescriptions_Drank()
	{
	}

	std::string Hexus_CardDescriptions_Drank::getStringIdentifier()
	{
		return "Hexus_CardDescriptions_Drank";
	}
