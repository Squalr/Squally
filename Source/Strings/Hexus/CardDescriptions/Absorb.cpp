...
namespace Strings
{
	Hexus_CardDescriptions_Absorb* Hexus_CardDescriptions_Absorb::create()
	{
		Hexus_CardDescriptions_Absorb* instance = new Hexus_CardDescriptions_Absorb();
	...
	LocalizedString* Hexus_CardDescriptions_Absorb::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Absorb::create();
	...
	Hexus_CardDescriptions_Absorb::Hexus_CardDescriptions_Absorb() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Absorb::~Hexus_CardDescriptions_Absorb()
	{
	}

	std::string Hexus_CardDescriptions_Absorb::getStringIdentifier()
	{
		return "Hexus_CardDescriptions_Absorb";
	}
