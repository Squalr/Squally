...
namespace Strings
{
	Hexus_CardDescriptions_Poison* Hexus_CardDescriptions_Poison::create()
	{
		Hexus_CardDescriptions_Poison* instance = new Hexus_CardDescriptions_Poison();
	...
	LocalizedString* Hexus_CardDescriptions_Poison::clone()
	{
		LocalizedString* clonedString = Hexus_CardDescriptions_Poison::create();
	...
	Hexus_CardDescriptions_Poison::Hexus_CardDescriptions_Poison() : LocalizedString()
	{
	}

	Hexus_CardDescriptions_Poison::~Hexus_CardDescriptions_Poison()
	{
	}

	std::string Hexus_CardDescriptions_Poison::getStringIdentifier()
	{
		return "Hexus_CardDescriptions_Poison";
	}
