...
namespace Strings
{
	Hexus_Cards_Mov* Hexus_Cards_Mov::create()
	{
		Hexus_Cards_Mov* instance = new Hexus_Cards_Mov();
	...
	LocalizedString* Hexus_Cards_Mov::clone()
	{
		LocalizedString* clonedString = Hexus_Cards_Mov::create();
	...
	Hexus_Cards_Mov::Hexus_Cards_Mov() : LocalizedString()
	{
	}

	Hexus_Cards_Mov::~Hexus_Cards_Mov()
	{
	}
