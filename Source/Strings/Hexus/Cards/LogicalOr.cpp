...
namespace Strings
{
	Hexus_Cards_LogicalOr* Hexus_Cards_LogicalOr::create()
	{
		Hexus_Cards_LogicalOr* instance = new Hexus_Cards_LogicalOr();
	...
	LocalizedString* Hexus_Cards_LogicalOr::clone()
	{
		LocalizedString* clonedString = Hexus_Cards_LogicalOr::create();
	...
	Hexus_Cards_LogicalOr::Hexus_Cards_LogicalOr() : LocalizedString()
	{
	}

	Hexus_Cards_LogicalOr::~Hexus_Cards_LogicalOr()
	{
	}
