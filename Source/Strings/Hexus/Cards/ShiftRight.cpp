...
namespace Strings
{
	Hexus_Cards_ShiftRight* Hexus_Cards_ShiftRight::create()
	{
		Hexus_Cards_ShiftRight* instance = new Hexus_Cards_ShiftRight();
	...
	LocalizedString* Hexus_Cards_ShiftRight::clone()
	{
		LocalizedString* clonedString = Hexus_Cards_ShiftRight::create();
	...
	Hexus_Cards_ShiftRight::Hexus_Cards_ShiftRight() : LocalizedString()
	{
	}

	Hexus_Cards_ShiftRight::~Hexus_Cards_ShiftRight()
	{
	}
