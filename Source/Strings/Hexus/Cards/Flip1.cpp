...
namespace Strings
{
	Hexus_Cards_Flip1* Hexus_Cards_Flip1::create()
	{
		Hexus_Cards_Flip1* instance = new Hexus_Cards_Flip1();
	...
	LocalizedString* Hexus_Cards_Flip1::clone()
	{
		return Hexus_Cards_Flip1::create();
	}

	Hexus_Cards_Flip1::Hexus_Cards_Flip1() : LocalizedString()
	{
	}

	Hexus_Cards_Flip1::~Hexus_Cards_Flip1()
	{
	}
