...
namespace Strings
{
	Hexus_Cards_Flip4* Hexus_Cards_Flip4::create()
	{
		Hexus_Cards_Flip4* instance = new Hexus_Cards_Flip4();
	...
	LocalizedString* Hexus_Cards_Flip4::clone()
	{
		return Hexus_Cards_Flip4::create();
	}

	Hexus_Cards_Flip4::Hexus_Cards_Flip4() : LocalizedString()
	{
	}

	Hexus_Cards_Flip4::~Hexus_Cards_Flip4()
	{
	}
