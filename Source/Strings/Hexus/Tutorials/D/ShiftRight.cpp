...
{
	ShiftRight* ShiftRight::create()
	{
		ShiftRight* instance = new ShiftRight();
	...
	LocalizedString* ShiftRight::clone()
	{
		return ShiftRight::create();
	}

	ShiftRight::ShiftRight() : LocalizedString()
	{
	}
