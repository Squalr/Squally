...
namespace Strings
{
	...
	{
		LocalizedString* clonedString = Hexus_Tutorials_A_BinCards::create();
	...
	std::string Hexus_Tutorials_A_BinCards::getStringIdentifier()
	{
		return "Hexus_Tutorials_A_BinCards";
	}
