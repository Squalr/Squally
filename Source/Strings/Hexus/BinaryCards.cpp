...
#include "BinaryCards.h"

namespace LocaleStrings
{
	BinaryCards* BinaryCards::create()
	{
	...
	LocalizedString* BinaryCards::clone()
	{
		return BinaryCards::create();
	}

	BinaryCards::BinaryCards() : LocalizedString()
	{
	}

	BinaryCards::~BinaryCards()
	{
	}
