...
namespace Strings
{
	class Items_Misc_Essences_EssenceOfUndeath : public LocalizedString
	{
	public:
		static Items_Misc_Essences_EssenceOfUndeath* create();
	...
	private:
		Items_Misc_Essences_EssenceOfUndeath();
		~Items_Misc_Essences_EssenceOfUndeath();
	};
}
