...
namespace Strings
{
	class Items_Misc_Essences_EssenceOfLightning : public LocalizedString
	{
	public:
		static Items_Misc_Essences_EssenceOfLightning* create();
	...
	private:
		Items_Misc_Essences_EssenceOfLightning();
		~Items_Misc_Essences_EssenceOfLightning();
	};
}
