...
namespace Strings
{
	class Hacking_Objects_FloatingObjects_GetDensity_GetDensity : public LocalizedString
	{
	public:
		static Hacking_Objects_FloatingObjects_GetDensity_GetDensity* create();
	...
	private:
		Hacking_Objects_FloatingObjects_GetDensity_GetDensity();
		~Hacking_Objects_FloatingObjects_GetDensity_GetDensity();
	};
}
