...
namespace Strings
{
	class Hacking_Objects_FloatingObjects_GetDensity_RegisterXmm1 : public LocalizedString
	{
	public:
		static Hacking_Objects_FloatingObjects_GetDensity_RegisterXmm1* create();
	...
	private:
		Hacking_Objects_FloatingObjects_GetDensity_RegisterXmm1();
		~Hacking_Objects_FloatingObjects_GetDensity_RegisterXmm1();
	};
}
