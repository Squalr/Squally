...
namespace Strings
{
	class Hacking_Objects_FloatingObjects_GetDensity_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_FloatingObjects_GetDensity_RegisterEax* create();
	...
	private:
		Hacking_Objects_FloatingObjects_GetDensity_RegisterEax();
		~Hacking_Objects_FloatingObjects_GetDensity_RegisterEax();
	};
}
