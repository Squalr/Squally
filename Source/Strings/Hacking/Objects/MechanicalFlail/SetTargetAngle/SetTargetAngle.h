...
namespace Strings
{
	class Hacking_Objects_MechanicalFlail_SetTargetAngle_SetTargetAngle : public LocalizedString
	{
	public:
		static Hacking_Objects_MechanicalFlail_SetTargetAngle_SetTargetAngle* create();
	...
	private:
		Hacking_Objects_MechanicalFlail_SetTargetAngle_SetTargetAngle();
		~Hacking_Objects_MechanicalFlail_SetTargetAngle_SetTargetAngle();
	};
}
