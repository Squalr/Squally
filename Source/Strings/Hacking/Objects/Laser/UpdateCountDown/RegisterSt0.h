...
namespace Strings
{
	class Hacking_Objects_Laser_UpdateCountDown_RegisterSt0 : public LocalizedString
	{
	public:
		static Hacking_Objects_Laser_UpdateCountDown_RegisterSt0* create();
	...
	private:
		Hacking_Objects_Laser_UpdateCountDown_RegisterSt0();
		~Hacking_Objects_Laser_UpdateCountDown_RegisterSt0();
	};
}
