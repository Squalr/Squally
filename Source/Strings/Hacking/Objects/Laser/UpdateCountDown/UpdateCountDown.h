...
namespace Strings
{
	class Hacking_Objects_Laser_UpdateCountDown_UpdateCountDown : public LocalizedString
	{
	public:
		static Hacking_Objects_Laser_UpdateCountDown_UpdateCountDown* create();
	...
	private:
		Hacking_Objects_Laser_UpdateCountDown_UpdateCountDown();
		~Hacking_Objects_Laser_UpdateCountDown_UpdateCountDown();
	};
}
