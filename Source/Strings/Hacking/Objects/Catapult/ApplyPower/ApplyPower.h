...
namespace Strings
{
	class Hacking_Objects_Catapult_ApplyPower_ApplyPower : public LocalizedString
	{
	public:
		static Hacking_Objects_Catapult_ApplyPower_ApplyPower* create();
	...
	private:
		Hacking_Objects_Catapult_ApplyPower_ApplyPower();
		~Hacking_Objects_Catapult_ApplyPower_ApplyPower();
	};
}
