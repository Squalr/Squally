...
namespace Strings
{
	class Hacking_Objects_Catapult_ApplyPower_RegisterXmm0 : public LocalizedString
	{
	public:
		static Hacking_Objects_Catapult_ApplyPower_RegisterXmm0* create();
	...
	private:
		Hacking_Objects_Catapult_ApplyPower_RegisterXmm0();
		~Hacking_Objects_Catapult_ApplyPower_RegisterXmm0();
	};
}
