...
namespace Strings
{
	class Hacking_Objects_Catapult_ApplyPower_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_Catapult_ApplyPower_RegisterEax* create();
	...
	private:
		Hacking_Objects_Catapult_ApplyPower_RegisterEax();
		~Hacking_Objects_Catapult_ApplyPower_RegisterEax();
	};
}
