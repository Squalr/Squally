...
namespace Strings
{
	class Hacking_Objects_PuzzleDoor_Multiply_RegisterEcx : public LocalizedString
	{
	public:
		static Hacking_Objects_PuzzleDoor_Multiply_RegisterEcx* create();
	...
	private:
		Hacking_Objects_PuzzleDoor_Multiply_RegisterEcx();
		~Hacking_Objects_PuzzleDoor_Multiply_RegisterEcx();
	};
}
