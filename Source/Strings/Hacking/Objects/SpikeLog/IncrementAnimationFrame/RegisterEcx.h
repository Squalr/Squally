...
namespace Strings
{
	class Hacking_Objects_SpikeLog_IncrementAnimationFrame_RegisterEcx : public LocalizedString
	{
	public:
		static Hacking_Objects_SpikeLog_IncrementAnimationFrame_RegisterEcx* create();
	...
	private:
		Hacking_Objects_SpikeLog_IncrementAnimationFrame_RegisterEcx();
		~Hacking_Objects_SpikeLog_IncrementAnimationFrame_RegisterEcx();
	};
}
