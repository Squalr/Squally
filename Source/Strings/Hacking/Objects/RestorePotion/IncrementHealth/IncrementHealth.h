...
namespace Strings
{
	class Hacking_Objects_RestorePotion_IncrementHealth_IncrementHealth : public LocalizedString
	{
	public:
		static Hacking_Objects_RestorePotion_IncrementHealth_IncrementHealth* create();
	...
	private:
		Hacking_Objects_RestorePotion_IncrementHealth_IncrementHealth();
		~Hacking_Objects_RestorePotion_IncrementHealth_IncrementHealth();
	};
}
