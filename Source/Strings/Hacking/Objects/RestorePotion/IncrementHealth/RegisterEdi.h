...
namespace Strings
{
	class Hacking_Objects_RestorePotion_IncrementHealth_RegisterEdi : public LocalizedString
	{
	public:
		static Hacking_Objects_RestorePotion_IncrementHealth_RegisterEdi* create();
	...
	private:
		Hacking_Objects_RestorePotion_IncrementHealth_RegisterEdi();
		~Hacking_Objects_RestorePotion_IncrementHealth_RegisterEdi();
	};
}
