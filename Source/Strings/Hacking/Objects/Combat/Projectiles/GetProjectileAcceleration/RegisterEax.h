...
namespace Strings
{
	class Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEax* create();
	...
	private:
		Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEax();
		~Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEax();
	};
}
