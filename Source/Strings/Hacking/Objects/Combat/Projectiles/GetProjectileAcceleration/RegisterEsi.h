...
namespace Strings
{
	class Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEsi : public LocalizedString
	{
	public:
		static Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEsi* create();
	...
	private:
		Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEsi();
		~Hacking_Objects_Combat_Projectiles_GetProjectileAcceleration_RegisterEsi();
	};
}
