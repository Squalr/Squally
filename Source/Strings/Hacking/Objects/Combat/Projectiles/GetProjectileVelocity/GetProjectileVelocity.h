...
namespace Strings
{
	class Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_GetProjectileVelocity : public LocalizedString
	{
	public:
		static Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_GetProjectileVelocity* create();
	...
	private:
		Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_GetProjectileVelocity();
		~Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_GetProjectileVelocity();
	};
}
