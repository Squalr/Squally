...
namespace Strings
{
	class Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEbx* create();
	...
	private:
		Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEbx();
		~Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEbx();
	};
}
