...
namespace Strings
{
	class Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEax* create();
	...
	private:
		Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEax();
		~Hacking_Objects_Combat_Projectiles_GetProjectileVelocity_RegisterEax();
	};
}
