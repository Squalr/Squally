...
namespace Strings
{
	Hacking_Objects_Wind_SetWindSpeed_RegisterEbx* Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::create()
	{
		Hacking_Objects_Wind_SetWindSpeed_RegisterEbx* instance = new Hacking_Objects_Wind_SetWindSpeed_RegisterEbx();
	...
	LocalizedString* Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::clone()
	{
		LocalizedString* clonedString = Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::create();
	...
	Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::Hacking_Objects_Wind_SetWindSpeed_RegisterEbx() : LocalizedString()
	{
	}

	Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::~Hacking_Objects_Wind_SetWindSpeed_RegisterEbx()
	{
	}

	std::string Hacking_Objects_Wind_SetWindSpeed_RegisterEbx::getStringIdentifier()
	{
		return "Hacking_Objects_Wind_SetWindSpeed_RegisterEbx";
	}
