...
namespace Strings
{
	class Hacking_Objects_Wind_SetWindSpeed_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Objects_Wind_SetWindSpeed_RegisterEbx* create();
	...
	private:
		Hacking_Objects_Wind_SetWindSpeed_RegisterEbx();
		~Hacking_Objects_Wind_SetWindSpeed_RegisterEbx();
	};
}
