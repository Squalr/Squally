...
namespace Strings
{
	class Hacking_Objects_Wind_SetWindSpeed_SetWindSpeed : public LocalizedString
	{
	public:
		static Hacking_Objects_Wind_SetWindSpeed_SetWindSpeed* create();
	...
	private:
		Hacking_Objects_Wind_SetWindSpeed_SetWindSpeed();
		~Hacking_Objects_Wind_SetWindSpeed_SetWindSpeed();
	};
}
