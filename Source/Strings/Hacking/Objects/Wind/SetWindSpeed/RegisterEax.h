...
namespace Strings
{
	class Hacking_Objects_Wind_SetWindSpeed_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_Wind_SetWindSpeed_RegisterEax* create();
	...
	private:
		Hacking_Objects_Wind_SetWindSpeed_RegisterEax();
		~Hacking_Objects_Wind_SetWindSpeed_RegisterEax();
	};
}
