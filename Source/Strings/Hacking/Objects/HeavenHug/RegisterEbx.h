...
namespace Strings
{
	class Hacking_Objects_HeavenHug_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Objects_HeavenHug_RegisterEbx* create();
	...
	private:
		Hacking_Objects_HeavenHug_RegisterEbx();
		~Hacking_Objects_HeavenHug_RegisterEbx();
	};
}
