...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEsp : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEsp* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEsp();
		~Hacking_Objects_Previews_RegisterEsp();
	};
}
