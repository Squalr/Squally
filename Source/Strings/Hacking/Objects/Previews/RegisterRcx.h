...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRcx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRcx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRcx();
		~Hacking_Objects_Previews_RegisterRcx();
	};
}
