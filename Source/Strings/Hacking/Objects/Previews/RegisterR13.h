...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR13 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR13* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR13();
		~Hacking_Objects_Previews_RegisterR13();
	};
}
