...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEcx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEcx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEcx();
		~Hacking_Objects_Previews_RegisterEcx();
	};
}
