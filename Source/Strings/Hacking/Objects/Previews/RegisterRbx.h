...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRbx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRbx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRbx();
		~Hacking_Objects_Previews_RegisterRbx();
	};
}
