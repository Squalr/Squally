...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR10 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR10* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR10();
		~Hacking_Objects_Previews_RegisterR10();
	};
}
