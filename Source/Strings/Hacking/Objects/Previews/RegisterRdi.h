...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRdi : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRdi* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRdi();
		~Hacking_Objects_Previews_RegisterRdi();
	};
}
