...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEsi : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEsi* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEsi();
		~Hacking_Objects_Previews_RegisterEsi();
	};
}
