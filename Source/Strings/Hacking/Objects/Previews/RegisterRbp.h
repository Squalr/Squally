...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRbp : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRbp* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRbp();
		~Hacking_Objects_Previews_RegisterRbp();
	};
}
