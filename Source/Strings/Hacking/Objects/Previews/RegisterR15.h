...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR15 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR15* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR15();
		~Hacking_Objects_Previews_RegisterR15();
	};
}
