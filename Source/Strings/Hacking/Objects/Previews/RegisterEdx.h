...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEdx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEdx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEdx();
		~Hacking_Objects_Previews_RegisterEdx();
	};
}
