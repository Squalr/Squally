...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEdi : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEdi* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEdi();
		~Hacking_Objects_Previews_RegisterEdi();
	};
}
