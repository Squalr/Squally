...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRsp : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRsp* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRsp();
		~Hacking_Objects_Previews_RegisterRsp();
	};
}
