...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRspWarning : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRspWarning* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRspWarning();
		~Hacking_Objects_Previews_RegisterRspWarning();
	};
}
