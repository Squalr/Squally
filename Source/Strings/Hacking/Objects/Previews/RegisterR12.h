...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR12 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR12* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR12();
		~Hacking_Objects_Previews_RegisterR12();
	};
}
