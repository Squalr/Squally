...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRdx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRdx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRdx();
		~Hacking_Objects_Previews_RegisterRdx();
	};
}
