...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR11 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR11* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR11();
		~Hacking_Objects_Previews_RegisterR11();
	};
}
