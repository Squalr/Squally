...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterR14 : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterR14* create();
	...
	private:
		Hacking_Objects_Previews_RegisterR14();
		~Hacking_Objects_Previews_RegisterR14();
	};
}
