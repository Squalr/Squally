...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEbx* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEbx();
		~Hacking_Objects_Previews_RegisterEbx();
	};
}
