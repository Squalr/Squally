...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEbp : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEbp* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEbp();
		~Hacking_Objects_Previews_RegisterEbp();
	};
}
