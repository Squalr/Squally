...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRsi : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRsi* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRsi();
		~Hacking_Objects_Previews_RegisterRsi();
	};
}
