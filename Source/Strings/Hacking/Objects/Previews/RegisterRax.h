...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterRax : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterRax* create();
	...
	private:
		Hacking_Objects_Previews_RegisterRax();
		~Hacking_Objects_Previews_RegisterRax();
	};
}
