...
namespace Strings
{
	class Hacking_Objects_Previews_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Objects_Previews_RegisterEax* create();
	...
	private:
		Hacking_Objects_Previews_RegisterEax();
		~Hacking_Objects_Previews_RegisterEax();
	};
}
