...
namespace Strings
{
	class Hacking_Objects_MetalSpikes_UpdateTimer_UpdateTimer : public LocalizedString
	{
	public:
		static Hacking_Objects_MetalSpikes_UpdateTimer_UpdateTimer* create();
	...
	private:
		Hacking_Objects_MetalSpikes_UpdateTimer_UpdateTimer();
		~Hacking_Objects_MetalSpikes_UpdateTimer_UpdateTimer();
	};
}
