...
namespace Strings
{
	class Hacking_Objects_PendulumBlade_TargetAngle : public LocalizedString
	{
	public:
		static Hacking_Objects_PendulumBlade_TargetAngle* create();
	...
	private:
		Hacking_Objects_PendulumBlade_TargetAngle();
		~Hacking_Objects_PendulumBlade_TargetAngle();
	};
}
