...
namespace Strings
{
	class Hacking_CodeEditor_Errors_UnknownError : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_UnknownError* create();
	...
	private:
		Hacking_CodeEditor_Errors_UnknownError();
		~Hacking_CodeEditor_Errors_UnknownError();
	};
}
