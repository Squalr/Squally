...
namespace Strings
{
	class Hacking_CodeEditor_Errors_LabelNameTooLong : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_LabelNameTooLong* create();
	...
	private:
		Hacking_CodeEditor_Errors_LabelNameTooLong();
		~Hacking_CodeEditor_Errors_LabelNameTooLong();
	};
}
