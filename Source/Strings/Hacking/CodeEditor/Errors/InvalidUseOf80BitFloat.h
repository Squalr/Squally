...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseOf80BitFloat : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseOf80BitFloat* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseOf80BitFloat();
		~Hacking_CodeEditor_Errors_InvalidUseOf80BitFloat();
	};
}
