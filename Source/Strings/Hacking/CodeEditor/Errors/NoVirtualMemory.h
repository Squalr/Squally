...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NoVirtualMemory : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NoVirtualMemory* create();
	...
	private:
		Hacking_CodeEditor_Errors_NoVirtualMemory();
		~Hacking_CodeEditor_Errors_NoVirtualMemory();
	};
}
