...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidAddressScale : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidAddressScale* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidAddressScale();
		~Hacking_CodeEditor_Errors_InvalidAddressScale();
	};
}
