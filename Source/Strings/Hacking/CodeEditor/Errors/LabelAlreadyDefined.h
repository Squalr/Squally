...
namespace Strings
{
	class Hacking_CodeEditor_Errors_LabelAlreadyDefined : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_LabelAlreadyDefined* create();
	...
	private:
		Hacking_CodeEditor_Errors_LabelAlreadyDefined();
		~Hacking_CodeEditor_Errors_LabelAlreadyDefined();
	};
}
