...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidState : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidState* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidState();
		~Hacking_CodeEditor_Errors_InvalidState();
	};
}
