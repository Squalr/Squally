...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRepPrefix : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRepPrefix* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRepPrefix();
		~Hacking_CodeEditor_Errors_InvalidRepPrefix();
	};
}
