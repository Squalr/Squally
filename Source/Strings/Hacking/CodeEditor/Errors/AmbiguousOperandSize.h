...
namespace Strings
{
	class Hacking_CodeEditor_Errors_AmbiguousOperandSize : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_AmbiguousOperandSize* create();
	...
	private:
		Hacking_CodeEditor_Errors_AmbiguousOperandSize();
		~Hacking_CodeEditor_Errors_AmbiguousOperandSize();
	};
}
