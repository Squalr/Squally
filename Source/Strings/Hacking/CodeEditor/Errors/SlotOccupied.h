...
namespace Strings
{
	class Hacking_CodeEditor_Errors_SlotOccupied : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_SlotOccupied* create();
	...
	private:
		Hacking_CodeEditor_Errors_SlotOccupied();
		~Hacking_CodeEditor_Errors_SlotOccupied();
	};
}
