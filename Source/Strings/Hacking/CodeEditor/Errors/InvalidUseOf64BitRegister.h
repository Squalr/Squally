...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseOf64BitRegister : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseOf64BitRegister* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseOf64BitRegister();
		~Hacking_CodeEditor_Errors_InvalidUseOf64BitRegister();
	};
}
