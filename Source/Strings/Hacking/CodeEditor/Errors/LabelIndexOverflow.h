...
namespace Strings
{
	class Hacking_CodeEditor_Errors_LabelIndexOverflow : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_LabelIndexOverflow* create();
	...
	private:
		Hacking_CodeEditor_Errors_LabelIndexOverflow();
		~Hacking_CodeEditor_Errors_LabelIndexOverflow();
	};
}
