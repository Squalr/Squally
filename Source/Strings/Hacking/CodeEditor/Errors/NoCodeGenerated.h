...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NoCodeGenerated : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NoCodeGenerated* create();
	...
	private:
		Hacking_CodeEditor_Errors_NoCodeGenerated();
		~Hacking_CodeEditor_Errors_NoCodeGenerated();
	};
}
