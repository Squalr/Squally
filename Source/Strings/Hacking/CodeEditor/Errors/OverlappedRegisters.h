...
namespace Strings
{
	class Hacking_CodeEditor_Errors_OverlappedRegisters : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_OverlappedRegisters* create();
	...
	private:
		Hacking_CodeEditor_Errors_OverlappedRegisters();
		~Hacking_CodeEditor_Errors_OverlappedRegisters();
	};
}
