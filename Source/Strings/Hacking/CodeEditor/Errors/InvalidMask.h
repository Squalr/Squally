...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidMask : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidMask* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidMask();
		~Hacking_CodeEditor_Errors_InvalidMask();
	};
}
