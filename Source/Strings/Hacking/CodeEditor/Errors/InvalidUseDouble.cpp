...
#include "InvalidUseDouble.h"

namespace Strings
{
	Hacking_CodeEditor_Errors_InvalidUseDouble* Hacking_CodeEditor_Errors_InvalidUseDouble::create()
	{
		Hacking_CodeEditor_Errors_InvalidUseDouble* instance = new Hacking_CodeEditor_Errors_InvalidUseDouble();
	...
	LocalizedString* Hacking_CodeEditor_Errors_InvalidUseDouble::clone()
	{
		LocalizedString* clonedString = Hacking_CodeEditor_Errors_InvalidUseDouble::create();
	...
	Hacking_CodeEditor_Errors_InvalidUseDouble::Hacking_CodeEditor_Errors_InvalidUseDouble() : LocalizedString()
	{
	}

	Hacking_CodeEditor_Errors_InvalidUseDouble::~Hacking_CodeEditor_Errors_InvalidUseDouble()
	{
	}

	std::string Hacking_CodeEditor_Errors_InvalidUseDouble::getStringIdentifier()
	{
		return "Hacking_CodeEditor_Errors_InvalidUseDouble";
	}
