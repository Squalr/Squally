...
namespace Strings
{
	class Hacking_CodeEditor_Errors_AlreadyInitialized : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_AlreadyInitialized* create();
	...
	private:
		Hacking_CodeEditor_Errors_AlreadyInitialized();
		~Hacking_CodeEditor_Errors_AlreadyInitialized();
	};
}
