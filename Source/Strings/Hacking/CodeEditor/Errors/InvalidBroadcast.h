...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidBroadcast : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidBroadcast* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidBroadcast();
		~Hacking_CodeEditor_Errors_InvalidBroadcast();
	};
}
