...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NotInitialized : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NotInitialized* create();
	...
	private:
		Hacking_CodeEditor_Errors_NotInitialized();
		~Hacking_CodeEditor_Errors_NotInitialized();
	};
}
