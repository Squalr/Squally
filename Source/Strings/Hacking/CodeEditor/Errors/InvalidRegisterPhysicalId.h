...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRegisterPhysicalId : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRegisterPhysicalId* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRegisterPhysicalId();
		~Hacking_CodeEditor_Errors_InvalidRegisterPhysicalId();
	};
}
