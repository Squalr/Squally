...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRegisterVirtualId : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRegisterVirtualId* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRegisterVirtualId();
		~Hacking_CodeEditor_Errors_InvalidRegisterVirtualId();
	};
}
