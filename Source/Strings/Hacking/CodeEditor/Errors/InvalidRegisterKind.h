...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRegisterKind : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRegisterKind* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRegisterKind();
		~Hacking_CodeEditor_Errors_InvalidRegisterKind();
	};
}
