...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidLabelName : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidLabelName* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidLabelName();
		~Hacking_CodeEditor_Errors_InvalidLabelName();
	};
}
