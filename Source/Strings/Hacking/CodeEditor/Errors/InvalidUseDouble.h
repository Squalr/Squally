...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseDouble : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseDouble* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseDouble();
		~Hacking_CodeEditor_Errors_InvalidUseDouble();
	};
}
