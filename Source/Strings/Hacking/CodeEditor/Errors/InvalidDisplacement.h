...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidDisplacement : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidDisplacement* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidDisplacement();
		~Hacking_CodeEditor_Errors_InvalidDisplacement();
	};
}
