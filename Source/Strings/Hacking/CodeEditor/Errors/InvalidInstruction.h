...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidInstruction : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidInstruction* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidInstruction();
		~Hacking_CodeEditor_Errors_InvalidInstruction();
	};
}
