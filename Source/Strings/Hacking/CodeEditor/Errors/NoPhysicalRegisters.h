...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NoPhysicalRegisters : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NoPhysicalRegisters* create();
	...
	private:
		Hacking_CodeEditor_Errors_NoPhysicalRegisters();
		~Hacking_CodeEditor_Errors_NoPhysicalRegisters();
	};
}
