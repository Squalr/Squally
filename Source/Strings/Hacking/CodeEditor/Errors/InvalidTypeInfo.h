...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidTypeInfo : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidTypeInfo* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidTypeInfo();
		~Hacking_CodeEditor_Errors_InvalidTypeInfo();
	};
}
