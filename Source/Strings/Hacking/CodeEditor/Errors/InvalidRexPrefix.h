...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRexPrefix : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRexPrefix* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRexPrefix();
		~Hacking_CodeEditor_Errors_InvalidRexPrefix();
	};
}
