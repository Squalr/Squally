...
namespace Strings
{
	class Hacking_CodeEditor_Errors_OperandSizeMismatch : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_OperandSizeMismatch* create();
	...
	private:
		Hacking_CodeEditor_Errors_OperandSizeMismatch();
		~Hacking_CodeEditor_Errors_OperandSizeMismatch();
	};
}
