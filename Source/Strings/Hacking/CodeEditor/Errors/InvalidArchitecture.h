...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidArchitecture : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidArchitecture* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidArchitecture();
		~Hacking_CodeEditor_Errors_InvalidArchitecture();
	};
}
