...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidLockPrefix : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidLockPrefix* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidLockPrefix();
		~Hacking_CodeEditor_Errors_InvalidLockPrefix();
	};
}
