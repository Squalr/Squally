...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidSegment : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidSegment* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidSegment();
		~Hacking_CodeEditor_Errors_InvalidSegment();
	};
}
