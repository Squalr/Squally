...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidXAquirePrefix : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidXAquirePrefix* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidXAquirePrefix();
		~Hacking_CodeEditor_Errors_InvalidXAquirePrefix();
	};
}
