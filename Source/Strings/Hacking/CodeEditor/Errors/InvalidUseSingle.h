...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseSingle : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseSingle* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseSingle();
		~Hacking_CodeEditor_Errors_InvalidUseSingle();
	};
}
