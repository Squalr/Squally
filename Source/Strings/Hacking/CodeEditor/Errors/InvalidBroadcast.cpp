...
namespace Strings
{
	Hacking_CodeEditor_Errors_InvalidBroadcast* Hacking_CodeEditor_Errors_InvalidBroadcast::create()
	{
		Hacking_CodeEditor_Errors_InvalidBroadcast* instance = new Hacking_CodeEditor_Errors_InvalidBroadcast();
	...
	LocalizedString* Hacking_CodeEditor_Errors_InvalidBroadcast::clone()
	{
		return Hacking_CodeEditor_Errors_InvalidBroadcast::create();
	}

	Hacking_CodeEditor_Errors_InvalidBroadcast::Hacking_CodeEditor_Errors_InvalidBroadcast() : LocalizedString()
	{
	}

	Hacking_CodeEditor_Errors_InvalidBroadcast::~Hacking_CodeEditor_Errors_InvalidBroadcast()
	{
	}

	std::string Hacking_CodeEditor_Errors_InvalidBroadcast::getStringIdentifier()
	{
		return "Hacking_CodeEditor_Errors_InvalidBroadcast";
	}
