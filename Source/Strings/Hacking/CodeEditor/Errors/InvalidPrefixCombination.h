...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidPrefixCombination : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidPrefixCombination* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidPrefixCombination();
		~Hacking_CodeEditor_Errors_InvalidPrefixCombination();
	};
}
