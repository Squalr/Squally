...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidOperandSize : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidOperandSize* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidOperandSize();
		~Hacking_CodeEditor_Errors_InvalidOperandSize();
	};
}
