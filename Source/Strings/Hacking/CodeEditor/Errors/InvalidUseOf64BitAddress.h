...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseOf64BitAddress : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseOf64BitAddress* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseOf64BitAddress();
		~Hacking_CodeEditor_Errors_InvalidUseOf64BitAddress();
	};
}
