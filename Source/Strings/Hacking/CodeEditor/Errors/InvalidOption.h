...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidOption : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidOption* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidOption();
		~Hacking_CodeEditor_Errors_InvalidOption();
	};
}
