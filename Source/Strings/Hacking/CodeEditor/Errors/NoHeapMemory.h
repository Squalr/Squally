...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NoHeapMemory : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NoHeapMemory* create();
	...
	private:
		Hacking_CodeEditor_Errors_NoHeapMemory();
		~Hacking_CodeEditor_Errors_NoHeapMemory();
	};
}
