...
namespace Strings
{
	class Hacking_CodeEditor_Errors_RelocationIndexOverflow : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_RelocationIndexOverflow* create();
	...
	private:
		Hacking_CodeEditor_Errors_RelocationIndexOverflow();
		~Hacking_CodeEditor_Errors_RelocationIndexOverflow();
	};
}
