...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidUseOf8BitRegister : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidUseOf8BitRegister* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidUseOf8BitRegister();
		~Hacking_CodeEditor_Errors_InvalidUseOf8BitRegister();
	};
}
