...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NotConsecutiveRegisters : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NotConsecutiveRegisters* create();
	...
	private:
		Hacking_CodeEditor_Errors_NotConsecutiveRegisters();
		~Hacking_CodeEditor_Errors_NotConsecutiveRegisters();
	};
}
