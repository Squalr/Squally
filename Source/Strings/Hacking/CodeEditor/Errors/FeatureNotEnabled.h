...
namespace Strings
{
	class Hacking_CodeEditor_Errors_FeatureNotEnabled : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_FeatureNotEnabled* create();
	...
	private:
		Hacking_CodeEditor_Errors_FeatureNotEnabled();
		~Hacking_CodeEditor_Errors_FeatureNotEnabled();
	};
}
