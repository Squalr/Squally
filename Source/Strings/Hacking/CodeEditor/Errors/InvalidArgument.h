...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidArgument : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidArgument* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidArgument();
		~Hacking_CodeEditor_Errors_InvalidArgument();
	};
}
