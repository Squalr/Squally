...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRelocationEntry : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRelocationEntry* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRelocationEntry();
		~Hacking_CodeEditor_Errors_InvalidRelocationEntry();
	};
}
