...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidParentLabel : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidParentLabel* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidParentLabel();
		~Hacking_CodeEditor_Errors_InvalidParentLabel();
	};
}
