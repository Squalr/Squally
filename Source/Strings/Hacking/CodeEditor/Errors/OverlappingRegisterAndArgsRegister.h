...
namespace Strings
{
	class Hacking_CodeEditor_Errors_OverlappingRegisterAndArgsRegister : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_OverlappingRegisterAndArgsRegister* create();
	...
	private:
		Hacking_CodeEditor_Errors_OverlappingRegisterAndArgsRegister();
		~Hacking_CodeEditor_Errors_OverlappingRegisterAndArgsRegister();
	};
}
