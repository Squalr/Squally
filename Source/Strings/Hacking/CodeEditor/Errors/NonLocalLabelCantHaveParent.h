...
namespace Strings
{
	class Hacking_CodeEditor_Errors_NonLocalLabelCantHaveParent : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_NonLocalLabelCantHaveParent* create();
	...
	private:
		Hacking_CodeEditor_Errors_NonLocalLabelCantHaveParent();
		~Hacking_CodeEditor_Errors_NonLocalLabelCantHaveParent();
	};
}
