...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidImmediateValue : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidImmediateValue* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidImmediateValue();
		~Hacking_CodeEditor_Errors_InvalidImmediateValue();
	};
}
