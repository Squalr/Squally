...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidAddress : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidAddress* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidAddress();
		~Hacking_CodeEditor_Errors_InvalidAddress();
	};
}
