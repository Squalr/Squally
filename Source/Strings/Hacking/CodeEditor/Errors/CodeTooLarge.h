...
namespace Strings
{
	class Hacking_CodeEditor_Errors_CodeTooLarge : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_CodeTooLarge* create();
	...
	private:
		Hacking_CodeEditor_Errors_CodeTooLarge();
		~Hacking_CodeEditor_Errors_CodeTooLarge();
	};
}
