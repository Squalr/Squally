...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidXReleasePrefix : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidXReleasePrefix* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidXReleasePrefix();
		~Hacking_CodeEditor_Errors_InvalidXReleasePrefix();
	};
}
