...
namespace Strings
{
	class Hacking_CodeEditor_Errors_LabelAlreadyBound : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_LabelAlreadyBound* create();
	...
	private:
		Hacking_CodeEditor_Errors_LabelAlreadyBound();
		~Hacking_CodeEditor_Errors_LabelAlreadyBound();
	};
}
