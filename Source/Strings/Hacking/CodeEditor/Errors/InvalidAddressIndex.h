...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidAddressIndex : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidAddressIndex* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidAddressIndex();
		~Hacking_CodeEditor_Errors_InvalidAddressIndex();
	};
}
