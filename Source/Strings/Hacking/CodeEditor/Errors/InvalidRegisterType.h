...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidRegisterType : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidRegisterType* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidRegisterType();
		~Hacking_CodeEditor_Errors_InvalidRegisterType();
	};
}
