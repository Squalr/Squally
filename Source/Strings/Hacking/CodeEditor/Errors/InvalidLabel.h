...
namespace Strings
{
	class Hacking_CodeEditor_Errors_InvalidLabel : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_Errors_InvalidLabel* create();
	...
	private:
		Hacking_CodeEditor_Errors_InvalidLabel();
		~Hacking_CodeEditor_Errors_InvalidLabel();
	};
}
