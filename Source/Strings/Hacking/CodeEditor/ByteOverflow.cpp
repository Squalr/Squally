...
namespace Strings
{
	Hacking_CodeEditor_ByteOverflow* Hacking_CodeEditor_ByteOverflow::create()
	{
		Hacking_CodeEditor_ByteOverflow* instance = new Hacking_CodeEditor_ByteOverflow();
	...
	Hacking_CodeEditor_ByteOverflow::~Hacking_CodeEditor_ByteOverflow()
	{
	}

	std::string Hacking_CodeEditor_ByteOverflow::getStringIdentifier()
	{
		return "Hacking_CodeEditor_ByteOverflow";
	}
