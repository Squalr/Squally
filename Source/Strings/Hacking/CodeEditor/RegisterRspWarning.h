...
namespace Strings
{
	class Hacking_CodeEditor_RegisterRspWarning : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_RegisterRspWarning* create();
	...
	private:
		Hacking_CodeEditor_RegisterRspWarning();
		~Hacking_CodeEditor_RegisterRspWarning();
	};
}
