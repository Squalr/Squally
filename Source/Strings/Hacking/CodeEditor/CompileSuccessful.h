...
namespace Strings
{
	class Hacking_CodeEditor_CompileSuccessful : public LocalizedString
	{
	public:
		static Hacking_CodeEditor_CompileSuccessful* create();
	...
	private:
		Hacking_CodeEditor_CompileSuccessful();
		~Hacking_CodeEditor_CompileSuccessful();
	};
}
