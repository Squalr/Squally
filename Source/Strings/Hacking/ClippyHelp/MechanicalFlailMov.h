...
namespace Strings
{
	class Hacking_ClippyHelp_MechanicalFlailMov : public LocalizedString
	{
	public:
		static Hacking_ClippyHelp_MechanicalFlailMov* create();
	...
	private:
		Hacking_ClippyHelp_MechanicalFlailMov();
		~Hacking_ClippyHelp_MechanicalFlailMov();
	};
}
