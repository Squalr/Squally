...
namespace Strings
{
	class Hacking_Entities_Squally_IsAlive_IsAlive : public LocalizedString
	{
	public:
		static Hacking_Entities_Squally_IsAlive_IsAlive* create();
	...
	private:
		Hacking_Entities_Squally_IsAlive_IsAlive();
		~Hacking_Entities_Squally_IsAlive_IsAlive();
	};
}
