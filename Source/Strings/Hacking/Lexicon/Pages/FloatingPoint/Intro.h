...
namespace Strings
{
	class Hacking_Lexicon_Pages_FloatingPoint_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_FloatingPoint_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_FloatingPoint_Intro();
		~Hacking_Lexicon_Pages_FloatingPoint_Intro();
	};
}
