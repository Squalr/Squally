...
namespace Strings
{
	class Hacking_Lexicon_Pages_FloatingPoint_Title : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_FloatingPoint_Title* create();
	...
	private:
		Hacking_Lexicon_Pages_FloatingPoint_Title();
		~Hacking_Lexicon_Pages_FloatingPoint_Title();
	};
}
