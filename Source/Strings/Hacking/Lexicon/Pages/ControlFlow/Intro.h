...
namespace Strings
{
	class Hacking_Lexicon_Pages_ControlFlow_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ControlFlow_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_ControlFlow_Intro();
		~Hacking_Lexicon_Pages_ControlFlow_Intro();
	};
}
