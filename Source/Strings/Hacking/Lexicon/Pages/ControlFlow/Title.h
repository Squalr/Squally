...
namespace Strings
{
	class Hacking_Lexicon_Pages_ControlFlow_Title : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ControlFlow_Title* create();
	...
	private:
		Hacking_Lexicon_Pages_ControlFlow_Title();
		~Hacking_Lexicon_Pages_ControlFlow_Title();
	};
}
