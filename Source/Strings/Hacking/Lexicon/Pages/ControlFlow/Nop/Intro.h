...
namespace Strings
{
	class Hacking_Lexicon_Pages_ControlFlow_Nop_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ControlFlow_Nop_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_ControlFlow_Nop_Intro();
		~Hacking_Lexicon_Pages_ControlFlow_Nop_Intro();
	};
}
