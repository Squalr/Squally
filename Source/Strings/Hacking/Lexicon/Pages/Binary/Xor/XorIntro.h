...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_Xor_XorIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_Xor_XorIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_Xor_XorIntro();
		~Hacking_Lexicon_Pages_Binary_Xor_XorIntro();
	};
}
