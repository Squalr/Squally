...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_Not_NotIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_Not_NotIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_Not_NotIntro();
		~Hacking_Lexicon_Pages_Binary_Not_NotIntro();
	};
}
