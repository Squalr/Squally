...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_Shr_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_Shr_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_Shr_Intro();
		~Hacking_Lexicon_Pages_Binary_Shr_Intro();
	};
}
