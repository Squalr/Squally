...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_And_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_And_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_And_Intro();
		~Hacking_Lexicon_Pages_Binary_And_Intro();
	};
}
