...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_And_AndIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_And_AndIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_And_AndIntro();
		~Hacking_Lexicon_Pages_Binary_And_AndIntro();
	};
}
