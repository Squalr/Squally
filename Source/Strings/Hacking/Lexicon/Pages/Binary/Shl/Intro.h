...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_Shl_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_Shl_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_Shl_Intro();
		~Hacking_Lexicon_Pages_Binary_Shl_Intro();
	};
}
