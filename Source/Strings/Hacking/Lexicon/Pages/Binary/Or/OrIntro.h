...
namespace Strings
{
	class Hacking_Lexicon_Pages_Binary_Or_OrIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Binary_Or_OrIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Binary_Or_OrIntro();
		~Hacking_Lexicon_Pages_Binary_Or_OrIntro();
	};
}
