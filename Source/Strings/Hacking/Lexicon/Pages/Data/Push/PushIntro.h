...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Push_PushIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Push_PushIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Push_PushIntro();
		~Hacking_Lexicon_Pages_Data_Push_PushIntro();
	};
}
