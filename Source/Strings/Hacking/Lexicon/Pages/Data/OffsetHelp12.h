...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_OffsetHelp12 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_OffsetHelp12* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_OffsetHelp12();
		~Hacking_Lexicon_Pages_Data_OffsetHelp12();
	};
}
