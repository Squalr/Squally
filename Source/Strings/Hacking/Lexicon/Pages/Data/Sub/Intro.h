...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Sub_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Sub_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Sub_Intro();
		~Hacking_Lexicon_Pages_Data_Sub_Intro();
	};
}
