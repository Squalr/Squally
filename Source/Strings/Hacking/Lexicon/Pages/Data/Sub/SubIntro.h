...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Sub_SubIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Sub_SubIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Sub_SubIntro();
		~Hacking_Lexicon_Pages_Data_Sub_SubIntro();
	};
}
