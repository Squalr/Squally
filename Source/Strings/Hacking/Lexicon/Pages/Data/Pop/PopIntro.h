...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Pop_PopIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Pop_PopIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Pop_PopIntro();
		~Hacking_Lexicon_Pages_Data_Pop_PopIntro();
	};
}
