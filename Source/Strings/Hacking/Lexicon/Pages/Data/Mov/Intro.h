...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Mov_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Mov_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Mov_Intro();
		~Hacking_Lexicon_Pages_Data_Mov_Intro();
	};
}
