...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Mov_MovIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Mov_MovIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Mov_MovIntro();
		~Hacking_Lexicon_Pages_Data_Mov_MovIntro();
	};
}
