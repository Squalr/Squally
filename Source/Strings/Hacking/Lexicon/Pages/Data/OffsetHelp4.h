...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_OffsetHelp4 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_OffsetHelp4* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_OffsetHelp4();
		~Hacking_Lexicon_Pages_Data_OffsetHelp4();
	};
}
