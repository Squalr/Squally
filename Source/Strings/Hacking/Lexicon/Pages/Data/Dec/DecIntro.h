...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Dec_DecIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Dec_DecIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Dec_DecIntro();
		~Hacking_Lexicon_Pages_Data_Dec_DecIntro();
	};
}
