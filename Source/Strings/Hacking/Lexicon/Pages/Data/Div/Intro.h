...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Div_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Div_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Div_Intro();
		~Hacking_Lexicon_Pages_Data_Div_Intro();
	};
}
