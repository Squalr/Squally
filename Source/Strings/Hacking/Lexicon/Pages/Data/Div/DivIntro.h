...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Div_DivIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Div_DivIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Div_DivIntro();
		~Hacking_Lexicon_Pages_Data_Div_DivIntro();
	};
}
