...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Inc_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Inc_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Inc_Intro();
		~Hacking_Lexicon_Pages_Data_Inc_Intro();
	};
}
