...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Inc_OffsetHelp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Inc_OffsetHelp* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Inc_OffsetHelp();
		~Hacking_Lexicon_Pages_Data_Inc_OffsetHelp();
	};
}
