...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Inc_IncIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Inc_IncIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Inc_IncIntro();
		~Hacking_Lexicon_Pages_Data_Inc_IncIntro();
	};
}
