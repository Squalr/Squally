...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Mul_MulIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Mul_MulIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Mul_MulIntro();
		~Hacking_Lexicon_Pages_Data_Mul_MulIntro();
	};
}
