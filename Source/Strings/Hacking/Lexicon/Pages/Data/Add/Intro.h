...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Add_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Add_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Add_Intro();
		~Hacking_Lexicon_Pages_Data_Add_Intro();
	};
}
