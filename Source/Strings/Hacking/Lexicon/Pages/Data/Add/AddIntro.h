...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Add_AddIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Add_AddIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Add_AddIntro();
		~Hacking_Lexicon_Pages_Data_Add_AddIntro();
	};
}
