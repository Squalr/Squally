...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Neg_Intro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Neg_Intro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Neg_Intro();
		~Hacking_Lexicon_Pages_Data_Neg_Intro();
	};
}
