...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Neg_NegIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Neg_NegIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Neg_NegIntro();
		~Hacking_Lexicon_Pages_Data_Neg_NegIntro();
	};
}
