...
namespace Strings
{
	class Hacking_Lexicon_Pages_Data_Lea_LeaIntro : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_Data_Lea_LeaIntro* create();
	...
	private:
		Hacking_Lexicon_Pages_Data_Lea_LeaIntro();
		~Hacking_Lexicon_Pages_Data_Lea_LeaIntro();
	};
}
