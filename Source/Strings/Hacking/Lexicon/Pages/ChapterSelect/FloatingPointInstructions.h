...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_FloatingPointInstructions : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_FloatingPointInstructions* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_FloatingPointInstructions();
		~Hacking_Lexicon_Pages_ChapterSelect_FloatingPointInstructions();
	};
}
