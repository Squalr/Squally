...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_ControlFlowInstructions : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_ControlFlowInstructions* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_ControlFlowInstructions();
		~Hacking_Lexicon_Pages_ChapterSelect_ControlFlowInstructions();
	};
}
