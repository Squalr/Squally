...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_ChooseAnOperation : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_ChooseAnOperation* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_ChooseAnOperation();
		~Hacking_Lexicon_Pages_ChapterSelect_ChooseAnOperation();
	};
}
