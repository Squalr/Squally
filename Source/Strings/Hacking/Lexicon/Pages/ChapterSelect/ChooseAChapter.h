...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_ChooseAChapter : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_ChooseAChapter* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_ChooseAChapter();
		~Hacking_Lexicon_Pages_ChapterSelect_ChooseAChapter();
	};
}
