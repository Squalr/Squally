...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_CommonInstructions : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_CommonInstructions* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_CommonInstructions();
		~Hacking_Lexicon_Pages_ChapterSelect_CommonInstructions();
	};
}
