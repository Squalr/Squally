...
namespace Strings
{
	class Hacking_Lexicon_Pages_ChapterSelect_VectorInstructions : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Pages_ChapterSelect_VectorInstructions* create();
	...
	private:
		Hacking_Lexicon_Pages_ChapterSelect_VectorInstructions();
		~Hacking_Lexicon_Pages_ChapterSelect_VectorInstructions();
	};
}
