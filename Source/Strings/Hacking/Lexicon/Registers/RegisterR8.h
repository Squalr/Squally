...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR8 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR8* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR8();
		~Hacking_Lexicon_Registers_RegisterR8();
	};
}
