...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEbx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEbx();
		~Hacking_Lexicon_Registers_RegisterEbx();
	};
}
