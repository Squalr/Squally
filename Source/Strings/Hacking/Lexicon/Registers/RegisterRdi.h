...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRdi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRdi* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRdi();
		~Hacking_Lexicon_Registers_RegisterRdi();
	};
}
