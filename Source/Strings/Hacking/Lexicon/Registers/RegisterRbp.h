...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRbp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRbp* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRbp();
		~Hacking_Lexicon_Registers_RegisterRbp();
	};
}
