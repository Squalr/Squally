...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm5 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm5* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm5();
		~Hacking_Lexicon_Registers_RegisterXmm5();
	};
}
