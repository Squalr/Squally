...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm2 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm2* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm2();
		~Hacking_Lexicon_Registers_RegisterXmm2();
	};
}
