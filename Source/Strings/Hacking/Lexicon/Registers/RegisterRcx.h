...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRcx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRcx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRcx();
		~Hacking_Lexicon_Registers_RegisterRcx();
	};
}
