...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRip* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRip();
		~Hacking_Lexicon_Registers_RegisterRip();
	};
}
