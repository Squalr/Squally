...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEdx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEdx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEdx();
		~Hacking_Lexicon_Registers_RegisterEdx();
	};
}
