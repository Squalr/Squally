...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR15 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR15* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR15();
		~Hacking_Lexicon_Registers_RegisterR15();
	};
}
