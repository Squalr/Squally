...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR12 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR12* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR12();
		~Hacking_Lexicon_Registers_RegisterR12();
	};
}
