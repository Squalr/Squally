...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRax : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRax* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRax();
		~Hacking_Lexicon_Registers_RegisterRax();
	};
}
