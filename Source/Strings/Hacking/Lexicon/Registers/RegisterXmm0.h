...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm0 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm0* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm0();
		~Hacking_Lexicon_Registers_RegisterXmm0();
	};
}
