...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR9 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR9* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR9();
		~Hacking_Lexicon_Registers_RegisterR9();
	};
}
