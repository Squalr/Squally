...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt1 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt1* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt1();
		~Hacking_Lexicon_Registers_RegisterSt1();
	};
}
