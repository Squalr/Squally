...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR14 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR14* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR14();
		~Hacking_Lexicon_Registers_RegisterR14();
	};
}
