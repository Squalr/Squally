...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt4 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt4* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt4();
		~Hacking_Lexicon_Registers_RegisterSt4();
	};
}
