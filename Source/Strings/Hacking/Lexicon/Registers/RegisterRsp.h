...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRsp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRsp* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRsp();
		~Hacking_Lexicon_Registers_RegisterRsp();
	};
}
