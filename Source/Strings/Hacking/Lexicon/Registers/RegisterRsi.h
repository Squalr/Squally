...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRsi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRsi* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRsi();
		~Hacking_Lexicon_Registers_RegisterRsi();
	};
}
