...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEdi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEdi* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEdi();
		~Hacking_Lexicon_Registers_RegisterEdi();
	};
}
