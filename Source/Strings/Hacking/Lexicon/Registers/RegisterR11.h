...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR11 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR11* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR11();
		~Hacking_Lexicon_Registers_RegisterR11();
	};
}
