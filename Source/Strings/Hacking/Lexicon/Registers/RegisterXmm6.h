...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm6 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm6* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm6();
		~Hacking_Lexicon_Registers_RegisterXmm6();
	};
}
