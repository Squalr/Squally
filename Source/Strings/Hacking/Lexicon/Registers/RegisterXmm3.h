...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm3 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm3* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm3();
		~Hacking_Lexicon_Registers_RegisterXmm3();
	};
}
