...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEax* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEax();
		~Hacking_Lexicon_Registers_RegisterEax();
	};
}
