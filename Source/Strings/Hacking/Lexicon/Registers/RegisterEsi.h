...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEsi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEsi* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEsi();
		~Hacking_Lexicon_Registers_RegisterEsi();
	};
}
