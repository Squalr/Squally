...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRbx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRbx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRbx();
		~Hacking_Lexicon_Registers_RegisterRbx();
	};
}
