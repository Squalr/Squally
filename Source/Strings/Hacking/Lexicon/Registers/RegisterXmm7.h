...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm7 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm7* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm7();
		~Hacking_Lexicon_Registers_RegisterXmm7();
	};
}
