...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR10 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR10* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR10();
		~Hacking_Lexicon_Registers_RegisterR10();
	};
}
