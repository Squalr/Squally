...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEcx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEcx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEcx();
		~Hacking_Lexicon_Registers_RegisterEcx();
	};
}
