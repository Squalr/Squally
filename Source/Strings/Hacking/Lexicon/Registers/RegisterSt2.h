...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt2 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt2* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt2();
		~Hacking_Lexicon_Registers_RegisterSt2();
	};
}
