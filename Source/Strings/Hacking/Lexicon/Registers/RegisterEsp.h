...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEsp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEsp* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEsp();
		~Hacking_Lexicon_Registers_RegisterEsp();
	};
}
