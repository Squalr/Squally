...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm4 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm4* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm4();
		~Hacking_Lexicon_Registers_RegisterXmm4();
	};
}
