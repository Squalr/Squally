...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEip* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEip();
		~Hacking_Lexicon_Registers_RegisterEip();
	};
}
