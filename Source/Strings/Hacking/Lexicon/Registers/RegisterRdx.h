...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterRdx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterRdx* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterRdx();
		~Hacking_Lexicon_Registers_RegisterRdx();
	};
}
