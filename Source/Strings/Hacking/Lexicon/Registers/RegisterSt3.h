...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt3 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt3* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt3();
		~Hacking_Lexicon_Registers_RegisterSt3();
	};
}
