...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterXmm1 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterXmm1* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterXmm1();
		~Hacking_Lexicon_Registers_RegisterXmm1();
	};
}
