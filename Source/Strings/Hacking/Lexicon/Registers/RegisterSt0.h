...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt0 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt0* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt0();
		~Hacking_Lexicon_Registers_RegisterSt0();
	};
}
