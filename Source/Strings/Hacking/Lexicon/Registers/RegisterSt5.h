...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt5 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt5* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt5();
		~Hacking_Lexicon_Registers_RegisterSt5();
	};
}
