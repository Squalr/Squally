...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterR13 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterR13* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterR13();
		~Hacking_Lexicon_Registers_RegisterR13();
	};
}
