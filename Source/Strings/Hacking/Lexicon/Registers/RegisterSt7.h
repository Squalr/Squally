...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt7 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt7* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt7();
		~Hacking_Lexicon_Registers_RegisterSt7();
	};
}
