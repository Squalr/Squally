...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterSt6 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterSt6* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterSt6();
		~Hacking_Lexicon_Registers_RegisterSt6();
	};
}
