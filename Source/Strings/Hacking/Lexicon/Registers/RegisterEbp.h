...
namespace Strings
{
	class Hacking_Lexicon_Registers_RegisterEbp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Registers_RegisterEbp* create();
	...
	private:
		Hacking_Lexicon_Registers_RegisterEbp();
		~Hacking_Lexicon_Registers_RegisterEbp();
	};
}
