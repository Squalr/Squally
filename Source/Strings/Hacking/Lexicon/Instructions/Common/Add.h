...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Add : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Add* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Add();
		~Hacking_Lexicon_Instructions_Common_Add();
	};
}
