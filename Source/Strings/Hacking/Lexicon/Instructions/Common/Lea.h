...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Lea : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Lea* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Lea();
		~Hacking_Lexicon_Instructions_Common_Lea();
	};
}
