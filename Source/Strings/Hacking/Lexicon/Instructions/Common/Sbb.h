...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Sbb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Sbb* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Sbb();
		~Hacking_Lexicon_Instructions_Common_Sbb();
	};
}
