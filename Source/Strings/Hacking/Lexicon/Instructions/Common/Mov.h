...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Mov : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Mov* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Mov();
		~Hacking_Lexicon_Instructions_Common_Mov();
	};
}
