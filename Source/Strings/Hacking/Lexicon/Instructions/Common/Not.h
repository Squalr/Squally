...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Not : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Not* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Not();
		~Hacking_Lexicon_Instructions_Common_Not();
	};
}
