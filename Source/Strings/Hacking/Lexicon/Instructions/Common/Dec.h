...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Dec : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Dec* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Dec();
		~Hacking_Lexicon_Instructions_Common_Dec();
	};
}
