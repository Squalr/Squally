...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Imul : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Imul* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Imul();
		~Hacking_Lexicon_Instructions_Common_Imul();
	};
}
