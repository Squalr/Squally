...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Sub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Sub* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Sub();
		~Hacking_Lexicon_Instructions_Common_Sub();
	};
}
