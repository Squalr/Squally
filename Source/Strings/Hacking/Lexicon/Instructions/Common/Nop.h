...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Nop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Nop* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Nop();
		~Hacking_Lexicon_Instructions_Common_Nop();
	};
}
