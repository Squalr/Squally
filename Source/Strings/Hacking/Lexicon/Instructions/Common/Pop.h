...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Pop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Pop* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Pop();
		~Hacking_Lexicon_Instructions_Common_Pop();
	};
}
