...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Idiv : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Idiv* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Idiv();
		~Hacking_Lexicon_Instructions_Common_Idiv();
	};
}
