...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Adc : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Adc* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Adc();
		~Hacking_Lexicon_Instructions_Common_Adc();
	};
}
