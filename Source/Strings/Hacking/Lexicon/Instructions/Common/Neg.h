...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Neg : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Neg* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Neg();
		~Hacking_Lexicon_Instructions_Common_Neg();
	};
}
