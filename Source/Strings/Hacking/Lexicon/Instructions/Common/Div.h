...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Div : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Div* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Div();
		~Hacking_Lexicon_Instructions_Common_Div();
	};
}
