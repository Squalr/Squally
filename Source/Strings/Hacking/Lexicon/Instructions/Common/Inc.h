...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Inc : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Inc* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Inc();
		~Hacking_Lexicon_Instructions_Common_Inc();
	};
}
