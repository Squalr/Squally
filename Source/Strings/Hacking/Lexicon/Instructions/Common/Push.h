...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Common_Push : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Common_Push* create();
	...
	private:
		Hacking_Lexicon_Instructions_Common_Push();
		~Hacking_Lexicon_Instructions_Common_Push();
	};
}
