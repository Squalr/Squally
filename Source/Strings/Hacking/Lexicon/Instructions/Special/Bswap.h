...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Special_Bswap : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Special_Bswap* create();
	...
	private:
		Hacking_Lexicon_Instructions_Special_Bswap();
		~Hacking_Lexicon_Instructions_Special_Bswap();
	};
}
