...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvtpi2ps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvtpi2ps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvtpi2ps();
		~Hacking_Lexicon_Instructions_Vector_Cvtpi2ps();
	};
}
