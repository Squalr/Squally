...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Unpcklps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Unpcklps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Unpcklps();
		~Hacking_Lexicon_Instructions_Vector_Unpcklps();
	};
}
