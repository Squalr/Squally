...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Subss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Subss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Subss();
		~Hacking_Lexicon_Instructions_Vector_Subss();
	};
}
