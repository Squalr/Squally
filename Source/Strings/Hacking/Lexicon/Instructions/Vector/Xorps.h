...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Xorps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Xorps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Xorps();
		~Hacking_Lexicon_Instructions_Vector_Xorps();
	};
}
