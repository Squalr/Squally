...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Maxps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Maxps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Maxps();
		~Hacking_Lexicon_Instructions_Vector_Maxps();
	};
}
