...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pmulhuw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pmulhuw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pmulhuw();
		~Hacking_Lexicon_Instructions_Vector_Pmulhuw();
	};
}
