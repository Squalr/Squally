...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Rsqrtps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Rsqrtps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Rsqrtps();
		~Hacking_Lexicon_Instructions_Vector_Rsqrtps();
	};
}
