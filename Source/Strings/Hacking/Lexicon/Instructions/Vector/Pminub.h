...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pminub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pminub* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pminub();
		~Hacking_Lexicon_Instructions_Vector_Pminub();
	};
}
