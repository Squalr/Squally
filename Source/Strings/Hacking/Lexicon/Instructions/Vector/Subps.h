...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Subps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Subps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Subps();
		~Hacking_Lexicon_Instructions_Vector_Subps();
	};
}
