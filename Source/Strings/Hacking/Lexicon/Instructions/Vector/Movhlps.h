...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movhlps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movhlps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movhlps();
		~Hacking_Lexicon_Instructions_Vector_Movhlps();
	};
}
