...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pmaxub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pmaxub* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pmaxub();
		~Hacking_Lexicon_Instructions_Vector_Pmaxub();
	};
}
