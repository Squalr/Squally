...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvtss2si : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvtss2si* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvtss2si();
		~Hacking_Lexicon_Instructions_Vector_Cvtss2si();
	};
}
