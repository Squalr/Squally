...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvttps2pi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvttps2pi* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvttps2pi();
		~Hacking_Lexicon_Instructions_Vector_Cvttps2pi();
	};
}
