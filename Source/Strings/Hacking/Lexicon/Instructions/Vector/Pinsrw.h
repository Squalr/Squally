...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pinsrw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pinsrw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pinsrw();
		~Hacking_Lexicon_Instructions_Vector_Pinsrw();
	};
}
