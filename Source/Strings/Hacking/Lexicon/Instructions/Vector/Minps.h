...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Minps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Minps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Minps();
		~Hacking_Lexicon_Instructions_Vector_Minps();
	};
}
