...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Sqrtps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Sqrtps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Sqrtps();
		~Hacking_Lexicon_Instructions_Vector_Sqrtps();
	};
}
