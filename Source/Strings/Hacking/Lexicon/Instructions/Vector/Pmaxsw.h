...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pmaxsw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pmaxsw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pmaxsw();
		~Hacking_Lexicon_Instructions_Vector_Pmaxsw();
	};
}
