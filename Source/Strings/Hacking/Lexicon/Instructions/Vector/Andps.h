...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Andps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Andps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Andps();
		~Hacking_Lexicon_Instructions_Vector_Andps();
	};
}
