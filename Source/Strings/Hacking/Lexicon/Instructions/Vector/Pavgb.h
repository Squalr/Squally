...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pavgb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pavgb* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pavgb();
		~Hacking_Lexicon_Instructions_Vector_Pavgb();
	};
}
