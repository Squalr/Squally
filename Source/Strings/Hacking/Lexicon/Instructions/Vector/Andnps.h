...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Andnps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Andnps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Andnps();
		~Hacking_Lexicon_Instructions_Vector_Andnps();
	};
}
