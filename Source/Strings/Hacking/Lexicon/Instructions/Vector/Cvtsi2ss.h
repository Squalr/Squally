...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvtsi2ss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvtsi2ss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvtsi2ss();
		~Hacking_Lexicon_Instructions_Vector_Cvtsi2ss();
	};
}
