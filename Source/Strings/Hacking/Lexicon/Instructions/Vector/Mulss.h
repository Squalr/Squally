...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Mulss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Mulss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Mulss();
		~Hacking_Lexicon_Instructions_Vector_Mulss();
	};
}
