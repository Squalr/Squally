...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pshufw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pshufw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pshufw();
		~Hacking_Lexicon_Instructions_Vector_Pshufw();
	};
}
