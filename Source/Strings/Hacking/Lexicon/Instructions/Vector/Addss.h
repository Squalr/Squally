...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Addss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Addss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Addss();
		~Hacking_Lexicon_Instructions_Vector_Addss();
	};
}
