...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Addps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Addps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Addps();
		~Hacking_Lexicon_Instructions_Vector_Addps();
	};
}
