...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movhps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movhps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movhps();
		~Hacking_Lexicon_Instructions_Vector_Movhps();
	};
}
