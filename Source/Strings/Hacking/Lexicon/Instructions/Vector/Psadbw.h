...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Psadbw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Psadbw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Psadbw();
		~Hacking_Lexicon_Instructions_Vector_Psadbw();
	};
}
