...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movss();
		~Hacking_Lexicon_Instructions_Vector_Movss();
	};
}
