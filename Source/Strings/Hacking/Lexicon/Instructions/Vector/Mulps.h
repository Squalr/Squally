...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Mulps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Mulps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Mulps();
		~Hacking_Lexicon_Instructions_Vector_Mulps();
	};
}
