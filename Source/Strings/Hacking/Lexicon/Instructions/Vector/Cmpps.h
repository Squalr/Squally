...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cmpps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cmpps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cmpps();
		~Hacking_Lexicon_Instructions_Vector_Cmpps();
	};
}
