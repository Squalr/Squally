...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvtps2pi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvtps2pi* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvtps2pi();
		~Hacking_Lexicon_Instructions_Vector_Cvtps2pi();
	};
}
