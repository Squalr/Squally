...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pminsw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pminsw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pminsw();
		~Hacking_Lexicon_Instructions_Vector_Pminsw();
	};
}
