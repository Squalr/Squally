...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Comiss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Comiss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Comiss();
		~Hacking_Lexicon_Instructions_Vector_Comiss();
	};
}
