...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pextrw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pextrw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pextrw();
		~Hacking_Lexicon_Instructions_Vector_Pextrw();
	};
}
