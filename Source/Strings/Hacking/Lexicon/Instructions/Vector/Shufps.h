...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Shufps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Shufps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Shufps();
		~Hacking_Lexicon_Instructions_Vector_Shufps();
	};
}
