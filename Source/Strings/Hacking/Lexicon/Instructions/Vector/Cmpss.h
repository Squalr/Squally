...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cmpss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cmpss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cmpss();
		~Hacking_Lexicon_Instructions_Vector_Cmpss();
	};
}
