...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pmovmskb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pmovmskb* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pmovmskb();
		~Hacking_Lexicon_Instructions_Vector_Pmovmskb();
	};
}
