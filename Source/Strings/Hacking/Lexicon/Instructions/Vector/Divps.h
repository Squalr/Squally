...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Divps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Divps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Divps();
		~Hacking_Lexicon_Instructions_Vector_Divps();
	};
}
