...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Divss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Divss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Divss();
		~Hacking_Lexicon_Instructions_Vector_Divss();
	};
}
