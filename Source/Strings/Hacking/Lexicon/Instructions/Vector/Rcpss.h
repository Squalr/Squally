...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Rcpss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Rcpss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Rcpss();
		~Hacking_Lexicon_Instructions_Vector_Rcpss();
	};
}
