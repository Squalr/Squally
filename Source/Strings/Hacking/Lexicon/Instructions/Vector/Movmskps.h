...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movmskps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movmskps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movmskps();
		~Hacking_Lexicon_Instructions_Vector_Movmskps();
	};
}
