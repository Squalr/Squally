...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movups : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movups* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movups();
		~Hacking_Lexicon_Instructions_Vector_Movups();
	};
}
