...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Unpckhps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Unpckhps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Unpckhps();
		~Hacking_Lexicon_Instructions_Vector_Unpckhps();
	};
}
