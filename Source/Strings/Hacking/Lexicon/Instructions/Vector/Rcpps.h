...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Rcpps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Rcpps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Rcpps();
		~Hacking_Lexicon_Instructions_Vector_Rcpps();
	};
}
