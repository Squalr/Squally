...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Cvttss2si : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Cvttss2si* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Cvttss2si();
		~Hacking_Lexicon_Instructions_Vector_Cvttss2si();
	};
}
