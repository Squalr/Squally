...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Orps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Orps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Orps();
		~Hacking_Lexicon_Instructions_Vector_Orps();
	};
}
