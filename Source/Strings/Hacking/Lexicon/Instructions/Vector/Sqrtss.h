...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Sqrtss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Sqrtss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Sqrtss();
		~Hacking_Lexicon_Instructions_Vector_Sqrtss();
	};
}
