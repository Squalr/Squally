...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Ucomiss : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Ucomiss* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Ucomiss();
		~Hacking_Lexicon_Instructions_Vector_Ucomiss();
	};
}
