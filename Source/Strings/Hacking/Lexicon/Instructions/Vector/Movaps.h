...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movaps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movaps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movaps();
		~Hacking_Lexicon_Instructions_Vector_Movaps();
	};
}
