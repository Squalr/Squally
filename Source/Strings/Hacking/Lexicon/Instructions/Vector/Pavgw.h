...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Pavgw : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Pavgw* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Pavgw();
		~Hacking_Lexicon_Instructions_Vector_Pavgw();
	};
}
