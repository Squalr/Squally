...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Vector_Movlhps : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Vector_Movlhps* create();
	...
	private:
		Hacking_Lexicon_Instructions_Vector_Movlhps();
		~Hacking_Lexicon_Instructions_Vector_Movlhps();
	};
}
