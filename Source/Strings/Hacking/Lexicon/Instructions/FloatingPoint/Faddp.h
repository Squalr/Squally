...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Faddp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Faddp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Faddp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Faddp();
	};
}
