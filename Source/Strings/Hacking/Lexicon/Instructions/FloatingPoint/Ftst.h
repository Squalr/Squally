...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Ftst : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Ftst* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Ftst();
		~Hacking_Lexicon_Instructions_FloatingPoint_Ftst();
	};
}
