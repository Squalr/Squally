...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldln2 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldln2* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldln2();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldln2();
	};
}
