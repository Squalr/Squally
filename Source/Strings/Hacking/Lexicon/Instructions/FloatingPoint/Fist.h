...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fist : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fist* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fist();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fist();
	};
}
