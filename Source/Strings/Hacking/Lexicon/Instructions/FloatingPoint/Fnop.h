...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fnop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fnop* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fnop();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fnop();
	};
}
