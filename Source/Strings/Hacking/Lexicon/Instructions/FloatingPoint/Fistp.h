...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fistp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fistp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fistp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fistp();
	};
}
