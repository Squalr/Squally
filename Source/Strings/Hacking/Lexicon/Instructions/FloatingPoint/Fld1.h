...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fld1 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fld1* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fld1();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fld1();
	};
}
