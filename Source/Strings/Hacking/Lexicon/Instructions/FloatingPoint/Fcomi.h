...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcomi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcomi* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcomi();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcomi();
	};
}
