...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fucom : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fucom* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fucom();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fucom();
	};
}
