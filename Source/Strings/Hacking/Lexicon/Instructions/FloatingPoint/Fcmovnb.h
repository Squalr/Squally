...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnb* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnb();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnb();
	};
}
