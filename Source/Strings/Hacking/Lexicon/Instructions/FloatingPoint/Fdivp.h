...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fdivp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fdivp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fdivp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fdivp();
	};
}
