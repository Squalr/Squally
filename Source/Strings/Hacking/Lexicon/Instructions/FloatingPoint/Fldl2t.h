...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldl2t : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldl2t* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldl2t();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldl2t();
	};
}
