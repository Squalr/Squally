...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fxtract : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fxtract* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fxtract();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fxtract();
	};
}
