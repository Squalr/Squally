...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fild : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fild* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fild();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fild();
	};
}
