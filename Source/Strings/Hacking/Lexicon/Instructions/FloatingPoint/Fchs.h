...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fchs : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fchs* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fchs();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fchs();
	};
}
