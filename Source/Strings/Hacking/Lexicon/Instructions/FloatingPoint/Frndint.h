...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Frndint : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Frndint* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Frndint();
		~Hacking_Lexicon_Instructions_FloatingPoint_Frndint();
	};
}
