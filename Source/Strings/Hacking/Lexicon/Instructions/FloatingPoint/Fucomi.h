...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fucomi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fucomi* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fucomi();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fucomi();
	};
}
