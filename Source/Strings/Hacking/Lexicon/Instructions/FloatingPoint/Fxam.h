...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fxam : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fxam* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fxam();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fxam();
	};
}
