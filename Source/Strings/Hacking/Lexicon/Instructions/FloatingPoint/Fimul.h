...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fimul : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fimul* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fimul();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fimul();
	};
}
