...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnbe : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnbe* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnbe();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnbe();
	};
}
