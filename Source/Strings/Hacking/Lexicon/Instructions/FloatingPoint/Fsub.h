...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fsub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fsub* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fsub();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fsub();
	};
}
