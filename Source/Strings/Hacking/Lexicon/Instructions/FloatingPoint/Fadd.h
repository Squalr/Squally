...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fadd : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fadd* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fadd();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fadd();
	};
}
