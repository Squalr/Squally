...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Ficom : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Ficom* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Ficom();
		~Hacking_Lexicon_Instructions_FloatingPoint_Ficom();
	};
}
