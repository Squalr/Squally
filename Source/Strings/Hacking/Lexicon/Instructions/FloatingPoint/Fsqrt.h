...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fsqrt : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fsqrt* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fsqrt();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fsqrt();
	};
}
