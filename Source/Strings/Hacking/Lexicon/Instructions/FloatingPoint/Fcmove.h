...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmove : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmove* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmove();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmove();
	};
}
