...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fiadd : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fiadd* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fiadd();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fiadd();
	};
}
