...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fxch : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fxch* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fxch();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fxch();
	};
}
