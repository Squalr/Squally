...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovne : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovne* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovne();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovne();
	};
}
