...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fisubr : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fisubr* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fisubr();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fisubr();
	};
}
