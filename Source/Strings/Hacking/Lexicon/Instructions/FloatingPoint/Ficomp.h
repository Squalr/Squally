...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Ficomp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Ficomp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Ficomp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Ficomp();
	};
}
