...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcompp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcompp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcompp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcompp();
	};
}
