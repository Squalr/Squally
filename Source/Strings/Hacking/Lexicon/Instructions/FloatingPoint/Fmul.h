...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fmul : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fmul* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fmul();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fmul();
	};
}
