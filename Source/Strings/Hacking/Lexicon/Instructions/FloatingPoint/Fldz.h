...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldz : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldz* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldz();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldz();
	};
}
