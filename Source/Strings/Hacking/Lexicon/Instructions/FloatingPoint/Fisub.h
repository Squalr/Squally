...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fisub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fisub* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fisub();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fisub();
	};
}
