...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fprem : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fprem* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fprem();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fprem();
	};
}
