...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fdiv : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fdiv* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fdiv();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fdiv();
	};
}
