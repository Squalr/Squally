...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fsubr : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fsubr* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fsubr();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fsubr();
	};
}
