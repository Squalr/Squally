...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fscale : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fscale* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fscale();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fscale();
	};
}
