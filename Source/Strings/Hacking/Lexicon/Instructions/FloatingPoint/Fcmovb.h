...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovb* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovb();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovb();
	};
}
