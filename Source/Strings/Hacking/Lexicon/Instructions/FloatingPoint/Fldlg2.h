...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldlg2 : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldlg2* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldlg2();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldlg2();
	};
}
