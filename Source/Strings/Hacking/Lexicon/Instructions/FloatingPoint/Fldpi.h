...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldpi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldpi* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldpi();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldpi();
	};
}
