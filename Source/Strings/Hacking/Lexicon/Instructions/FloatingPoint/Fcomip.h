...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcomip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcomip* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcomip();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcomip();
	};
}
