...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovu : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovu* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovu();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovu();
	};
}
