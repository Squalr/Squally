...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fmulp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fmulp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fmulp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fmulp();
	};
}
