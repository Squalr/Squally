...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fdivrp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fdivrp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fdivrp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fdivrp();
	};
}
