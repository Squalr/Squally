...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fsubp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fsubp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fsubp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fsubp();
	};
}
