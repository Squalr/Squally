...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovbe : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovbe* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovbe();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovbe();
	};
}
