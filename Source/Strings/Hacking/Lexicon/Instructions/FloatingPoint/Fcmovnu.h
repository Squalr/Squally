...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnu : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnu* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnu();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcmovnu();
	};
}
