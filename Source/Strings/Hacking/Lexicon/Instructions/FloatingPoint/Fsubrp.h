...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fsubrp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fsubrp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fsubrp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fsubrp();
	};
}
