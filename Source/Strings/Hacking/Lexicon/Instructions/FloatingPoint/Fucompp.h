...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fucompp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fucompp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fucompp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fucompp();
	};
}
