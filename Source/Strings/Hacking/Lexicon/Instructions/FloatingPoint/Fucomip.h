...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fucomip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fucomip* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fucomip();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fucomip();
	};
}
