...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fstp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fstp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fstp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fstp();
	};
}
