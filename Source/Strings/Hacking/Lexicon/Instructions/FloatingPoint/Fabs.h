...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fabs : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fabs* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fabs();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fabs();
	};
}
