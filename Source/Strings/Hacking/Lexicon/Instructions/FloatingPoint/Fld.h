...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fld : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fld* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fld();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fld();
	};
}
