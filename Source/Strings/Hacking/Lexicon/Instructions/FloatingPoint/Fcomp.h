...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcomp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcomp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcomp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcomp();
	};
}
