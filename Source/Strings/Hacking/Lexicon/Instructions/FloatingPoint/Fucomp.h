...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fucomp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fucomp* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fucomp();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fucomp();
	};
}
