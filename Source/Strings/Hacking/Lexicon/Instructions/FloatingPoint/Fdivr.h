...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fdivr : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fdivr* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fdivr();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fdivr();
	};
}
