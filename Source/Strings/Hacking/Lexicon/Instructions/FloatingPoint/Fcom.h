...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fcom : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fcom* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fcom();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fcom();
	};
}
