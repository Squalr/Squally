...
namespace Strings
{
	class Hacking_Lexicon_Instructions_FloatingPoint_Fldl2e : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_FloatingPoint_Fldl2e* create();
	...
	private:
		Hacking_Lexicon_Instructions_FloatingPoint_Fldl2e();
		~Hacking_Lexicon_Instructions_FloatingPoint_Fldl2e();
	};
}
