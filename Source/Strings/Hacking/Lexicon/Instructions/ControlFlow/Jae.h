...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jae : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jae* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jae();
		~Hacking_Lexicon_Instructions_ControlFlow_Jae();
	};
}
