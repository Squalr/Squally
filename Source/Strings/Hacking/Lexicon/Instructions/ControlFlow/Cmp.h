...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Cmp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Cmp* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Cmp();
		~Hacking_Lexicon_Instructions_ControlFlow_Cmp();
	};
}
