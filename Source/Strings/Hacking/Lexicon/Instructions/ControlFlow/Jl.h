...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jl : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jl* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jl();
		~Hacking_Lexicon_Instructions_ControlFlow_Jl();
	};
}
