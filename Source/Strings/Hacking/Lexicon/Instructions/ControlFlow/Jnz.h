...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jnz : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jnz* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jnz();
		~Hacking_Lexicon_Instructions_ControlFlow_Jnz();
	};
}
