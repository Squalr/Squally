...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Test : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Test* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Test();
		~Hacking_Lexicon_Instructions_ControlFlow_Test();
	};
}
