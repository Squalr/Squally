...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loopnz : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loopnz* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loopnz();
		~Hacking_Lexicon_Instructions_ControlFlow_Loopnz();
	};
}
