...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Je : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Je* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Je();
		~Hacking_Lexicon_Instructions_ControlFlow_Je();
	};
}
