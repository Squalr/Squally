...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loopz : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loopz* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loopz();
		~Hacking_Lexicon_Instructions_ControlFlow_Loopz();
	};
}
