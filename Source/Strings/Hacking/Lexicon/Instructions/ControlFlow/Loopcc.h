...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loopcc : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loopcc* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loopcc();
		~Hacking_Lexicon_Instructions_ControlFlow_Loopcc();
	};
}
