...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jg : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jg* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jg();
		~Hacking_Lexicon_Instructions_ControlFlow_Jg();
	};
}
