...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Ret : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Ret* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Ret();
		~Hacking_Lexicon_Instructions_ControlFlow_Ret();
	};
}
