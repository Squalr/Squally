...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Call : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Call* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Call();
		~Hacking_Lexicon_Instructions_ControlFlow_Call();
	};
}
