...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jge : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jge* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jge();
		~Hacking_Lexicon_Instructions_ControlFlow_Jge();
	};
}
