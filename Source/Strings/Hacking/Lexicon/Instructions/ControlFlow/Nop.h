...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Nop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Nop* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Nop();
		~Hacking_Lexicon_Instructions_ControlFlow_Nop();
	};
}
