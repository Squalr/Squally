...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jz : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jz* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jz();
		~Hacking_Lexicon_Instructions_ControlFlow_Jz();
	};
}
