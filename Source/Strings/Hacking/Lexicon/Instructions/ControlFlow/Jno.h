...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jno : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jno* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jno();
		~Hacking_Lexicon_Instructions_ControlFlow_Jno();
	};
}
