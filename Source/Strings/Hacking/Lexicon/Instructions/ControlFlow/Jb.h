...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jb* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jb();
		~Hacking_Lexicon_Instructions_ControlFlow_Jb();
	};
}
