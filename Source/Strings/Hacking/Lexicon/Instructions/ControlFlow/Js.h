...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Js : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Js* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Js();
		~Hacking_Lexicon_Instructions_ControlFlow_Js();
	};
}
