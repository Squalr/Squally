...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jne : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jne* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jne();
		~Hacking_Lexicon_Instructions_ControlFlow_Jne();
	};
}
