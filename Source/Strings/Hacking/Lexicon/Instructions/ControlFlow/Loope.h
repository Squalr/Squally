...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loope : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loope* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loope();
		~Hacking_Lexicon_Instructions_ControlFlow_Loope();
	};
}
