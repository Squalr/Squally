...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loop* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loop();
		~Hacking_Lexicon_Instructions_ControlFlow_Loop();
	};
}
