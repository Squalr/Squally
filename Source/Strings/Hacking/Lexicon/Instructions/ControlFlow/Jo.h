...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jo : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jo* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jo();
		~Hacking_Lexicon_Instructions_ControlFlow_Jo();
	};
}
