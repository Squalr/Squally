...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jmp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jmp* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jmp();
		~Hacking_Lexicon_Instructions_ControlFlow_Jmp();
	};
}
