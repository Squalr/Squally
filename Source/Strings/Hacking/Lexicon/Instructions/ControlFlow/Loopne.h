...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Loopne : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Loopne* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Loopne();
		~Hacking_Lexicon_Instructions_ControlFlow_Loopne();
	};
}
