...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jns : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jns* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jns();
		~Hacking_Lexicon_Instructions_ControlFlow_Jns();
	};
}
