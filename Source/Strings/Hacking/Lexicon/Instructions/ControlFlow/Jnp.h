...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Jnp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Jnp* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Jnp();
		~Hacking_Lexicon_Instructions_ControlFlow_Jnp();
	};
}
