...
namespace Strings
{
	class Hacking_Lexicon_Instructions_ControlFlow_Ja : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_ControlFlow_Ja* create();
	...
	private:
		Hacking_Lexicon_Instructions_ControlFlow_Ja();
		~Hacking_Lexicon_Instructions_ControlFlow_Ja();
	};
}
