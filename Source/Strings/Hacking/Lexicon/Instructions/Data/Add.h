...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Add : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Add* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Add();
		~Hacking_Lexicon_Instructions_Data_Add();
	};
}
