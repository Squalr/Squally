...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Pop : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Pop* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Pop();
		~Hacking_Lexicon_Instructions_Data_Pop();
	};
}
