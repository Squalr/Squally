...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Push : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Push* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Push();
		~Hacking_Lexicon_Instructions_Data_Push();
	};
}
