...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Mov : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Mov* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Mov();
		~Hacking_Lexicon_Instructions_Data_Mov();
	};
}
