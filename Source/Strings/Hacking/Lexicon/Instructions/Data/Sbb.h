...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Sbb : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Sbb* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Sbb();
		~Hacking_Lexicon_Instructions_Data_Sbb();
	};
}
