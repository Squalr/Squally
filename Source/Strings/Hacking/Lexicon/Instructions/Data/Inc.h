...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Inc : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Inc* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Inc();
		~Hacking_Lexicon_Instructions_Data_Inc();
	};
}
