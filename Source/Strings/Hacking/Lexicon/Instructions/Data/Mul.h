...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Mul : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Mul* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Mul();
		~Hacking_Lexicon_Instructions_Data_Mul();
	};
}
