...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Idiv : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Idiv* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Idiv();
		~Hacking_Lexicon_Instructions_Data_Idiv();
	};
}
