...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Neg : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Neg* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Neg();
		~Hacking_Lexicon_Instructions_Data_Neg();
	};
}
