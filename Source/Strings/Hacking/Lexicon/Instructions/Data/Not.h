...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Not : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Not* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Not();
		~Hacking_Lexicon_Instructions_Data_Not();
	};
}
