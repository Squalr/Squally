...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Dec : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Dec* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Dec();
		~Hacking_Lexicon_Instructions_Data_Dec();
	};
}
