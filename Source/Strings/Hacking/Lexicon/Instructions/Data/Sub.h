...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Sub : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Sub* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Sub();
		~Hacking_Lexicon_Instructions_Data_Sub();
	};
}
