...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Adc : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Adc* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Adc();
		~Hacking_Lexicon_Instructions_Data_Adc();
	};
}
