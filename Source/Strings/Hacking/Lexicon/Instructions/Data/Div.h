...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Div : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Div* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Div();
		~Hacking_Lexicon_Instructions_Data_Div();
	};
}
