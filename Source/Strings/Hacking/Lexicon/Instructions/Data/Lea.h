...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Data_Lea : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Data_Lea* create();
	...
	private:
		Hacking_Lexicon_Instructions_Data_Lea();
		~Hacking_Lexicon_Instructions_Data_Lea();
	};
}
