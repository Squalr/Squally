...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Shrd : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Shrd* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Shrd();
		~Hacking_Lexicon_Instructions_Binary_Shrd();
	};
}
