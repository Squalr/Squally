...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Not : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Not* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Not();
		~Hacking_Lexicon_Instructions_Binary_Not();
	};
}
