...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Rcl : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Rcl* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Rcl();
		~Hacking_Lexicon_Instructions_Binary_Rcl();
	};
}
