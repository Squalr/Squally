...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Rol : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Rol* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Rol();
		~Hacking_Lexicon_Instructions_Binary_Rol();
	};
}
