...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Rcr : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Rcr* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Rcr();
		~Hacking_Lexicon_Instructions_Binary_Rcr();
	};
}
