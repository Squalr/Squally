...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Shr : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Shr* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Shr();
		~Hacking_Lexicon_Instructions_Binary_Shr();
	};
}
