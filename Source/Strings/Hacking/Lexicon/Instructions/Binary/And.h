...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_And : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_And* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_And();
		~Hacking_Lexicon_Instructions_Binary_And();
	};
}
