...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Sar : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Sar* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Sar();
		~Hacking_Lexicon_Instructions_Binary_Sar();
	};
}
