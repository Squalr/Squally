...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Shld : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Shld* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Shld();
		~Hacking_Lexicon_Instructions_Binary_Shld();
	};
}
