...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Ror : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Ror* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Ror();
		~Hacking_Lexicon_Instructions_Binary_Ror();
	};
}
