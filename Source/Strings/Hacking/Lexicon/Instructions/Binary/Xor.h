...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Xor : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Xor* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Xor();
		~Hacking_Lexicon_Instructions_Binary_Xor();
	};
}
