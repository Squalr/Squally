...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Sal : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Sal* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Sal();
		~Hacking_Lexicon_Instructions_Binary_Sal();
	};
}
