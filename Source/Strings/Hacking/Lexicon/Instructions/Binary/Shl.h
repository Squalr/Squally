...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Shl : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Shl* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Shl();
		~Hacking_Lexicon_Instructions_Binary_Shl();
	};
}
