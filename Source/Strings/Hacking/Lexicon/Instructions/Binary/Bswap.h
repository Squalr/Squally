...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Bswap : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Bswap* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Bswap();
		~Hacking_Lexicon_Instructions_Binary_Bswap();
	};
}
