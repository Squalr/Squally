...
namespace Strings
{
	class Hacking_Lexicon_Instructions_Binary_Or : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Instructions_Binary_Or* create();
	...
	private:
		Hacking_Lexicon_Instructions_Binary_Or();
		~Hacking_Lexicon_Instructions_Binary_Or();
	};
}
