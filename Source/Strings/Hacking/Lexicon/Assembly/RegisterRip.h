...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRip* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRip();
		~Hacking_Lexicon_Assembly_RegisterRip();
	};
}
