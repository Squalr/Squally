...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRdi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRdi* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRdi();
		~Hacking_Lexicon_Assembly_RegisterRdi();
	};
}
