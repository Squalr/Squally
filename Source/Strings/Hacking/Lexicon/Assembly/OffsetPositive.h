...
namespace Strings
{
	class Hacking_Lexicon_Assembly_OffsetPositive : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_OffsetPositive* create();
	...
	private:
		Hacking_Lexicon_Assembly_OffsetPositive();
		~Hacking_Lexicon_Assembly_OffsetPositive();
	};
}
