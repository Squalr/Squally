...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEip : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEip* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEip();
		~Hacking_Lexicon_Assembly_RegisterEip();
	};
}
