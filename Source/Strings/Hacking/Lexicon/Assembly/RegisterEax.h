...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEax : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEax* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEax();
		~Hacking_Lexicon_Assembly_RegisterEax();
	};
}
