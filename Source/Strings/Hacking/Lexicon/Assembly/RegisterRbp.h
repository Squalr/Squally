...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRbp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRbp* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRbp();
		~Hacking_Lexicon_Assembly_RegisterRbp();
	};
}
