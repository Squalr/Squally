...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEsp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEsp* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEsp();
		~Hacking_Lexicon_Assembly_RegisterEsp();
	};
}
