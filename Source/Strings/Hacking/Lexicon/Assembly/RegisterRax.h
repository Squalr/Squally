...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRax : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRax* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRax();
		~Hacking_Lexicon_Assembly_RegisterRax();
	};
}
