...
namespace Strings
{
	class Hacking_Lexicon_Assembly_OffsetNegative : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_OffsetNegative* create();
	...
	private:
		Hacking_Lexicon_Assembly_OffsetNegative();
		~Hacking_Lexicon_Assembly_OffsetNegative();
	};
}
