...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRcx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRcx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRcx();
		~Hacking_Lexicon_Assembly_RegisterRcx();
	};
}
