...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEbp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEbp* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEbp();
		~Hacking_Lexicon_Assembly_RegisterEbp();
	};
}
