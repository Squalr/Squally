...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEcx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEcx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEcx();
		~Hacking_Lexicon_Assembly_RegisterEcx();
	};
}
