...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEdx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEdx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEdx();
		~Hacking_Lexicon_Assembly_RegisterEdx();
	};
}
