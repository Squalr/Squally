...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRsi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRsi* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRsi();
		~Hacking_Lexicon_Assembly_RegisterRsi();
	};
}
