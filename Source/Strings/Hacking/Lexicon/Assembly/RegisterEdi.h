...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEdi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEdi* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEdi();
		~Hacking_Lexicon_Assembly_RegisterEdi();
	};
}
