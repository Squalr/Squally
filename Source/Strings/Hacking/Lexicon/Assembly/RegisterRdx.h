...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRdx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRdx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRdx();
		~Hacking_Lexicon_Assembly_RegisterRdx();
	};
}
