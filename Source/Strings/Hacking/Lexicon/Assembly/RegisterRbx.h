...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRbx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRbx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRbx();
		~Hacking_Lexicon_Assembly_RegisterRbx();
	};
}
