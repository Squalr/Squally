...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEsi : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEsi* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEsi();
		~Hacking_Lexicon_Assembly_RegisterEsi();
	};
}
