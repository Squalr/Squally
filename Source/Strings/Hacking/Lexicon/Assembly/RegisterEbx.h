...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterEbx : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterEbx* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterEbx();
		~Hacking_Lexicon_Assembly_RegisterEbx();
	};
}
