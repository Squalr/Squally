...
namespace Strings
{
	class Hacking_Lexicon_Assembly_RegisterRsp : public LocalizedString
	{
	public:
		static Hacking_Lexicon_Assembly_RegisterRsp* create();
	...
	private:
		Hacking_Lexicon_Assembly_RegisterRsp();
		~Hacking_Lexicon_Assembly_RegisterRsp();
	};
}
