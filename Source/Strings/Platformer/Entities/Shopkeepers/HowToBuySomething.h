...
namespace Strings
{
	class Platformer_Entities_Shopkeepers_HowToBuySomething : public LocalizedString
	{
	public:
		static Platformer_Entities_Shopkeepers_HowToBuySomething* create();
	...
	private:
		Platformer_Entities_Shopkeepers_HowToBuySomething();
		~Platformer_Entities_Shopkeepers_HowToBuySomething();
	};
}
