...
namespace Strings
{
	class Platformer_Entities_HowAboutARoundOfHexus : public LocalizedString
	{
	public:
		static Platformer_Entities_HowAboutARoundOfHexus* create();
	...
	private:
		Platformer_Entities_HowAboutARoundOfHexus();
		~Platformer_Entities_HowAboutARoundOfHexus();
	};
}
