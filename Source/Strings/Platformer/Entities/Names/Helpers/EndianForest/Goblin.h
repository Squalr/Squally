...
namespace Strings
{
	class Platformer_Entities_Names_Helpers_EndianForest_Goblin : public LocalizedString
	{
	public:
		static Platformer_Entities_Names_Helpers_EndianForest_Goblin* create();
	...
	private:
		Platformer_Entities_Names_Helpers_EndianForest_Goblin();
		~Platformer_Entities_Names_Helpers_EndianForest_Goblin();
	};
}
