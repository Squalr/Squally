...
namespace Strings
{
	class Platformer_Entities_Names_Helpers_DaemonsHallow_Apple : public LocalizedString
	{
	public:
		static Platformer_Entities_Names_Helpers_DaemonsHallow_Apple* create();
	...
	private:
		Platformer_Entities_Names_Helpers_DaemonsHallow_Apple();
		~Platformer_Entities_Names_Helpers_DaemonsHallow_Apple();
	};
}
