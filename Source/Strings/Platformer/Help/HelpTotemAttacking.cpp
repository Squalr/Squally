...
namespace Strings
{
	Platformer_Help_HelpTotemAttacking* Platformer_Help_HelpTotemAttacking::create()
	{
		Platformer_Help_HelpTotemAttacking* instance = new Platformer_Help_HelpTotemAttacking();
	...
	LocalizedString* Platformer_Help_HelpTotemAttacking::clone()
	{
		LocalizedString* clonedString = Platformer_Help_HelpTotemAttacking::create();
	...
	Platformer_Help_HelpTotemAttacking::Platformer_Help_HelpTotemAttacking() : LocalizedString()
	{
	}

	Platformer_Help_HelpTotemAttacking::~Platformer_Help_HelpTotemAttacking()
	{
	}

	std::string Platformer_Help_HelpTotemAttacking::getStringIdentifier()
	{
		return "Platformer_Help_HelpTotemAttacking";
	}
