...
namespace Strings
{
	class Platformer_Enemies_BattleCries_DieMortal : public LocalizedString
	{
	public:
		static Platformer_Enemies_BattleCries_DieMortal* create();
	...
	private:
		Platformer_Enemies_BattleCries_DieMortal();
		~Platformer_Enemies_BattleCries_DieMortal();
	};
}
