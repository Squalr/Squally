...
namespace Strings
{
	class Platformer_Quests_FindElriel_OrderMyGuards : public LocalizedString
	{
	public:
		static Platformer_Quests_FindElriel_OrderMyGuards* create();
	...
	private:
		Platformer_Quests_FindElriel_OrderMyGuards();
		~Platformer_Quests_FindElriel_OrderMyGuards();
	};
}
