...
namespace Strings
{
	class Platformer_Quests_FindElriel_HowDareYou : public LocalizedString
	{
	public:
		static Platformer_Quests_FindElriel_HowDareYou* create();
	...
	private:
		Platformer_Quests_FindElriel_HowDareYou();
		~Platformer_Quests_FindElriel_HowDareYou();
	};
}
