...
namespace Strings
{
	class Platformer_Quests_FindElriel_CantLeaveTown : public LocalizedString
	{
	public:
		static Platformer_Quests_FindElriel_CantLeaveTown* create();
	...
	private:
		Platformer_Quests_FindElriel_CantLeaveTown();
		~Platformer_Quests_FindElriel_CantLeaveTown();
	};
}
