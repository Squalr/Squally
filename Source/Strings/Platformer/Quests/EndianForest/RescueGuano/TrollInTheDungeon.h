...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_TrollInTheDungeon : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_TrollInTheDungeon* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_TrollInTheDungeon();
		~Platformer_Quests_EndianForest_RescueGuano_TrollInTheDungeon();
	};
}
