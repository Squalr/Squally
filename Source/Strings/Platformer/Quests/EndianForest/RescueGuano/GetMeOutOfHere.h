...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_GetMeOutOfHere : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_GetMeOutOfHere* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_GetMeOutOfHere();
		~Platformer_Quests_EndianForest_RescueGuano_GetMeOutOfHere();
	};
}
