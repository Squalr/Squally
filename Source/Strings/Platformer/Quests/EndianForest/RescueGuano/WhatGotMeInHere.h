...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_WhatGotMeInHere : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_WhatGotMeInHere* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_WhatGotMeInHere();
		~Platformer_Quests_EndianForest_RescueGuano_WhatGotMeInHere();
	};
}
