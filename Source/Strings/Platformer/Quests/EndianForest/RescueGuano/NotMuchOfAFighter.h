...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_NotMuchOfAFighter : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_NotMuchOfAFighter* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_NotMuchOfAFighter();
		~Platformer_Quests_EndianForest_RescueGuano_NotMuchOfAFighter();
	};
}
