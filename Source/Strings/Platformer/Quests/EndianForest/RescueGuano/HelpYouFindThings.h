...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_HelpYouFindThings : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_HelpYouFindThings* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_HelpYouFindThings();
		~Platformer_Quests_EndianForest_RescueGuano_HelpYouFindThings();
	};
}
