...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_WeShouldHelpHim : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_WeShouldHelpHim* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_WeShouldHelpHim();
		~Platformer_Quests_EndianForest_RescueGuano_WeShouldHelpHim();
	};
}
