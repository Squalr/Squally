...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_Lycan_FollowMe : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_Lycan_FollowMe* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_Lycan_FollowMe();
		~Platformer_Quests_EndianForest_RescueGuano_Lycan_FollowMe();
	};
}
