...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_Lycan_NoVisitors : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_Lycan_NoVisitors* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_Lycan_NoVisitors();
		~Platformer_Quests_EndianForest_RescueGuano_Lycan_NoVisitors();
	};
}
