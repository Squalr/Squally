...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_Lycan_GoingToTheInn : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_Lycan_GoingToTheInn* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_Lycan_GoingToTheInn();
		~Platformer_Quests_EndianForest_RescueGuano_Lycan_GoingToTheInn();
	};
}
