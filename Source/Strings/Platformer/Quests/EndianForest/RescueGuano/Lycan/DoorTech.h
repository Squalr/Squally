...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_Lycan_DoorTech : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_Lycan_DoorTech* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_Lycan_DoorTech();
		~Platformer_Quests_EndianForest_RescueGuano_Lycan_DoorTech();
	};
}
