...
namespace Strings
{
	class Platformer_Quests_EndianForest_RescueGuano_Freedom : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_RescueGuano_Freedom* create();
	...
	private:
		Platformer_Quests_EndianForest_RescueGuano_Freedom();
		~Platformer_Quests_EndianForest_RescueGuano_Freedom();
	};
}
