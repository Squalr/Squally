...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_LegendHasItHexus : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_LegendHasItHexus* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_LegendHasItHexus();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_LegendHasItHexus();
	};
}
