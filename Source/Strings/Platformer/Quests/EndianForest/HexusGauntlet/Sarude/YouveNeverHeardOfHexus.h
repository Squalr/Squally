...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_YouveNeverHeardOfHexus : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_YouveNeverHeardOfHexus* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_YouveNeverHeardOfHexus();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_YouveNeverHeardOfHexus();
	};
}
