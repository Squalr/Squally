...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_IChallengeYou : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_IChallengeYou* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_IChallengeYou();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_IChallengeYou();
	};
}
