...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_FirstChallenge : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_FirstChallenge* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_FirstChallenge();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_FirstChallenge();
	};
}
