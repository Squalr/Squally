...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HexusIsAGameWhere : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HexusIsAGameWhere* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HexusIsAGameWhere();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HexusIsAGameWhere();
	};
}
