...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WelcomeToMagesGuild : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WelcomeToMagesGuild* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WelcomeToMagesGuild();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WelcomeToMagesGuild();
	};
}
