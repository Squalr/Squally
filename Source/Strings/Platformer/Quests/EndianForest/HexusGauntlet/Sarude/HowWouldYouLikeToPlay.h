...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HowWouldYouLikeToPlay : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HowWouldYouLikeToPlay* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HowWouldYouLikeToPlay();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_HowWouldYouLikeToPlay();
	};
}
