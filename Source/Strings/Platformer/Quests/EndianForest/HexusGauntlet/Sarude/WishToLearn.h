...
namespace Strings
{
	class Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WishToLearn : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WishToLearn* create();
	...
	private:
		Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WishToLearn();
		~Platformer_Quests_EndianForest_HexusGauntlet_Sarude_WishToLearn();
	};
}
