...
#include "K_IChallengeYou.h"

namespace Strings
{
	Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou* Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::create()
	{
		Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou* instance = new Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou();
	...
	LocalizedString* Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::clone()
	{
		LocalizedString* clonedString = Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::create();
	...
	Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou() : LocalizedString()
	{
	}

	Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::~Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou()
	{
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringIdentifier()
	{
		return "Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringAr()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringBg()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringCs()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringDa()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringDe()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringEl()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringEn()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringEs()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringEs419()
	{
		return "Veo que pudiste atravesar el guante. Bueno. Creo que estás listo para un partido real. Si puedes derrotarme, te daré la recompensa que prometí.";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringFi()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringFr()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringHu()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringIt()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringJa()
	{
		return "ガントレットを通り抜けることができたと思います。良い。あなたは本当の試合の準備ができていると思います。あなたが私を倒すことができるなら、私はあなたに約束した報酬を与えます。";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringKo()
	{
		return "나는 당신이 건틀렛을 통해 그것을 만들 수 있었다 참조하십시오. 좋은. 나는 당신이 진짜 경기에 대한 준비가 된 것 같아요. 당신이 나를 이길 수 있다면, 나는 당신에게 약속 한 보상을 줄 것입니다.";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringNl()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringNo()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringPl()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringPt()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringPtBr()
	{
		return "Vejo que você conseguiu passar pela luva. Boa. Eu acho que você está pronto para uma partida de verdade. Se você puder me derrotar, eu lhe darei a recompensa que prometi.";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringRo()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringRu()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringSv()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringTh()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringTr()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringUk()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringVi()
	{
	...
	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringZhCn()
	{
		return "我看到您能够通过手套完成任务。好。我认为您已经准备好进行一场真正的比赛。如果你能打败我，我会给你我所承诺的回报。";
	}

	std::string Platformer_Quests_EndianForest_HexusGauntlet_Marcel_K_IChallengeYou::getStringZhTw()
	{
