...
namespace Strings
{
	class Platformer_Quests_EndianForest_FindElriel_NobodyLeavesUntil : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_FindElriel_NobodyLeavesUntil* create();
	...
	private:
		Platformer_Quests_EndianForest_FindElriel_NobodyLeavesUntil();
		~Platformer_Quests_EndianForest_FindElriel_NobodyLeavesUntil();
	};
}
