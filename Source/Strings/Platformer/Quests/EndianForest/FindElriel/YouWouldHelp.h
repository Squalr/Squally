...
namespace Strings
{
	class Platformer_Quests_EndianForest_FindElriel_YouWouldHelp : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_FindElriel_YouWouldHelp* create();
	...
	private:
		Platformer_Quests_EndianForest_FindElriel_YouWouldHelp();
		~Platformer_Quests_EndianForest_FindElriel_YouWouldHelp();
	};
}
