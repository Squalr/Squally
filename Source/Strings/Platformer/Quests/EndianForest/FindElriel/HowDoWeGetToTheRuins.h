...
namespace Strings
{
	class Platformer_Quests_EndianForest_FindElriel_HowDoWeGetToTheRuins : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_FindElriel_HowDoWeGetToTheRuins* create();
	...
	private:
		Platformer_Quests_EndianForest_FindElriel_HowDoWeGetToTheRuins();
		~Platformer_Quests_EndianForest_FindElriel_HowDoWeGetToTheRuins();
	};
}
