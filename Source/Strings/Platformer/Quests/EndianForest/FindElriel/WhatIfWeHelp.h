...
namespace Strings
{
	class Platformer_Quests_EndianForest_FindElriel_WhatIfWeHelp : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_FindElriel_WhatIfWeHelp* create();
	...
	private:
		Platformer_Quests_EndianForest_FindElriel_WhatIfWeHelp();
		~Platformer_Quests_EndianForest_FindElriel_WhatIfWeHelp();
	};
}
