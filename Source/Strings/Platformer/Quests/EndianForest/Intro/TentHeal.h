...
namespace Strings
{
	class Platformer_Quests_EndianForest_Intro_TentHeal : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_Intro_TentHeal* create();
	...
	private:
		Platformer_Quests_EndianForest_Intro_TentHeal();
		~Platformer_Quests_EndianForest_Intro_TentHeal();
	};
}
