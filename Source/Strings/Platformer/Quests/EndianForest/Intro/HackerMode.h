...
namespace Strings
{
	class Platformer_Quests_EndianForest_Intro_HackerMode : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_Intro_HackerMode* create();
	...
	private:
		Platformer_Quests_EndianForest_Intro_HackerMode();
		~Platformer_Quests_EndianForest_Intro_HackerMode();
	};
}
