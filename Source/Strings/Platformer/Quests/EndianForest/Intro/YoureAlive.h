...
namespace Strings
{
	class Platformer_Quests_EndianForest_Intro_YoureAlive : public LocalizedString
	{
	public:
		static Platformer_Quests_EndianForest_Intro_YoureAlive* create();
	...
	private:
		Platformer_Quests_EndianForest_Intro_YoureAlive();
		~Platformer_Quests_EndianForest_Intro_YoureAlive();
	};
}
