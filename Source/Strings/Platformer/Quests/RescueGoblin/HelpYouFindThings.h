...
namespace Strings
{
	class Platformer_Quests_RescueGoblin_HelpYouFindThings : public LocalizedString
	{
	public:
		static Platformer_Quests_RescueGoblin_HelpYouFindThings* create();
	...
	private:
		Platformer_Quests_RescueGoblin_HelpYouFindThings();
		~Platformer_Quests_RescueGoblin_HelpYouFindThings();
	};
}
