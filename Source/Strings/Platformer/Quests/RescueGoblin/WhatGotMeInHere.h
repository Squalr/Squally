...
namespace Strings
{
	class Platformer_Quests_RescueGoblin_WhatGotMeInHere : public LocalizedString
	{
	public:
		static Platformer_Quests_RescueGoblin_WhatGotMeInHere* create();
	...
	private:
		Platformer_Quests_RescueGoblin_WhatGotMeInHere();
		~Platformer_Quests_RescueGoblin_WhatGotMeInHere();
	};
}
