...
namespace Strings
{
	class Platformer_Quests_RescueGoblin_GetMeOutOfHere : public LocalizedString
	{
	public:
		static Platformer_Quests_RescueGoblin_GetMeOutOfHere* create();
	...
	private:
		Platformer_Quests_RescueGoblin_GetMeOutOfHere();
		~Platformer_Quests_RescueGoblin_GetMeOutOfHere();
	};
}
