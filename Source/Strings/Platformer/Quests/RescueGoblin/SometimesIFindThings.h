...
namespace Strings
{
	class Platformer_Quests_RescueGoblin_SometimesIFindThings : public LocalizedString
	{
	public:
		static Platformer_Quests_RescueGoblin_SometimesIFindThings* create();
	...
	private:
		Platformer_Quests_RescueGoblin_SometimesIFindThings();
		~Platformer_Quests_RescueGoblin_SometimesIFindThings();
	};
}
