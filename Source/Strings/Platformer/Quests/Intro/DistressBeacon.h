...
namespace Strings
{
	class Platformer_Quests_Intro_DistressBeacon : public LocalizedString
	{
	public:
		static Platformer_Quests_Intro_DistressBeacon* create();
	...
	private:
		Platformer_Quests_Intro_DistressBeacon();
		~Platformer_Quests_Intro_DistressBeacon();
	};
}
