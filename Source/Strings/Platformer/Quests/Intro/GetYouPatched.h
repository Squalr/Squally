...
namespace Strings
{
	class Platformer_Quests_Intro_GetYouPatched : public LocalizedString
	{
	public:
		static Platformer_Quests_Intro_GetYouPatched* create();
	...
	private:
		Platformer_Quests_Intro_GetYouPatched();
		~Platformer_Quests_Intro_GetYouPatched();
	};
}
