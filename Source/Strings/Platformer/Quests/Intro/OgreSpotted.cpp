...
#include "OgreSpotted.h"

namespace Strings
{
	Platformer_Quests_Intro_OgreSpotted* Platformer_Quests_Intro_OgreSpotted::create()
	{
		Platformer_Quests_Intro_OgreSpotted* instance = new Platformer_Quests_Intro_OgreSpotted();
	...
	LocalizedString* Platformer_Quests_Intro_OgreSpotted::clone()
	{
		LocalizedString* clonedString = Platformer_Quests_Intro_OgreSpotted::create();
	...
	Platformer_Quests_Intro_OgreSpotted::Platformer_Quests_Intro_OgreSpotted() : LocalizedString()
	{
	}

	Platformer_Quests_Intro_OgreSpotted::~Platformer_Quests_Intro_OgreSpotted()
	{
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringIdentifier()
	{
		return "Platformer_Quests_Intro_OgreSpotted";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringAr()
	{
		return "حذر! أرى عدوًا قادمًا. منذ أن انفتحت السماء ، انتشرت الوحوش إلى زوايا الأرض.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringBg()
	{
		return "Внимателен! Виждам враг напред. Откакто небето се отвори, чудовищата се разпространиха по ъглите на Земята.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringCs()
	{
		return "Opatrný! Před sebou vidím nepřítele. Od té doby, co se obloha rozlétla, se příšery rozšířily do koutů Země.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringDa()
	{
		return "Forsigtig! Jeg ser en fjende fremad. Helt siden skyen har åbnet, har monstre spredt sig til jordens hjørner.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringDe()
	{
	...
	std::string Platformer_Quests_Intro_OgreSpotted::getStringEl()
	{
	...
	std::string Platformer_Quests_Intro_OgreSpotted::getStringEn()
	{
		return "Careful! I see an enemy ahead. Ever since the sky cracked open, monsters have spread to the corners of the Earth.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringEs()
	{
	...
	std::string Platformer_Quests_Intro_OgreSpotted::getStringEs419()
	{
		return "¡Cuidadoso! Veo un enemigo por delante. Desde que el cielo se abrió, los monstruos se han extendido a los rincones de la Tierra.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringFi()
	{
		return "Varovainen! Näen vihollisen eteenpäin. Siitä lähtien, kun taivas säröi auki, hirviöt ovat levinneet maan kulmiin.";
	}

	std::string Platformer_Quests_Intro_OgreSpotted::getStringFr()
	{
