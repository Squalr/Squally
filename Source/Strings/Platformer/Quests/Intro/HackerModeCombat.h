...
namespace Strings
{
	class Platformer_Quests_Intro_HackerModeCombat : public LocalizedString
	{
	public:
		static Platformer_Quests_Intro_HackerModeCombat* create();
	...
	private:
		Platformer_Quests_Intro_HackerModeCombat();
		~Platformer_Quests_Intro_HackerModeCombat();
	};
}
