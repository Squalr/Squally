...
namespace Strings
{
	class Platformer_Quests_Intro_SquallyTrapped : public LocalizedString
	{
	public:
		static Platformer_Quests_Intro_SquallyTrapped* create();
	...
	private:
		Platformer_Quests_Intro_SquallyTrapped();
		~Platformer_Quests_Intro_SquallyTrapped();
	};
}
