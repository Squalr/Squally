...
namespace Strings
{
	class Menus_CodeEditor_Errors_OperandSizeMismatch : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_OperandSizeMismatch* create();
	...
	private:
		Menus_CodeEditor_Errors_OperandSizeMismatch();
		~Menus_CodeEditor_Errors_OperandSizeMismatch();
	};
}
