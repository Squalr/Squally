...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidMask* Menus_CodeEditor_Errors_InvalidMask::create()
	{
		Menus_CodeEditor_Errors_InvalidMask* instance = new Menus_CodeEditor_Errors_InvalidMask();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidMask::clone()
	{
		return Menus_CodeEditor_Errors_InvalidMask::create();
	}

	Menus_CodeEditor_Errors_InvalidMask::Menus_CodeEditor_Errors_InvalidMask() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidMask::~Menus_CodeEditor_Errors_InvalidMask()
	{
	}
