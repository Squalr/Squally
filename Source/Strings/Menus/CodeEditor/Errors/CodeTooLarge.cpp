...
namespace Strings
{
	Menus_CodeEditor_Errors_CodeTooLarge* Menus_CodeEditor_Errors_CodeTooLarge::create()
	{
		Menus_CodeEditor_Errors_CodeTooLarge* instance = new Menus_CodeEditor_Errors_CodeTooLarge();
	...
	LocalizedString* Menus_CodeEditor_Errors_CodeTooLarge::clone()
	{
		return Menus_CodeEditor_Errors_CodeTooLarge::create();
	}

	Menus_CodeEditor_Errors_CodeTooLarge::Menus_CodeEditor_Errors_CodeTooLarge() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_CodeTooLarge::~Menus_CodeEditor_Errors_CodeTooLarge()
	{
	}
