...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidOption* Menus_CodeEditor_Errors_InvalidOption::create()
	{
		Menus_CodeEditor_Errors_InvalidOption* instance = new Menus_CodeEditor_Errors_InvalidOption();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidOption::clone()
	{
		return Menus_CodeEditor_Errors_InvalidOption::create();
	}

	Menus_CodeEditor_Errors_InvalidOption::Menus_CodeEditor_Errors_InvalidOption() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidOption::~Menus_CodeEditor_Errors_InvalidOption()
	{
	}
