...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRelocationEntry* Menus_CodeEditor_Errors_InvalidRelocationEntry::create()
	{
		Menus_CodeEditor_Errors_InvalidRelocationEntry* instance = new Menus_CodeEditor_Errors_InvalidRelocationEntry();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRelocationEntry::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRelocationEntry::create();
	}

	Menus_CodeEditor_Errors_InvalidRelocationEntry::Menus_CodeEditor_Errors_InvalidRelocationEntry() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRelocationEntry::~Menus_CodeEditor_Errors_InvalidRelocationEntry()
	{
	}
