...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidArchitecture* Menus_CodeEditor_Errors_InvalidArchitecture::create()
	{
		Menus_CodeEditor_Errors_InvalidArchitecture* instance = new Menus_CodeEditor_Errors_InvalidArchitecture();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidArchitecture::clone()
	{
		return Menus_CodeEditor_Errors_InvalidArchitecture::create();
	}

	Menus_CodeEditor_Errors_InvalidArchitecture::Menus_CodeEditor_Errors_InvalidArchitecture() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidArchitecture::~Menus_CodeEditor_Errors_InvalidArchitecture()
	{
	}
