...
namespace Strings
{
	Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent* Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent::create()
	{
		Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent* instance = new Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent();
	...
	LocalizedString* Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent::clone()
	{
		return Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent::create();
	}

	Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent::Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent::~Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent()
	{
	}
