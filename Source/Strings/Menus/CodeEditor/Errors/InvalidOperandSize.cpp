...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidOperandSize* Menus_CodeEditor_Errors_InvalidOperandSize::create()
	{
		Menus_CodeEditor_Errors_InvalidOperandSize* instance = new Menus_CodeEditor_Errors_InvalidOperandSize();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidOperandSize::clone()
	{
		return Menus_CodeEditor_Errors_InvalidOperandSize::create();
	}

	Menus_CodeEditor_Errors_InvalidOperandSize::Menus_CodeEditor_Errors_InvalidOperandSize() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidOperandSize::~Menus_CodeEditor_Errors_InvalidOperandSize()
	{
	}
