...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidParentLabel : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidParentLabel* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidParentLabel();
		~Menus_CodeEditor_Errors_InvalidParentLabel();
	};
}
