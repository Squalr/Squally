...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRegisterPhysicalId* Menus_CodeEditor_Errors_InvalidRegisterPhysicalId::create()
	{
		Menus_CodeEditor_Errors_InvalidRegisterPhysicalId* instance = new Menus_CodeEditor_Errors_InvalidRegisterPhysicalId();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRegisterPhysicalId::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRegisterPhysicalId::create();
	}

	Menus_CodeEditor_Errors_InvalidRegisterPhysicalId::Menus_CodeEditor_Errors_InvalidRegisterPhysicalId() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRegisterPhysicalId::~Menus_CodeEditor_Errors_InvalidRegisterPhysicalId()
	{
	}
