...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidLockPrefix : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidLockPrefix* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidLockPrefix();
		~Menus_CodeEditor_Errors_InvalidLockPrefix();
	};
}
