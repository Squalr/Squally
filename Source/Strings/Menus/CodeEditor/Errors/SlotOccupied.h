...
namespace Strings
{
	class Menus_CodeEditor_Errors_SlotOccupied : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_SlotOccupied* create();
	...
	private:
		Menus_CodeEditor_Errors_SlotOccupied();
		~Menus_CodeEditor_Errors_SlotOccupied();
	};
}
