...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseDouble : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseDouble* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseDouble();
		~Menus_CodeEditor_Errors_InvalidUseDouble();
	};
}
