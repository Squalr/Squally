...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRegisterVirtualId : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRegisterVirtualId* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRegisterVirtualId();
		~Menus_CodeEditor_Errors_InvalidRegisterVirtualId();
	};
}
