...
namespace Strings
{
	Menus_CodeEditor_Errors_NotConsecutiveRegisters* Menus_CodeEditor_Errors_NotConsecutiveRegisters::create()
	{
		Menus_CodeEditor_Errors_NotConsecutiveRegisters* instance = new Menus_CodeEditor_Errors_NotConsecutiveRegisters();
	...
	LocalizedString* Menus_CodeEditor_Errors_NotConsecutiveRegisters::clone()
	{
		return Menus_CodeEditor_Errors_NotConsecutiveRegisters::create();
	}

	Menus_CodeEditor_Errors_NotConsecutiveRegisters::Menus_CodeEditor_Errors_NotConsecutiveRegisters() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NotConsecutiveRegisters::~Menus_CodeEditor_Errors_NotConsecutiveRegisters()
	{
	}
