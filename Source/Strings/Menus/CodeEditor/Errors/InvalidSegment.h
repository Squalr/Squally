...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidSegment : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidSegment* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidSegment();
		~Menus_CodeEditor_Errors_InvalidSegment();
	};
}
