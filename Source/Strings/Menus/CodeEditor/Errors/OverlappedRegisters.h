...
namespace Strings
{
	class Menus_CodeEditor_Errors_OverlappedRegisters : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_OverlappedRegisters* create();
	...
	private:
		Menus_CodeEditor_Errors_OverlappedRegisters();
		~Menus_CodeEditor_Errors_OverlappedRegisters();
	};
}
