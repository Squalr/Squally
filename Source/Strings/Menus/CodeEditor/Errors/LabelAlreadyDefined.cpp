...
namespace Strings
{
	Menus_CodeEditor_Errors_LabelAlreadyDefined* Menus_CodeEditor_Errors_LabelAlreadyDefined::create()
	{
		Menus_CodeEditor_Errors_LabelAlreadyDefined* instance = new Menus_CodeEditor_Errors_LabelAlreadyDefined();
	...
	LocalizedString* Menus_CodeEditor_Errors_LabelAlreadyDefined::clone()
	{
		return Menus_CodeEditor_Errors_LabelAlreadyDefined::create();
	}

	Menus_CodeEditor_Errors_LabelAlreadyDefined::Menus_CodeEditor_Errors_LabelAlreadyDefined() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_LabelAlreadyDefined::~Menus_CodeEditor_Errors_LabelAlreadyDefined()
	{
	}
