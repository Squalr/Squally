...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRegisterType : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRegisterType* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRegisterType();
		~Menus_CodeEditor_Errors_InvalidRegisterType();
	};
}
