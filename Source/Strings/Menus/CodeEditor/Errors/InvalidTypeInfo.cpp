...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidTypeInfo* Menus_CodeEditor_Errors_InvalidTypeInfo::create()
	{
		Menus_CodeEditor_Errors_InvalidTypeInfo* instance = new Menus_CodeEditor_Errors_InvalidTypeInfo();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidTypeInfo::clone()
	{
		return Menus_CodeEditor_Errors_InvalidTypeInfo::create();
	}

	Menus_CodeEditor_Errors_InvalidTypeInfo::Menus_CodeEditor_Errors_InvalidTypeInfo() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidTypeInfo::~Menus_CodeEditor_Errors_InvalidTypeInfo()
	{
	}
