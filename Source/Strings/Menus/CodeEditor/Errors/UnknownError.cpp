...
namespace Strings
{
	Menus_CodeEditor_Errors_UnknownError* Menus_CodeEditor_Errors_UnknownError::create()
	{
		Menus_CodeEditor_Errors_UnknownError* instance = new Menus_CodeEditor_Errors_UnknownError();
	...
	LocalizedString* Menus_CodeEditor_Errors_UnknownError::clone()
	{
		return Menus_CodeEditor_Errors_UnknownError::create();
	}

	Menus_CodeEditor_Errors_UnknownError::Menus_CodeEditor_Errors_UnknownError() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_UnknownError::~Menus_CodeEditor_Errors_UnknownError()
	{
	}
