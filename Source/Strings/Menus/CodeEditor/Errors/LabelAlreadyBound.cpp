...
namespace Strings
{
	Menus_CodeEditor_Errors_LabelAlreadyBound* Menus_CodeEditor_Errors_LabelAlreadyBound::create()
	{
		Menus_CodeEditor_Errors_LabelAlreadyBound* instance = new Menus_CodeEditor_Errors_LabelAlreadyBound();
	...
	LocalizedString* Menus_CodeEditor_Errors_LabelAlreadyBound::clone()
	{
		return Menus_CodeEditor_Errors_LabelAlreadyBound::create();
	}

	Menus_CodeEditor_Errors_LabelAlreadyBound::Menus_CodeEditor_Errors_LabelAlreadyBound() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_LabelAlreadyBound::~Menus_CodeEditor_Errors_LabelAlreadyBound()
	{
	}

	std::string Menus_CodeEditor_Errors_LabelAlreadyBound::getStringIdentifier()
	{
		return "Menus_CodeEditor_Errors_LabelAlreadyBound";
	}
