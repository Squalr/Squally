...
namespace Strings
{
	Menus_CodeEditor_Errors_AmbiguousOperandSize* Menus_CodeEditor_Errors_AmbiguousOperandSize::create()
	{
		Menus_CodeEditor_Errors_AmbiguousOperandSize* instance = new Menus_CodeEditor_Errors_AmbiguousOperandSize();
	...
	LocalizedString* Menus_CodeEditor_Errors_AmbiguousOperandSize::clone()
	{
		return Menus_CodeEditor_Errors_AmbiguousOperandSize::create();
	}

	Menus_CodeEditor_Errors_AmbiguousOperandSize::Menus_CodeEditor_Errors_AmbiguousOperandSize() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_AmbiguousOperandSize::~Menus_CodeEditor_Errors_AmbiguousOperandSize()
	{
	}
