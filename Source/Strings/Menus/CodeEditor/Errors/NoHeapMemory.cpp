...
namespace Strings
{
	Menus_CodeEditor_Errors_NoHeapMemory* Menus_CodeEditor_Errors_NoHeapMemory::create()
	{
		Menus_CodeEditor_Errors_NoHeapMemory* instance = new Menus_CodeEditor_Errors_NoHeapMemory();
	...
	LocalizedString* Menus_CodeEditor_Errors_NoHeapMemory::clone()
	{
		return Menus_CodeEditor_Errors_NoHeapMemory::create();
	}

	Menus_CodeEditor_Errors_NoHeapMemory::Menus_CodeEditor_Errors_NoHeapMemory() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NoHeapMemory::~Menus_CodeEditor_Errors_NoHeapMemory()
	{
	}
