...
namespace Strings
{
	Menus_CodeEditor_Errors_SlotOccupied* Menus_CodeEditor_Errors_SlotOccupied::create()
	{
		Menus_CodeEditor_Errors_SlotOccupied* instance = new Menus_CodeEditor_Errors_SlotOccupied();
	...
	LocalizedString* Menus_CodeEditor_Errors_SlotOccupied::clone()
	{
		return Menus_CodeEditor_Errors_SlotOccupied::create();
	}

	Menus_CodeEditor_Errors_SlotOccupied::Menus_CodeEditor_Errors_SlotOccupied() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_SlotOccupied::~Menus_CodeEditor_Errors_SlotOccupied()
	{
	}
