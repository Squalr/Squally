...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidImmediateValue : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidImmediateValue* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidImmediateValue();
		~Menus_CodeEditor_Errors_InvalidImmediateValue();
	};
}
