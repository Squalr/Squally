...
namespace Strings
{
	Menus_CodeEditor_Errors_LabelIndexOverflow* Menus_CodeEditor_Errors_LabelIndexOverflow::create()
	{
		Menus_CodeEditor_Errors_LabelIndexOverflow* instance = new Menus_CodeEditor_Errors_LabelIndexOverflow();
	...
	LocalizedString* Menus_CodeEditor_Errors_LabelIndexOverflow::clone()
	{
		return Menus_CodeEditor_Errors_LabelIndexOverflow::create();
	}

	Menus_CodeEditor_Errors_LabelIndexOverflow::Menus_CodeEditor_Errors_LabelIndexOverflow() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_LabelIndexOverflow::~Menus_CodeEditor_Errors_LabelIndexOverflow()
	{
	}
