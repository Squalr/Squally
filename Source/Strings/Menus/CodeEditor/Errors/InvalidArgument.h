...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidArgument : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidArgument* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidArgument();
		~Menus_CodeEditor_Errors_InvalidArgument();
	};
}
