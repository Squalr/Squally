...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidXAquirePrefix* Menus_CodeEditor_Errors_InvalidXAquirePrefix::create()
	{
		Menus_CodeEditor_Errors_InvalidXAquirePrefix* instance = new Menus_CodeEditor_Errors_InvalidXAquirePrefix();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidXAquirePrefix::clone()
	{
		return Menus_CodeEditor_Errors_InvalidXAquirePrefix::create();
	}

	Menus_CodeEditor_Errors_InvalidXAquirePrefix::Menus_CodeEditor_Errors_InvalidXAquirePrefix() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidXAquirePrefix::~Menus_CodeEditor_Errors_InvalidXAquirePrefix()
	{
	}
