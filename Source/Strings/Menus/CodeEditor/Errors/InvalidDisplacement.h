...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidDisplacement : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidDisplacement* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidDisplacement();
		~Menus_CodeEditor_Errors_InvalidDisplacement();
	};
}
