...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidState : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidState* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidState();
		~Menus_CodeEditor_Errors_InvalidState();
	};
}
