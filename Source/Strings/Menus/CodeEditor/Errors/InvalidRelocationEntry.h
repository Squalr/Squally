...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRelocationEntry : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRelocationEntry* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRelocationEntry();
		~Menus_CodeEditor_Errors_InvalidRelocationEntry();
	};
}
