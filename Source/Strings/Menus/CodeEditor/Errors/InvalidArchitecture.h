...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidArchitecture : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidArchitecture* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidArchitecture();
		~Menus_CodeEditor_Errors_InvalidArchitecture();
	};
}
