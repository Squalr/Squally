...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidUseSingle* Menus_CodeEditor_Errors_InvalidUseSingle::create()
	{
		Menus_CodeEditor_Errors_InvalidUseSingle* instance = new Menus_CodeEditor_Errors_InvalidUseSingle();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidUseSingle::clone()
	{
		return Menus_CodeEditor_Errors_InvalidUseSingle::create();
	}

	Menus_CodeEditor_Errors_InvalidUseSingle::Menus_CodeEditor_Errors_InvalidUseSingle() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidUseSingle::~Menus_CodeEditor_Errors_InvalidUseSingle()
	{
	}

	std::string Menus_CodeEditor_Errors_InvalidUseSingle::getStringIdentifier()
	{
		return "Menus_CodeEditor_Errors_InvalidUseSingle";
	}
