...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidLabelName : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidLabelName* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidLabelName();
		~Menus_CodeEditor_Errors_InvalidLabelName();
	};
}
