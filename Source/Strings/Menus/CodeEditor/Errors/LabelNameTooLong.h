...
namespace Strings
{
	class Menus_CodeEditor_Errors_LabelNameTooLong : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_LabelNameTooLong* create();
	...
	private:
		Menus_CodeEditor_Errors_LabelNameTooLong();
		~Menus_CodeEditor_Errors_LabelNameTooLong();
	};
}
