...
namespace Strings
{
	class Menus_CodeEditor_Errors_CodeTooLarge : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_CodeTooLarge* create();
	...
	private:
		Menus_CodeEditor_Errors_CodeTooLarge();
		~Menus_CodeEditor_Errors_CodeTooLarge();
	};
}
