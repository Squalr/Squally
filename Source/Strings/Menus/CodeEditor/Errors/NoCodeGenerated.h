...
namespace Strings
{
	class Menus_CodeEditor_Errors_NoCodeGenerated : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NoCodeGenerated* create();
	...
	private:
		Menus_CodeEditor_Errors_NoCodeGenerated();
		~Menus_CodeEditor_Errors_NoCodeGenerated();
	};
}
