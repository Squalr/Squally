...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidOperandSize : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidOperandSize* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidOperandSize();
		~Menus_CodeEditor_Errors_InvalidOperandSize();
	};
}
