...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidSegment* Menus_CodeEditor_Errors_InvalidSegment::create()
	{
		Menus_CodeEditor_Errors_InvalidSegment* instance = new Menus_CodeEditor_Errors_InvalidSegment();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidSegment::clone()
	{
		return Menus_CodeEditor_Errors_InvalidSegment::create();
	}

	Menus_CodeEditor_Errors_InvalidSegment::Menus_CodeEditor_Errors_InvalidSegment() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidSegment::~Menus_CodeEditor_Errors_InvalidSegment()
	{
	}
