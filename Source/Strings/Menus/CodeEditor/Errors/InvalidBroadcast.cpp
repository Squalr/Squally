...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidBroadcast* Menus_CodeEditor_Errors_InvalidBroadcast::create()
	{
		Menus_CodeEditor_Errors_InvalidBroadcast* instance = new Menus_CodeEditor_Errors_InvalidBroadcast();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidBroadcast::clone()
	{
		return Menus_CodeEditor_Errors_InvalidBroadcast::create();
	}

	Menus_CodeEditor_Errors_InvalidBroadcast::Menus_CodeEditor_Errors_InvalidBroadcast() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidBroadcast::~Menus_CodeEditor_Errors_InvalidBroadcast()
	{
	}
