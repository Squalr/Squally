...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidOption : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidOption* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidOption();
		~Menus_CodeEditor_Errors_InvalidOption();
	};
}
