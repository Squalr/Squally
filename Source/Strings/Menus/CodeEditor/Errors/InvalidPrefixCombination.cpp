...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidPrefixCombination* Menus_CodeEditor_Errors_InvalidPrefixCombination::create()
	{
		Menus_CodeEditor_Errors_InvalidPrefixCombination* instance = new Menus_CodeEditor_Errors_InvalidPrefixCombination();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidPrefixCombination::clone()
	{
		return Menus_CodeEditor_Errors_InvalidPrefixCombination::create();
	}

	Menus_CodeEditor_Errors_InvalidPrefixCombination::Menus_CodeEditor_Errors_InvalidPrefixCombination() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidPrefixCombination::~Menus_CodeEditor_Errors_InvalidPrefixCombination()
	{
	}
