...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidImmediateValue* Menus_CodeEditor_Errors_InvalidImmediateValue::create()
	{
		Menus_CodeEditor_Errors_InvalidImmediateValue* instance = new Menus_CodeEditor_Errors_InvalidImmediateValue();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidImmediateValue::clone()
	{
		return Menus_CodeEditor_Errors_InvalidImmediateValue::create();
	}

	Menus_CodeEditor_Errors_InvalidImmediateValue::Menus_CodeEditor_Errors_InvalidImmediateValue() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidImmediateValue::~Menus_CodeEditor_Errors_InvalidImmediateValue()
	{
	}
