...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidUseOf80BitFloat* Menus_CodeEditor_Errors_InvalidUseOf80BitFloat::create()
	{
		Menus_CodeEditor_Errors_InvalidUseOf80BitFloat* instance = new Menus_CodeEditor_Errors_InvalidUseOf80BitFloat();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidUseOf80BitFloat::clone()
	{
		return Menus_CodeEditor_Errors_InvalidUseOf80BitFloat::create();
	}

	Menus_CodeEditor_Errors_InvalidUseOf80BitFloat::Menus_CodeEditor_Errors_InvalidUseOf80BitFloat() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidUseOf80BitFloat::~Menus_CodeEditor_Errors_InvalidUseOf80BitFloat()
	{
	}
