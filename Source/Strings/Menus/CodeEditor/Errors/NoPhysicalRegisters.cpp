...
namespace Strings
{
	Menus_CodeEditor_Errors_NoPhysicalRegisters* Menus_CodeEditor_Errors_NoPhysicalRegisters::create()
	{
		Menus_CodeEditor_Errors_NoPhysicalRegisters* instance = new Menus_CodeEditor_Errors_NoPhysicalRegisters();
	...
	LocalizedString* Menus_CodeEditor_Errors_NoPhysicalRegisters::clone()
	{
		return Menus_CodeEditor_Errors_NoPhysicalRegisters::create();
	}

	Menus_CodeEditor_Errors_NoPhysicalRegisters::Menus_CodeEditor_Errors_NoPhysicalRegisters() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NoPhysicalRegisters::~Menus_CodeEditor_Errors_NoPhysicalRegisters()
	{
	}
