...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseOf64BitRegister : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseOf64BitRegister* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseOf64BitRegister();
		~Menus_CodeEditor_Errors_InvalidUseOf64BitRegister();
	};
}
