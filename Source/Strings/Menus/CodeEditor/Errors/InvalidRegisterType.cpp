...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRegisterType* Menus_CodeEditor_Errors_InvalidRegisterType::create()
	{
		Menus_CodeEditor_Errors_InvalidRegisterType* instance = new Menus_CodeEditor_Errors_InvalidRegisterType();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRegisterType::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRegisterType::create();
	}

	Menus_CodeEditor_Errors_InvalidRegisterType::Menus_CodeEditor_Errors_InvalidRegisterType() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRegisterType::~Menus_CodeEditor_Errors_InvalidRegisterType()
	{
	}

	std::string Menus_CodeEditor_Errors_InvalidRegisterType::getStringIdentifier()
	{
		return "Menus_CodeEditor_Errors_InvalidRegisterType";
	}
