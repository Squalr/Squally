...
namespace Strings
{
	Menus_CodeEditor_Errors_LabelNameTooLong* Menus_CodeEditor_Errors_LabelNameTooLong::create()
	{
		Menus_CodeEditor_Errors_LabelNameTooLong* instance = new Menus_CodeEditor_Errors_LabelNameTooLong();
	...
	LocalizedString* Menus_CodeEditor_Errors_LabelNameTooLong::clone()
	{
		return Menus_CodeEditor_Errors_LabelNameTooLong::create();
	}

	Menus_CodeEditor_Errors_LabelNameTooLong::Menus_CodeEditor_Errors_LabelNameTooLong() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_LabelNameTooLong::~Menus_CodeEditor_Errors_LabelNameTooLong()
	{
	}
