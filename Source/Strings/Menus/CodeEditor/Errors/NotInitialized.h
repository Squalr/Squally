...
namespace Strings
{
	class Menus_CodeEditor_Errors_NotInitialized : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NotInitialized* create();
	...
	private:
		Menus_CodeEditor_Errors_NotInitialized();
		~Menus_CodeEditor_Errors_NotInitialized();
	};
}
