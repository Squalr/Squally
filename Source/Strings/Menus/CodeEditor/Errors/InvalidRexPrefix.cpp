...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRexPrefix* Menus_CodeEditor_Errors_InvalidRexPrefix::create()
	{
		Menus_CodeEditor_Errors_InvalidRexPrefix* instance = new Menus_CodeEditor_Errors_InvalidRexPrefix();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRexPrefix::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRexPrefix::create();
	}

	Menus_CodeEditor_Errors_InvalidRexPrefix::Menus_CodeEditor_Errors_InvalidRexPrefix() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRexPrefix::~Menus_CodeEditor_Errors_InvalidRexPrefix()
	{
	}
