...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidXAquirePrefix : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidXAquirePrefix* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidXAquirePrefix();
		~Menus_CodeEditor_Errors_InvalidXAquirePrefix();
	};
}
