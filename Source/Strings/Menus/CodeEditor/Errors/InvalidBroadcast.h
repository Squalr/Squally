...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidBroadcast : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidBroadcast* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidBroadcast();
		~Menus_CodeEditor_Errors_InvalidBroadcast();
	};
}
