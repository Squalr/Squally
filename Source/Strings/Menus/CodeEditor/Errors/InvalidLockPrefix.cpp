...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidLockPrefix* Menus_CodeEditor_Errors_InvalidLockPrefix::create()
	{
		Menus_CodeEditor_Errors_InvalidLockPrefix* instance = new Menus_CodeEditor_Errors_InvalidLockPrefix();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidLockPrefix::clone()
	{
		return Menus_CodeEditor_Errors_InvalidLockPrefix::create();
	}

	Menus_CodeEditor_Errors_InvalidLockPrefix::Menus_CodeEditor_Errors_InvalidLockPrefix() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidLockPrefix::~Menus_CodeEditor_Errors_InvalidLockPrefix()
	{
	}
