...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidXReleasePrefix : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidXReleasePrefix* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidXReleasePrefix();
		~Menus_CodeEditor_Errors_InvalidXReleasePrefix();
	};
}
