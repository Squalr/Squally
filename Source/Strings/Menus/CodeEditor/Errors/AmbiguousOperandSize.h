...
namespace Strings
{
	class Menus_CodeEditor_Errors_AmbiguousOperandSize : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_AmbiguousOperandSize* create();
	...
	private:
		Menus_CodeEditor_Errors_AmbiguousOperandSize();
		~Menus_CodeEditor_Errors_AmbiguousOperandSize();
	};
}
