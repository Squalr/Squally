...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRegisterPhysicalId : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRegisterPhysicalId* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRegisterPhysicalId();
		~Menus_CodeEditor_Errors_InvalidRegisterPhysicalId();
	};
}
