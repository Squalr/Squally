...
namespace Strings
{
	class Menus_CodeEditor_Errors_NoVirtualMemory : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NoVirtualMemory* create();
	...
	private:
		Menus_CodeEditor_Errors_NoVirtualMemory();
		~Menus_CodeEditor_Errors_NoVirtualMemory();
	};
}
