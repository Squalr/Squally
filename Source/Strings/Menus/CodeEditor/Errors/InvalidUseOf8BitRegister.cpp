...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidUseOf8BitRegister* Menus_CodeEditor_Errors_InvalidUseOf8BitRegister::create()
	{
		Menus_CodeEditor_Errors_InvalidUseOf8BitRegister* instance = new Menus_CodeEditor_Errors_InvalidUseOf8BitRegister();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidUseOf8BitRegister::clone()
	{
		return Menus_CodeEditor_Errors_InvalidUseOf8BitRegister::create();
	}

	Menus_CodeEditor_Errors_InvalidUseOf8BitRegister::Menus_CodeEditor_Errors_InvalidUseOf8BitRegister() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidUseOf8BitRegister::~Menus_CodeEditor_Errors_InvalidUseOf8BitRegister()
	{
	}
