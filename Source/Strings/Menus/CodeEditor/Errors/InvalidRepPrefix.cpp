...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRepPrefix* Menus_CodeEditor_Errors_InvalidRepPrefix::create()
	{
		Menus_CodeEditor_Errors_InvalidRepPrefix* instance = new Menus_CodeEditor_Errors_InvalidRepPrefix();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRepPrefix::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRepPrefix::create();
	}

	Menus_CodeEditor_Errors_InvalidRepPrefix::Menus_CodeEditor_Errors_InvalidRepPrefix() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRepPrefix::~Menus_CodeEditor_Errors_InvalidRepPrefix()
	{
	}

	std::string Menus_CodeEditor_Errors_InvalidRepPrefix::getStringIdentifier()
	{
		return "Menus_CodeEditor_Errors_InvalidRepPrefix";
	}
