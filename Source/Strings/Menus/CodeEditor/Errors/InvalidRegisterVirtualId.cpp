...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidRegisterVirtualId* Menus_CodeEditor_Errors_InvalidRegisterVirtualId::create()
	{
		Menus_CodeEditor_Errors_InvalidRegisterVirtualId* instance = new Menus_CodeEditor_Errors_InvalidRegisterVirtualId();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidRegisterVirtualId::clone()
	{
		return Menus_CodeEditor_Errors_InvalidRegisterVirtualId::create();
	}

	Menus_CodeEditor_Errors_InvalidRegisterVirtualId::Menus_CodeEditor_Errors_InvalidRegisterVirtualId() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidRegisterVirtualId::~Menus_CodeEditor_Errors_InvalidRegisterVirtualId()
	{
	}
