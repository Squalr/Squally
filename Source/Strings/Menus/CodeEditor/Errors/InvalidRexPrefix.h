...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRexPrefix : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRexPrefix* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRexPrefix();
		~Menus_CodeEditor_Errors_InvalidRexPrefix();
	};
}
