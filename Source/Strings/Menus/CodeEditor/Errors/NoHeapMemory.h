...
namespace Strings
{
	class Menus_CodeEditor_Errors_NoHeapMemory : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NoHeapMemory* create();
	...
	private:
		Menus_CodeEditor_Errors_NoHeapMemory();
		~Menus_CodeEditor_Errors_NoHeapMemory();
	};
}
