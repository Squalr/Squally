...
namespace Strings
{
	Menus_CodeEditor_Errors_NoVirtualMemory* Menus_CodeEditor_Errors_NoVirtualMemory::create()
	{
		Menus_CodeEditor_Errors_NoVirtualMemory* instance = new Menus_CodeEditor_Errors_NoVirtualMemory();
	...
	LocalizedString* Menus_CodeEditor_Errors_NoVirtualMemory::clone()
	{
		return Menus_CodeEditor_Errors_NoVirtualMemory::create();
	}

	Menus_CodeEditor_Errors_NoVirtualMemory::Menus_CodeEditor_Errors_NoVirtualMemory() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NoVirtualMemory::~Menus_CodeEditor_Errors_NoVirtualMemory()
	{
	}
