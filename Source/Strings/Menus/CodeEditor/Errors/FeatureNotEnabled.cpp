...
namespace Strings
{
	Menus_CodeEditor_Errors_FeatureNotEnabled* Menus_CodeEditor_Errors_FeatureNotEnabled::create()
	{
		Menus_CodeEditor_Errors_FeatureNotEnabled* instance = new Menus_CodeEditor_Errors_FeatureNotEnabled();
	...
	LocalizedString* Menus_CodeEditor_Errors_FeatureNotEnabled::clone()
	{
		return Menus_CodeEditor_Errors_FeatureNotEnabled::create();
	}

	Menus_CodeEditor_Errors_FeatureNotEnabled::Menus_CodeEditor_Errors_FeatureNotEnabled() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_FeatureNotEnabled::~Menus_CodeEditor_Errors_FeatureNotEnabled()
	{
	}
