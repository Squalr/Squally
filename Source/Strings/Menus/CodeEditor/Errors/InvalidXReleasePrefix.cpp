...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidXReleasePrefix* Menus_CodeEditor_Errors_InvalidXReleasePrefix::create()
	{
		Menus_CodeEditor_Errors_InvalidXReleasePrefix* instance = new Menus_CodeEditor_Errors_InvalidXReleasePrefix();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidXReleasePrefix::clone()
	{
		return Menus_CodeEditor_Errors_InvalidXReleasePrefix::create();
	}

	Menus_CodeEditor_Errors_InvalidXReleasePrefix::Menus_CodeEditor_Errors_InvalidXReleasePrefix() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidXReleasePrefix::~Menus_CodeEditor_Errors_InvalidXReleasePrefix()
	{
	}
