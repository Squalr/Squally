...
namespace Strings
{
	class Menus_CodeEditor_Errors_UnknownError : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_UnknownError* create();
	...
	private:
		Menus_CodeEditor_Errors_UnknownError();
		~Menus_CodeEditor_Errors_UnknownError();
	};
}
