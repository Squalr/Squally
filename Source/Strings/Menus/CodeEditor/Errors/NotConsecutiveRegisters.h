...
namespace Strings
{
	class Menus_CodeEditor_Errors_NotConsecutiveRegisters : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NotConsecutiveRegisters* create();
	...
	private:
		Menus_CodeEditor_Errors_NotConsecutiveRegisters();
		~Menus_CodeEditor_Errors_NotConsecutiveRegisters();
	};
}
