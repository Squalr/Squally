...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseOf8BitRegister : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseOf8BitRegister* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseOf8BitRegister();
		~Menus_CodeEditor_Errors_InvalidUseOf8BitRegister();
	};
}
