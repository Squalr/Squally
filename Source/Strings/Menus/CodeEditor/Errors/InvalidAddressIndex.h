...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidAddressIndex : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidAddressIndex* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidAddressIndex();
		~Menus_CodeEditor_Errors_InvalidAddressIndex();
	};
}
