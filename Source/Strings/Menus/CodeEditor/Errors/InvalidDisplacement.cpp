...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidDisplacement* Menus_CodeEditor_Errors_InvalidDisplacement::create()
	{
		Menus_CodeEditor_Errors_InvalidDisplacement* instance = new Menus_CodeEditor_Errors_InvalidDisplacement();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidDisplacement::clone()
	{
		return Menus_CodeEditor_Errors_InvalidDisplacement::create();
	}

	Menus_CodeEditor_Errors_InvalidDisplacement::Menus_CodeEditor_Errors_InvalidDisplacement() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidDisplacement::~Menus_CodeEditor_Errors_InvalidDisplacement()
	{
	}
