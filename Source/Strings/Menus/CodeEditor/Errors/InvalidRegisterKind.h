...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRegisterKind : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRegisterKind* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRegisterKind();
		~Menus_CodeEditor_Errors_InvalidRegisterKind();
	};
}
