...
namespace Strings
{
	class Menus_CodeEditor_Errors_LabelAlreadyDefined : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_LabelAlreadyDefined* create();
	...
	private:
		Menus_CodeEditor_Errors_LabelAlreadyDefined();
		~Menus_CodeEditor_Errors_LabelAlreadyDefined();
	};
}
