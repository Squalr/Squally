...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseOf80BitFloat : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseOf80BitFloat* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseOf80BitFloat();
		~Menus_CodeEditor_Errors_InvalidUseOf80BitFloat();
	};
}
