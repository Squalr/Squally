...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidAddress* Menus_CodeEditor_Errors_InvalidAddress::create()
	{
		Menus_CodeEditor_Errors_InvalidAddress* instance = new Menus_CodeEditor_Errors_InvalidAddress();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidAddress::clone()
	{
		return Menus_CodeEditor_Errors_InvalidAddress::create();
	}

	Menus_CodeEditor_Errors_InvalidAddress::Menus_CodeEditor_Errors_InvalidAddress() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidAddress::~Menus_CodeEditor_Errors_InvalidAddress()
	{
	}
