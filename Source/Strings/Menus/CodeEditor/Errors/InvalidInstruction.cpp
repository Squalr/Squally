...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidInstruction* Menus_CodeEditor_Errors_InvalidInstruction::create()
	{
		Menus_CodeEditor_Errors_InvalidInstruction* instance = new Menus_CodeEditor_Errors_InvalidInstruction();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidInstruction::clone()
	{
		return Menus_CodeEditor_Errors_InvalidInstruction::create();
	}

	Menus_CodeEditor_Errors_InvalidInstruction::Menus_CodeEditor_Errors_InvalidInstruction() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidInstruction::~Menus_CodeEditor_Errors_InvalidInstruction()
	{
	}
