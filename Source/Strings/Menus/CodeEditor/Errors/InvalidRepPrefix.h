...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidRepPrefix : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidRepPrefix* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidRepPrefix();
		~Menus_CodeEditor_Errors_InvalidRepPrefix();
	};
}
