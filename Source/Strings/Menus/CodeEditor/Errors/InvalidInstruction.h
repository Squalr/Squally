...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidInstruction : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidInstruction* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidInstruction();
		~Menus_CodeEditor_Errors_InvalidInstruction();
	};
}
