...
namespace Strings
{
	class Menus_CodeEditor_Errors_RelocationIndexOverflow : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_RelocationIndexOverflow* create();
	...
	private:
		Menus_CodeEditor_Errors_RelocationIndexOverflow();
		~Menus_CodeEditor_Errors_RelocationIndexOverflow();
	};
}
