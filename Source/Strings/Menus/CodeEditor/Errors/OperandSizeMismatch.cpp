...
namespace Strings
{
	Menus_CodeEditor_Errors_OperandSizeMismatch* Menus_CodeEditor_Errors_OperandSizeMismatch::create()
	{
		Menus_CodeEditor_Errors_OperandSizeMismatch* instance = new Menus_CodeEditor_Errors_OperandSizeMismatch();
	...
	LocalizedString* Menus_CodeEditor_Errors_OperandSizeMismatch::clone()
	{
		return Menus_CodeEditor_Errors_OperandSizeMismatch::create();
	}

	Menus_CodeEditor_Errors_OperandSizeMismatch::Menus_CodeEditor_Errors_OperandSizeMismatch() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_OperandSizeMismatch::~Menus_CodeEditor_Errors_OperandSizeMismatch()
	{
	}
