...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidParentLabel* Menus_CodeEditor_Errors_InvalidParentLabel::create()
	{
		Menus_CodeEditor_Errors_InvalidParentLabel* instance = new Menus_CodeEditor_Errors_InvalidParentLabel();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidParentLabel::clone()
	{
		return Menus_CodeEditor_Errors_InvalidParentLabel::create();
	}

	Menus_CodeEditor_Errors_InvalidParentLabel::Menus_CodeEditor_Errors_InvalidParentLabel() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidParentLabel::~Menus_CodeEditor_Errors_InvalidParentLabel()
	{
	}
