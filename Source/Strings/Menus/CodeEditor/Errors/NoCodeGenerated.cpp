...
namespace Strings
{
	Menus_CodeEditor_Errors_NoCodeGenerated* Menus_CodeEditor_Errors_NoCodeGenerated::create()
	{
		Menus_CodeEditor_Errors_NoCodeGenerated* instance = new Menus_CodeEditor_Errors_NoCodeGenerated();
	...
	LocalizedString* Menus_CodeEditor_Errors_NoCodeGenerated::clone()
	{
		return Menus_CodeEditor_Errors_NoCodeGenerated::create();
	}

	Menus_CodeEditor_Errors_NoCodeGenerated::Menus_CodeEditor_Errors_NoCodeGenerated() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_NoCodeGenerated::~Menus_CodeEditor_Errors_NoCodeGenerated()
	{
	}
