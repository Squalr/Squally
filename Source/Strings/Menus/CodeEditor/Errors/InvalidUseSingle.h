...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseSingle : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseSingle* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseSingle();
		~Menus_CodeEditor_Errors_InvalidUseSingle();
	};
}
