...
namespace Strings
{
	class Menus_CodeEditor_Errors_LabelAlreadyBound : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_LabelAlreadyBound* create();
	...
	private:
		Menus_CodeEditor_Errors_LabelAlreadyBound();
		~Menus_CodeEditor_Errors_LabelAlreadyBound();
	};
}
