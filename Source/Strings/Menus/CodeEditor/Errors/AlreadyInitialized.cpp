...
namespace Strings
{
	Menus_CodeEditor_Errors_AlreadyInitialized* Menus_CodeEditor_Errors_AlreadyInitialized::create()
	{
		Menus_CodeEditor_Errors_AlreadyInitialized* instance = new Menus_CodeEditor_Errors_AlreadyInitialized();
	...
	LocalizedString* Menus_CodeEditor_Errors_AlreadyInitialized::clone()
	{
		return Menus_CodeEditor_Errors_AlreadyInitialized::create();
	}

	Menus_CodeEditor_Errors_AlreadyInitialized::Menus_CodeEditor_Errors_AlreadyInitialized() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_AlreadyInitialized::~Menus_CodeEditor_Errors_AlreadyInitialized()
	{
	}
