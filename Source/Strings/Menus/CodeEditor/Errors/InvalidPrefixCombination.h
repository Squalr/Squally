...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidPrefixCombination : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidPrefixCombination* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidPrefixCombination();
		~Menus_CodeEditor_Errors_InvalidPrefixCombination();
	};
}
