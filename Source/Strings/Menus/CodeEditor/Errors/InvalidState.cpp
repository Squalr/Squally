...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidState* Menus_CodeEditor_Errors_InvalidState::create()
	{
		Menus_CodeEditor_Errors_InvalidState* instance = new Menus_CodeEditor_Errors_InvalidState();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidState::clone()
	{
		return Menus_CodeEditor_Errors_InvalidState::create();
	}

	Menus_CodeEditor_Errors_InvalidState::Menus_CodeEditor_Errors_InvalidState() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidState::~Menus_CodeEditor_Errors_InvalidState()
	{
	}
