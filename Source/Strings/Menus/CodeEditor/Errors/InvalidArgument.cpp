...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidArgument* Menus_CodeEditor_Errors_InvalidArgument::create()
	{
		Menus_CodeEditor_Errors_InvalidArgument* instance = new Menus_CodeEditor_Errors_InvalidArgument();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidArgument::clone()
	{
		return Menus_CodeEditor_Errors_InvalidArgument::create();
	}

	Menus_CodeEditor_Errors_InvalidArgument::Menus_CodeEditor_Errors_InvalidArgument() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidArgument::~Menus_CodeEditor_Errors_InvalidArgument()
	{
	}
