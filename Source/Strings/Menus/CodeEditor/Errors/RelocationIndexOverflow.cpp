...
namespace Strings
{
	Menus_CodeEditor_Errors_RelocationIndexOverflow* Menus_CodeEditor_Errors_RelocationIndexOverflow::create()
	{
		Menus_CodeEditor_Errors_RelocationIndexOverflow* instance = new Menus_CodeEditor_Errors_RelocationIndexOverflow();
	...
	LocalizedString* Menus_CodeEditor_Errors_RelocationIndexOverflow::clone()
	{
		return Menus_CodeEditor_Errors_RelocationIndexOverflow::create();
	}

	Menus_CodeEditor_Errors_RelocationIndexOverflow::Menus_CodeEditor_Errors_RelocationIndexOverflow() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_RelocationIndexOverflow::~Menus_CodeEditor_Errors_RelocationIndexOverflow()
	{
	}
