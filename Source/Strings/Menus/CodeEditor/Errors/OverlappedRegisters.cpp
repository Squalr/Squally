...
namespace Strings
{
	Menus_CodeEditor_Errors_OverlappedRegisters* Menus_CodeEditor_Errors_OverlappedRegisters::create()
	{
		Menus_CodeEditor_Errors_OverlappedRegisters* instance = new Menus_CodeEditor_Errors_OverlappedRegisters();
	...
	LocalizedString* Menus_CodeEditor_Errors_OverlappedRegisters::clone()
	{
		return Menus_CodeEditor_Errors_OverlappedRegisters::create();
	}

	Menus_CodeEditor_Errors_OverlappedRegisters::Menus_CodeEditor_Errors_OverlappedRegisters() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_OverlappedRegisters::~Menus_CodeEditor_Errors_OverlappedRegisters()
	{
	}

	std::string Menus_CodeEditor_Errors_OverlappedRegisters::getStringIdentifier()
	{
		return "Menus_CodeEditor_Errors_OverlappedRegisters";
	}
