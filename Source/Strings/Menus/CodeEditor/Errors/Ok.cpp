...
namespace Strings
{
	Menus_CodeEditor_Errors_Ok* Menus_CodeEditor_Errors_Ok::create()
	{
		Menus_CodeEditor_Errors_Ok* instance = new Menus_CodeEditor_Errors_Ok();
	...
	LocalizedString* Menus_CodeEditor_Errors_Ok::clone()
	{
		return Menus_CodeEditor_Errors_Ok::create();
	}

	Menus_CodeEditor_Errors_Ok::Menus_CodeEditor_Errors_Ok() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_Ok::~Menus_CodeEditor_Errors_Ok()
	{
	}
