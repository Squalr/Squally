...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidUseOf64BitAddress* Menus_CodeEditor_Errors_InvalidUseOf64BitAddress::create()
	{
		Menus_CodeEditor_Errors_InvalidUseOf64BitAddress* instance = new Menus_CodeEditor_Errors_InvalidUseOf64BitAddress();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidUseOf64BitAddress::clone()
	{
		return Menus_CodeEditor_Errors_InvalidUseOf64BitAddress::create();
	}

	Menus_CodeEditor_Errors_InvalidUseOf64BitAddress::Menus_CodeEditor_Errors_InvalidUseOf64BitAddress() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidUseOf64BitAddress::~Menus_CodeEditor_Errors_InvalidUseOf64BitAddress()
	{
	}
