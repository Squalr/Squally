...
namespace Strings
{
	class Menus_CodeEditor_Errors_LabelIndexOverflow : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_LabelIndexOverflow* create();
	...
	private:
		Menus_CodeEditor_Errors_LabelIndexOverflow();
		~Menus_CodeEditor_Errors_LabelIndexOverflow();
	};
}
