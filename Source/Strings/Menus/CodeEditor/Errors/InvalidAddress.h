...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidAddress : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidAddress* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidAddress();
		~Menus_CodeEditor_Errors_InvalidAddress();
	};
}
