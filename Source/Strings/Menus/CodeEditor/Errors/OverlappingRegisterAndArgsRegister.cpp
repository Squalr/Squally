...
namespace Strings
{
	Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister* Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister::create()
	{
		Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister* instance = new Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister();
	...
	LocalizedString* Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister::clone()
	{
		return Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister::create();
	}

	Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister::Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister::~Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister()
	{
	}
