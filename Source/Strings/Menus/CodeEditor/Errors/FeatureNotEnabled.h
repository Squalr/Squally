...
namespace Strings
{
	class Menus_CodeEditor_Errors_FeatureNotEnabled : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_FeatureNotEnabled* create();
	...
	private:
		Menus_CodeEditor_Errors_FeatureNotEnabled();
		~Menus_CodeEditor_Errors_FeatureNotEnabled();
	};
}
