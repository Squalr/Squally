...
namespace Strings
{
	class Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister* create();
	...
	private:
		Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister();
		~Menus_CodeEditor_Errors_OverlappingRegisterAndArgsRegister();
	};
}
