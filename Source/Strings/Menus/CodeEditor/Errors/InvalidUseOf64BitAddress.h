...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidUseOf64BitAddress : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidUseOf64BitAddress* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidUseOf64BitAddress();
		~Menus_CodeEditor_Errors_InvalidUseOf64BitAddress();
	};
}
