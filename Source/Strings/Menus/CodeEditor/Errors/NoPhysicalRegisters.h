...
namespace Strings
{
	class Menus_CodeEditor_Errors_NoPhysicalRegisters : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NoPhysicalRegisters* create();
	...
	private:
		Menus_CodeEditor_Errors_NoPhysicalRegisters();
		~Menus_CodeEditor_Errors_NoPhysicalRegisters();
	};
}
