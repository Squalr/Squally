...
namespace Strings
{
	class Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent* create();
	...
	private:
		Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent();
		~Menus_CodeEditor_Errors_NonLocalLabelCantHaveParent();
	};
}
