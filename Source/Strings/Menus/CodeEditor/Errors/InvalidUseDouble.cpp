...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidUseDouble* Menus_CodeEditor_Errors_InvalidUseDouble::create()
	{
		Menus_CodeEditor_Errors_InvalidUseDouble* instance = new Menus_CodeEditor_Errors_InvalidUseDouble();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidUseDouble::clone()
	{
		return Menus_CodeEditor_Errors_InvalidUseDouble::create();
	}

	Menus_CodeEditor_Errors_InvalidUseDouble::Menus_CodeEditor_Errors_InvalidUseDouble() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidUseDouble::~Menus_CodeEditor_Errors_InvalidUseDouble()
	{
	}
