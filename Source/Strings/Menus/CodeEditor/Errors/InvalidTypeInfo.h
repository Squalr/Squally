...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidTypeInfo : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidTypeInfo* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidTypeInfo();
		~Menus_CodeEditor_Errors_InvalidTypeInfo();
	};
}
