...
namespace Strings
{
	class Menus_CodeEditor_Errors_InvalidAddressScale : public LocalizedString
	{
	public:
		static Menus_CodeEditor_Errors_InvalidAddressScale* create();
	...
	private:
		Menus_CodeEditor_Errors_InvalidAddressScale();
		~Menus_CodeEditor_Errors_InvalidAddressScale();
	};
}
