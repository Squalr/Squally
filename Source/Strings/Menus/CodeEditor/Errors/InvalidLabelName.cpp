...
namespace Strings
{
	Menus_CodeEditor_Errors_InvalidLabelName* Menus_CodeEditor_Errors_InvalidLabelName::create()
	{
		Menus_CodeEditor_Errors_InvalidLabelName* instance = new Menus_CodeEditor_Errors_InvalidLabelName();
	...
	LocalizedString* Menus_CodeEditor_Errors_InvalidLabelName::clone()
	{
		return Menus_CodeEditor_Errors_InvalidLabelName::create();
	}

	Menus_CodeEditor_Errors_InvalidLabelName::Menus_CodeEditor_Errors_InvalidLabelName() : LocalizedString()
	{
	}

	Menus_CodeEditor_Errors_InvalidLabelName::~Menus_CodeEditor_Errors_InvalidLabelName()
	{
	}
