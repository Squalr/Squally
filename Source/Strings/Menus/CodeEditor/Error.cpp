...
namespace Strings
{
	Menus_CodeEditor_Error* Menus_CodeEditor_Error::create()
	{
		Menus_CodeEditor_Error* instance = new Menus_CodeEditor_Error();
	...
	LocalizedString* Menus_CodeEditor_Error::clone()
	{
		return Menus_CodeEditor_Error::create();
	}

	Menus_CodeEditor_Error::Menus_CodeEditor_Error() : LocalizedString()
	{
	}

	Menus_CodeEditor_Error::~Menus_CodeEditor_Error()
	{
	}

	std::string Menus_CodeEditor_Error::getStringIdentifier()
	{
		return "Menus_CodeEditor_Error";
	}
