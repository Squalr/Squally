...
namespace Strings
{
	Menus_CodeEditor_ByteCount* Menus_CodeEditor_ByteCount::create()
	{
		Menus_CodeEditor_ByteCount* instance = new Menus_CodeEditor_ByteCount();
	...
	LocalizedString* Menus_CodeEditor_ByteCount::clone()
	{
		return Menus_CodeEditor_ByteCount::create();
	}

	Menus_CodeEditor_ByteCount::Menus_CodeEditor_ByteCount() : LocalizedString()
	{
	}

	Menus_CodeEditor_ByteCount::~Menus_CodeEditor_ByteCount()
	{
	}

	std::string Menus_CodeEditor_ByteCount::getStringIdentifier()
	{
		return "Menus_CodeEditor_ByteCount";
	}
