...
{
	ClickToEdit* ClickToEdit::create()
	{
		ClickToEdit* instance = new ClickToEdit();
	...
	LocalizedString* ClickToEdit::clone()
	{
		return ClickToEdit::create();
	}

	ClickToEdit::ClickToEdit() : LocalizedString()
	{
	}
