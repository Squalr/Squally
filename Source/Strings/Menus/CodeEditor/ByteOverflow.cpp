...
#include "ByteOverflow.h"

namespace Strings
{
	Menus_CodeEditor_ByteOverflow* Menus_CodeEditor_ByteOverflow::create()
	{
		Menus_CodeEditor_ByteOverflow* instance = new Menus_CodeEditor_ByteOverflow();
	...
	LocalizedString* Menus_CodeEditor_ByteOverflow::clone()
	{
		return Menus_CodeEditor_ByteOverflow::create();
	}

	Menus_CodeEditor_ByteOverflow::Menus_CodeEditor_ByteOverflow() : LocalizedString()
	{
	}

	Menus_CodeEditor_ByteOverflow::~Menus_CodeEditor_ByteOverflow()
	{
	}
