...
namespace Strings
{
	Menus_CodeEditor_Bytes* Menus_CodeEditor_Bytes::create()
	{
		Menus_CodeEditor_Bytes* instance = new Menus_CodeEditor_Bytes();
	...
	LocalizedString* Menus_CodeEditor_Bytes::clone()
	{
		return Menus_CodeEditor_Bytes::create();
	}

	Menus_CodeEditor_Bytes::Menus_CodeEditor_Bytes() : LocalizedString()
	{
	}

	Menus_CodeEditor_Bytes::~Menus_CodeEditor_Bytes()
	{
	}
