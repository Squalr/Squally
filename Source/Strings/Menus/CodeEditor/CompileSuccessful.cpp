...
namespace Strings
{
	Menus_CodeEditor_CompileSuccessful* Menus_CodeEditor_CompileSuccessful::create()
	{
		Menus_CodeEditor_CompileSuccessful* instance = new Menus_CodeEditor_CompileSuccessful();
	...
	LocalizedString* Menus_CodeEditor_CompileSuccessful::clone()
	{
		return Menus_CodeEditor_CompileSuccessful::create();
	}

	Menus_CodeEditor_CompileSuccessful::Menus_CodeEditor_CompileSuccessful() : LocalizedString()
	{
	}

	Menus_CodeEditor_CompileSuccessful::~Menus_CodeEditor_CompileSuccessful()
	{
	}
