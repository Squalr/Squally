...
namespace Strings
{
	Menus_CodeEditor_UnfilledBytes* Menus_CodeEditor_UnfilledBytes::create()
	{
		Menus_CodeEditor_UnfilledBytes* instance = new Menus_CodeEditor_UnfilledBytes();
	...
	LocalizedString* Menus_CodeEditor_UnfilledBytes::clone()
	{
		return Menus_CodeEditor_UnfilledBytes::create();
	}

	Menus_CodeEditor_UnfilledBytes::Menus_CodeEditor_UnfilledBytes() : LocalizedString()
	{
	}

	Menus_CodeEditor_UnfilledBytes::~Menus_CodeEditor_UnfilledBytes()
	{
	}
