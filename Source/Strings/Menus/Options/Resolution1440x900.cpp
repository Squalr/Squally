...
namespace Strings
{
	...
	{
		LocalizedString* clonedString = Menus_Options_Resolution1440x900::create();
	...
	std::string Menus_Options_Resolution1440x900::getStringIdentifier()
	{
		return "Menus_Options_Resolution1440x900";
	}
