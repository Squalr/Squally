...
namespace Strings
{
	...
	{
		LocalizedString* clonedString = Menus_Options_Resolution3840x2160::create();
	...
	std::string Menus_Options_Resolution3840x2160::getStringIdentifier()
	{
		return "Menus_Options_Resolution3840x2160";
	}
