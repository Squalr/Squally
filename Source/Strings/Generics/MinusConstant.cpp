...
#include "MinusConstant.h"

namespace Strings
{
	Generics_MinusConstant* Generics_MinusConstant::create()
	{
		Generics_MinusConstant* instance = new Generics_MinusConstant();
	...
	LocalizedString* Generics_MinusConstant::clone()
	{
		LocalizedString* clonedString = Generics_MinusConstant::create();
	...
	Generics_MinusConstant::Generics_MinusConstant() : LocalizedString()
	{
	}

	Generics_MinusConstant::~Generics_MinusConstant()
	{
	}
