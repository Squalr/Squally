...
#include "TimesConstant.h"

namespace Strings
{
	Generics_TimesConstant* Generics_TimesConstant::create()
	{
		Generics_TimesConstant* instance = new Generics_TimesConstant();
	...
	LocalizedString* Generics_TimesConstant::clone()
	{
		LocalizedString* clonedString = Generics_TimesConstant::create();
	...
	Generics_TimesConstant::Generics_TimesConstant() : LocalizedString()
	{
	}

	Generics_TimesConstant::~Generics_TimesConstant()
	{
	}
