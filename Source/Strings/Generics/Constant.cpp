...
namespace Strings
{
	Generics_Constant* Generics_Constant::create()
	{
		Generics_Constant* instance = new Generics_Constant();
	...
	Generics_Constant::~Generics_Constant()
	{
	}

	std::string Generics_Constant::getStringIdentifier()
	{
		return "Generics_Constant";
	}
