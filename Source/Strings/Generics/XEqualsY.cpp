...
namespace Strings
{
	Generics_XEqualsY* Generics_XEqualsY::create()
	{
		Generics_XEqualsY* instance = new Generics_XEqualsY();
	...
	Generics_XEqualsY::~Generics_XEqualsY()
	{
	}

	std::string Generics_XEqualsY::getStringIdentifier()
	{
		return "Generics_XEqualsY";
	}
