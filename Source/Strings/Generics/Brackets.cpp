...
namespace Strings
{
	Generics_Brackets* Generics_Brackets::create()
	{
		Generics_Brackets* instance = new Generics_Brackets();
	...
	Generics_Brackets::~Generics_Brackets()
	{
	}

	std::string Generics_Brackets::getStringIdentifier()
	{
		return "Generics_Brackets";
	}
