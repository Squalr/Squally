...
namespace Strings
{
	class Dialogue_Story_Intro_HackerModeCombat : public LocalizedString
	{
	public:
		static Dialogue_Story_Intro_HackerModeCombat* create();
	...
	private:
		Dialogue_Story_Intro_HackerModeCombat();
		~Dialogue_Story_Intro_HackerModeCombat();
	};
}
