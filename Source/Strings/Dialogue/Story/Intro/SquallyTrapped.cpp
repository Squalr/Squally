...
namespace Strings
{
	Dialogue_Story_Intro_SquallyTrapped* Dialogue_Story_Intro_SquallyTrapped::create()
	{
		Dialogue_Story_Intro_SquallyTrapped* instance = new Dialogue_Story_Intro_SquallyTrapped();
	...
	LocalizedString* Dialogue_Story_Intro_SquallyTrapped::clone()
	{
		LocalizedString* clonedString = Dialogue_Story_Intro_SquallyTrapped::create();
	...
	Dialogue_Story_Intro_SquallyTrapped::Dialogue_Story_Intro_SquallyTrapped() : LocalizedString()
	{
	}

	Dialogue_Story_Intro_SquallyTrapped::~Dialogue_Story_Intro_SquallyTrapped()
	{
	}

	std::string Dialogue_Story_Intro_SquallyTrapped::getStringIdentifier()
	{
		return "Dialogue_Story_Intro_SquallyTrapped";
	}
