...
namespace Strings
{
	class Dialogue_Enemies_BattleCries_DieMortal : public LocalizedString
	{
	public:
		static Dialogue_Enemies_BattleCries_DieMortal* create();
	...
	private:
		Dialogue_Enemies_BattleCries_DieMortal();
		~Dialogue_Enemies_BattleCries_DieMortal();
	};
}
