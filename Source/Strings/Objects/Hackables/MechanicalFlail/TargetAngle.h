...
namespace Strings
{
	class Objects_Hackables_MechanicalFlail_TargetAngle : public LocalizedString
	{
	public:
		static Objects_Hackables_MechanicalFlail_TargetAngle* create();
	...
	private:
		Objects_Hackables_MechanicalFlail_TargetAngle();
		~Objects_Hackables_MechanicalFlail_TargetAngle();
	};
}
