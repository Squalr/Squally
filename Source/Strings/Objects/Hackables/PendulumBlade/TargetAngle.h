...
namespace Strings
{
	class Objects_Hackables_PendulumBlade_TargetAngle : public LocalizedString
	{
	public:
		static Objects_Hackables_PendulumBlade_TargetAngle* create();
	...
	private:
		Objects_Hackables_PendulumBlade_TargetAngle();
		~Objects_Hackables_PendulumBlade_TargetAngle();
	};
}
