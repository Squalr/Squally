...
PlatformerAttachedBehaviorDeserializer::PlatformerAttachedBehaviorDeserializer() : super()
{
	...
	this->attachedBehaviorDeserializers[EntityRunBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)EntityRunBehavior::create(owner); };
	this->attachedBehaviorDeserializers[DispelIllusionBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)DispelIllusionBehavior::create(owner); };
	...
	this->attachedBehaviorDeserializers[IllusionBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)IllusionBehavior::create(owner); };
	this->attachedBehaviorDeserializers[IncrementHealthFlaskTutorialBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)IncrementHealthFlaskTutorialBehavior::create(owner); };
	...
	this->attachedBehaviorDeserializers[MageCastBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)MageCastBehavior::create(owner); };
	...
	this->attachedBehaviorDeserializers[TrainingHealTutorialBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)TrainingHealTutorialBehavior::create(owner); };
	
	/*********************
	    Transportation
	*********************/
	this->attachedBehaviorDeserializers[EFURTransportationBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)EFURTransportationBehavior::create(owner); };
	...
	*********************/
	...
	// Endian forest
	this->attachedBehaviorDeserializers[AraBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)AraBehavior::create(owner); };
