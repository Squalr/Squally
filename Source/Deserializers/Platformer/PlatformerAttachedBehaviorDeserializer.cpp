...
PlatformerAttachedBehaviorDeserializer::PlatformerAttachedBehaviorDeserializer() : super()
{
	...
	this->attachedBehaviorDeserializers[NpcNoCollisionBehaviorGroup::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)NpcNoCollisionBehaviorGroup::create(owner); };
	...
	// this->attachedBehaviorDeserializers[ScrappyCombatBehavior::MapKeyAttachedBehavior] = [=](GameObject* owner) { return (AttachedBehavior*)ScrappyCombatBehavior::create(owner); };
