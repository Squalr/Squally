...
const Color4B MiniMapObjectDeserializer::WarpColor = Color4B(160, 11, 11, 255);
...
const Color4B MiniMapObjectDeserializer::InteractableColor = Color4B(76, 121, 166, 255);
const Color4B MiniMapObjectDeserializer::ShrineColor = Color4B(122, 163, 0, 255);
...
MiniMapObjectDeserializer::MiniMapObjectDeserializer() : super(MiniMapObjectDeserializer::MapKeyTypeObject)
{
	...
	this->deserializers[AncientAnvil::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties); };
	...
	this->deserializers[Brazier::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties, MiniMapObjectDeserializer::InteractableColor); };
	...
	this->deserializers[HelpTotemColdWater::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties); };
	...
	this->deserializers[LifeStone::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties, MiniMapObjectDeserializer::ShrineColor); };
	...
	this->deserializers[PerceptronUnarmored::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties); };
	...
	this->deserializers[SpikedLogRailed::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties); };
	...
	this->deserializers[Switch::MapKey] = [=](ValueMap properties) { return (GameObject*)MiniMapObject::create(properties, MiniMapObjectDeserializer::InteractableColor); };
