...
PlatformerComponentDeserializer::PlatformerComponentDeserializer() : super()
{
	...
	this->componentDeserializers[EntityKillableBehavior::MapKey] = [=](GameObject* owner) { return (GameComponent*)EntityKillableBehavior::create(owner); };
	...
	*********************/
	...
	this->componentDeserializers[GrampsBehavior::MapKey] = [=](GameObject* owner) { return (GameComponent*)GrampsBehavior::create(owner); };
	...
	// DM
	this->componentDeserializers[BurchBehavior::MapKey] = [=](GameObject* owner) { return (GameComponent*)BurchBehavior::create(owner); };
	...
	this->componentDeserializers[GarinBehavior::MapKey] = [=](GameObject* owner) { return (GameComponent*)GarinBehavior::create(owner); };
