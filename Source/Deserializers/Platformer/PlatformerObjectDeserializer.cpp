...
PlatformerObjectDeserializer::PlatformerObjectDeserializer() : super(PlatformerObjectDeserializer::MapKeyTypeObject, { (PropertyDeserializer*)PlatformerAttachedBehaviorDeserializer::create(), (PropertyDeserializer*)PlatformerQuestDeserializer::create() })
{
	...
	this->deserializers[AlchemyLab::MapKeyAlchemyLab] = [=](ValueMap properties) { return (GameObject*)AlchemyLab::create(properties); };
	...
	this->deserializers[FireLauncherSqualr::MapKeyFireLauncherSqualr] = [=](ValueMap properties) { return (GameObject*)FireLauncherSqualr::create(properties); };
	...
	this->deserializers[MetalChest::MapKeyMetalChest] = [=](ValueMap properties) { return (GameObject*)MetalChest::create(properties); };
	...
	this->deserializers[Torch::MapKeyTorch] = [=](ValueMap properties) { return (GameObject*)Torch::create(properties); };
	...
	this->deserializers[Vase::MapKeyVase] = [=](ValueMap properties) { return (GameObject*)Vase::create(properties); };
