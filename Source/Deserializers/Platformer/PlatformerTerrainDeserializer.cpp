...
PlatformerTerrainDeserializer::PlatformerTerrainDeserializer() : super(PlatformerTerrainDeserializer::MapKeyTypeTerrain)
{
	...
	this->deserializers[LavaTerrain::MapKeyTerrainTypeLava] = [=](ValueMap properties) { return (GameObject*)LavaTerrain::create(properties); };
	this->deserializers[LeafTerrain::MapKeyTerrainTypeLeaf] = [=](ValueMap properties) { return (GameObject*)LeafTerrain::create(properties); };
	this->deserializers[MarbleDarkTerrain::MapKeyTerrainTypeMarbleDark] = [=](ValueMap properties) { return (GameObject*)MarbleDarkTerrain::create(properties); };
	...
	this->deserializers[ShipAltTerrain::MapKeyTerrainTypeShipAlt] = [=](ValueMap properties) { return (GameObject*)ShipAltTerrain::create(properties); };
	this->deserializers[ShipTerrain::MapKeyTerrainTypeShip] = [=](ValueMap properties) { return (GameObject*)ShipTerrain::create(properties); };
	this->deserializers[TempleTerrain::MapKeyTerrainTypeTemple] = [=](ValueMap properties) { return (GameObject*)TempleTerrain::create(properties); };
