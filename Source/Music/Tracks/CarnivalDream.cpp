...
CarnivalDream::CarnivalDream(cocos2d::ValueMap& properties) : super(properties, MusicResources::CarnivalDream, Strings::Menus_TODO::create(), Strings::Menus_TODO::create())
{
}
