...
void DisplayModeToggles::initializePositions()
{
	...
	this->toggleButtonBin->setPosition(Vec2(visibleSize.width / 2.0f + Config::LeftColumnCenter + -518.0f + 64.0f * 0.0f, visibleSize.height / 2.0f - 432.0f));
	this->toggleButtonDec->setPosition(Vec2(visibleSize.width / 2.0f + Config::LeftColumnCenter + -518.0f + 64.0f * 1.0f, visibleSize.height / 2.0f - 432.0f));
	this->toggleButtonHex->setPosition(Vec2(visibleSize.width / 2.0f + Config::LeftColumnCenter + -518.0f + 64.0f * 2.0f, visibleSize.height / 2.0f - 432.0f));
	this->toggleButtonAscii->setPosition(Vec2(visibleSize.width / 2.0f + Config::LeftColumnCenter + -518.0f + 64.0f * 3.0f, visibleSize.height / 2.0f - 432.0f));
}
