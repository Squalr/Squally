#include "HexusOpponentKnight.h"

const std::string HexusOpponentKnight::StringKeyOpponentName = "Squally_Npc_Names_Kickstarter_Knight";
HexusOpponentKnight* HexusOpponentKnight::instance = nullptr;

HexusOpponentKnight* HexusOpponentKnight::getInstance()
{
	if (HexusOpponentKnight::instance == nullptr)
	{
		HexusOpponentKnight::instance = new HexusOpponentKnight();
	}

	return HexusOpponentKnight::instance;
}
...
HexusOpponentKnight::HexusOpponentKnight() : HexusOpponentData(
	...
	Vec2(0.0f, -96.0f),
	Vec2(0.0f, 0.0f),
	HexusOpponentKnight::StringKeyOpponentName,
...
HexusOpponentKnight::~HexusOpponentKnight()
{
}
