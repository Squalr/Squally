#include "HexusOpponentEgyptianMummy.h"

const std::string HexusOpponentEgyptianMummy::StringKeyOpponentName = "Squally_Npc_Names_Egyptian_Mummy";
HexusOpponentEgyptianMummy* HexusOpponentEgyptianMummy::instance = nullptr;

HexusOpponentEgyptianMummy* HexusOpponentEgyptianMummy::getInstance()
{
	if (HexusOpponentEgyptianMummy::instance == nullptr)
	{
		HexusOpponentEgyptianMummy::instance = new HexusOpponentEgyptianMummy();
	}

	return HexusOpponentEgyptianMummy::instance;
}

HexusOpponentEgyptianMummy::HexusOpponentEgyptianMummy() : HexusOpponentData(
...
HexusOpponentEgyptianMummy::~HexusOpponentEgyptianMummy()
{
}
