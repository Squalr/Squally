#include "HexusOpponentOrcKing.h"

const std::string HexusOpponentOrcKing::StringKeyOpponentName = "Squally_Npc_Names_Orc_King";
HexusOpponentOrcKing* HexusOpponentOrcKing::instance = nullptr;

HexusOpponentOrcKing* HexusOpponentOrcKing::getInstance()
{
	if (HexusOpponentOrcKing::instance == nullptr)
	{
		HexusOpponentOrcKing::instance = new HexusOpponentOrcKing();
	}

	return HexusOpponentOrcKing::instance;
}
...
HexusOpponentOrcKing::~HexusOpponentOrcKing()
{
}
