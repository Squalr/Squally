#include "HexusOpponentEgyptianGoddess.h"

const std::string HexusOpponentEgyptianGoddess::StringKeyOpponentName = "Squally_Npc_Names_Egyptian_Goddess";
HexusOpponentEgyptianGoddess* HexusOpponentEgyptianGoddess::instance = nullptr;

HexusOpponentEgyptianGoddess* HexusOpponentEgyptianGoddess::getInstance()
{
	if (HexusOpponentEgyptianGoddess::instance == nullptr)
	{
		HexusOpponentEgyptianGoddess::instance = new HexusOpponentEgyptianGoddess();
	}

	return HexusOpponentEgyptianGoddess::instance;
}
...
HexusOpponentEgyptianGoddess::~HexusOpponentEgyptianGoddess()
{
}
