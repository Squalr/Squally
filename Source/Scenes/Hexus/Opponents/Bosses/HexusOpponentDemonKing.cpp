#include "HexusOpponentDemonKing.h"

const std::string HexusOpponentDemonKing::StringKeyOpponentName = "Squally_Npc_Names_Demon_King";
HexusOpponentDemonKing* HexusOpponentDemonKing::instance = nullptr;

HexusOpponentDemonKing* HexusOpponentDemonKing::getInstance()
{
	if (HexusOpponentDemonKing::instance == nullptr)
	{
		HexusOpponentDemonKing::instance = new HexusOpponentDemonKing();
	}

	return HexusOpponentDemonKing::instance;
}
...
HexusOpponentDemonKing::HexusOpponentDemonKing() : HexusOpponentData(
	...
	Vec2(0.0f, -48.0f),
	Vec2(0.0f, 0.0f),
	HexusOpponentDemonKing::StringKeyOpponentName,
...
HexusOpponentDemonKing::~HexusOpponentDemonKing()
{
}
