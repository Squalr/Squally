...
HandCardCountDisplay::HandCardCountDisplay()
{
	...
	this->playerHandCardCountText = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H1, Strings::Common_Constant::create());
	...
	this->enemyHandCardCountText = LocalizedLabel::create(LocalizedLabel::FontStyle::Coding, LocalizedLabel::FontSize::H1, Strings::Common_Constant::create());
...
void HandCardCountDisplay::initializePositions()
{
	...
	this->playerHandCardCountText->setPosition(visibleSize.width / 2.0f + Config::leftColumnCenter + Config::handCountOffsetX - 24.0f + 4.0f, visibleSize.height / 2.0f - Config::handCountOffsetY + 2.0f);
	...
	this->enemyHandCardCountText->setPosition(visibleSize.width / 2.0f + Config::leftColumnCenter + Config::handCountOffsetX - 24.0f + 4.0f, visibleSize.height / 2.0f + Config::handCountOffsetY + 32.0f + 2.0f);
}
