...
SarudeTutorialIntroSequence::SarudeTutorialIntroSequence() : super(GameState::StateType::RoundStart)
{
	...
	this->lossDisplayTutorialLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Main, LocalizedLabel::FontSize::P, Strings::Hexus_Tutorials_Sarude_RealMatch::create(), CSize(420.0f, 0.0f));
