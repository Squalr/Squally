...
TutorialCIntroSequence::TutorialCIntroSequence() : TutorialBase(StateOverride::TutorialMode::TutorialC, GameState::StateType::Neutral)
{
	...
	this->scoreTotalsTutorialLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Main, LocalizedLabel::FontSize::P, Strings::OpponentLead::create(), Size(420.0f, 0.0f));
	this->handCardsTutorialLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Main, LocalizedLabel::FontSize::P, Strings::NotEnoughToWin::create(), Size(640.0f, 0.0f), TextHAlignment::CENTER);
	this->lastStandTutorialLabel = LocalizedLabel::create(LocalizedLabel::FontStyle::Main, LocalizedLabel::FontSize::P, Strings::UseSurrender::create(), Size(640.0f, 0.0f), TextHAlignment::CENTER);
