#include "StateSacrificeStaged.h"

StateSacrificeStaged* StateSacrificeStaged::create()
{
	StateSacrificeStaged* instance = new StateSacrificeStaged();
...
StateSacrificeStaged::StateSacrificeStaged() : StateBase(GameState::StateType::ControlSacrificeStaged)
{
	this->sacrificeStatus = Label::create("", Localization::getMainFont(), 28.0f);
...
void StateSacrificeStaged::initializePositions()
{
...
void StateSacrificeStaged::initializeCallbacks(GameState* gameState)
{
	this->cancelButton->setClickCallback(CC_CALLBACK_1(StateSacrificeStaged::onSacrificeCancel, this));

	gameState->playerHand->setMouseClickCallback(CC_CALLBACK_1(StateSacrificeStaged::selectCard, this));
	gameState->enemyHand->setMouseClickCallback(CC_CALLBACK_1(StateSacrificeStaged::selectCard, this));

	gameState->playerBinaryCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
	gameState->playerDecimalCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
	gameState->playerHexCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
	gameState->enemyBinaryCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
	gameState->enemyDecimalCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
	gameState->enemyHexCards->enableRowCardSelection(CC_CALLBACK_1(StateSacrificeStaged::stageSacrificeTarget, this));
...
void StateSacrificeStaged::aiPerformAction(GameState* gameState)
{

}

void StateSacrificeStaged::selectCard(Card* card)
{
...
void StateSacrificeStaged::stageSacrificeTarget(Card* card)
{
...
void StateSacrificeStaged::onSacrificeCancel(MenuSprite* menuSprite)
{
...
void StateSacrificeStaged::updateSacrificeStatus()
{
