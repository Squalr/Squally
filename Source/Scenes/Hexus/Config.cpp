...
const float Config::coinFlipDownDuration = 1.25f;
...
const float Config::cardTotalOffsetX = -525.0f;
...
const float Config::deckCardCountOffsetY = 80.0f;
const float Config::handOffsetY = 472.0f;
const float Config::handCountOffsetX = 132.0f;
const float Config::handCountOffsetY = 196.0f;
...
const float Config::passButtonOffsetY = -432.0f;
const float Config::playerPassIndicatorOffsetX = 120.0f;
const float Config::playerPassIndicatorOffsetY = -282.0f;
const float Config::enemyPassIndicatorOffsetX = 120.0f;
const float Config::enemyPassIndicatorOffsetY = 432.0f;
const float Config::passIndicatorFadeSpeed = 0.25f;
const float Config::socketOffsetY = 78.0f;
const float Config::socketAOffsetX = -136.0f;
