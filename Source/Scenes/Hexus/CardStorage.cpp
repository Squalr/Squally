...
CardStorage::CardStorage()
{
	...
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal0));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal1));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal2));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal3));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal3));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal3));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal4));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal4));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Decimal5));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex0));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex1));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex2));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex3));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex4));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Hex5));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Addition));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Addition));
	this->defaultCards.push_back(CardList::getInstance()->cardListByName->at(CardList::Addition));
}
