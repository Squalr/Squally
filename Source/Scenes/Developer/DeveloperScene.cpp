...
DeveloperScene::DeveloperScene()
{
	...
	this->chapterList.push_back(this->buildDebugButton("==========", ""));
	this->chapterList.push_back(this->buildDebugButton("Alch (DM)", MapResources::DataMines_Town_Alch));
	this->chapterList.push_back(this->buildDebugButton("Inn (DM)", MapResources::DataMines_Town_Inn));
	this->chapterList.push_back(this->buildDebugButton("Smith (DM)", MapResources::DataMines_Town_Smith));
	this->chapterList.push_back(this->buildDebugButton("Town (DM)", MapResources::DataMines_Town_Main));
	this->chapterList.push_back(this->buildDebugButton("Zone_4_3 (DM)", MapResources::DataMines_Zone_4_3));
	this->chapterList.push_back(this->buildDebugButton("Zone_4_2 (DM)", MapResources::DataMines_Zone_4_2));
	this->chapterList.push_back(this->buildDebugButton("Zone_4_1 (DM)", MapResources::DataMines_Zone_4_1));
	this->chapterList.push_back(this->buildDebugButton("Zone_4_0 (DM)", MapResources::DataMines_Zone_4_0));
	this->chapterList.push_back(this->buildDebugButton("Zone_3_3 (DM)", MapResources::DataMines_Zone_3_3));
	this->chapterList.push_back(this->buildDebugButton("Zone_3_2 (DM)", MapResources::DataMines_Zone_3_2));
	this->chapterList.push_back(this->buildDebugButton("Zone_3_1 (DM)", MapResources::DataMines_Zone_3_1));
	this->chapterList.push_back(this->buildDebugButton("Zone_3_0 (DM)", MapResources::DataMines_Zone_3_0));
	this->chapterList.push_back(this->buildDebugButton("Zone_2_3 (DM)", MapResources::DataMines_Zone_2_3));
	this->chapterList.push_back(this->buildDebugButton("Zone_2_2 (DM)", MapResources::DataMines_Zone_2_2));
	this->chapterList.push_back(this->buildDebugButton("Zone_2_1 (DM)", MapResources::DataMines_Zone_2_1));
	this->chapterList.push_back(this->buildDebugButton("Zone_2_0 (DM)", MapResources::DataMines_Zone_2_0));
	...
	this->chapterList.push_back(this->buildDebugButton("Smith (DEV) (UR)", MapResources::UnderflowRuins_Town_Smith_Questless));
	this->chapterList.push_back(this->buildDebugButton("Alch (UR)", MapResources::UnderflowRuins_Town_Alch));
	this->chapterList.push_back(this->buildDebugButton("Alch (DEV) (UR)", MapResources::UnderflowRuins_Town_Alch_Questless));
