...
DeveloperScene::DeveloperScene()
{
	...
	this->chapterList.push_back(this->buildDebugButton("Zone_2_2 (DM)", MapResources::DataMines_Zone_2_1));
	this->chapterList.push_back(this->buildDebugButton("Zone_2_1 (DM)", MapResources::DataMines_Zone_2_2));
