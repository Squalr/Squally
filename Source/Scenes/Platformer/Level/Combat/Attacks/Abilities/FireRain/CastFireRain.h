...
class CastFireRain : public PlatformerAttack
{
public:
	static CastFireRain* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastFireRain(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastFireRain();
