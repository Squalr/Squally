...
class CastInnerFire : public PlatformerAttack
{
public:
	static CastInnerFire* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastInnerFire(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastInnerFire();
