...
class CastUndying : public PlatformerAttack
{
public:
	static CastUndying* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastUndying(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastUndying();
