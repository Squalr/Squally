...
class CastThickHide : public PlatformerAttack
{
public:
	static CastThickHide* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastThickHide(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastThickHide();
