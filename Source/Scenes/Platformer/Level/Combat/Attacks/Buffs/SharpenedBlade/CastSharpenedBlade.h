...
class CastSharpenedBlade : public PlatformerAttack
{
public:
	static CastSharpenedBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastSharpenedBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastSharpenedBlade();
