...
class CastParry : public PlatformerAttack
{
public:
	static CastParry* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastParry(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastParry();
