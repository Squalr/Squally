...
class CastCauterize : public PlatformerAttack
{
public:
	static CastCauterize* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastCauterize(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastCauterize();
