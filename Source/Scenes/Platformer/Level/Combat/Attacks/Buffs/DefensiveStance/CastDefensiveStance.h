...
class CastDefensiveStance : public PlatformerAttack
{
public:
	static CastDefensiveStance* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastDefensiveStance(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastDefensiveStance();
