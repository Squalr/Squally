...
class CastManifest : public PlatformerAttack
{
public:
	static CastManifest* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastManifest(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastManifest();
