...
class CastEnchantedBlade : public PlatformerAttack
{
public:
	static CastEnchantedBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastEnchantedBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastEnchantedBlade();
