...
class CastScaldingBlade : public PlatformerAttack
{
public:
	static CastScaldingBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastScaldingBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastScaldingBlade();
