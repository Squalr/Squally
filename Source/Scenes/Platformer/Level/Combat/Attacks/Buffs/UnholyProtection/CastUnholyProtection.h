...
class CastUnholyProtection : public PlatformerAttack
{
public:
	static CastUnholyProtection* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastUnholyProtection(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastUnholyProtection();
