...
class CastSeekingBlade : public PlatformerAttack
{
public:
	static CastSeekingBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastSeekingBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastSeekingBlade();
