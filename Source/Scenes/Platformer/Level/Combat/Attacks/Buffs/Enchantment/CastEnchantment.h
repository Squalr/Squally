...
class CastEnchantment : public PlatformerAttack
{
public:
	static CastEnchantment* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastEnchantment(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastEnchantment();
