...
class CastCalcify : public PlatformerAttack
{
public:
	static CastCalcify* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastCalcify(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastCalcify();
