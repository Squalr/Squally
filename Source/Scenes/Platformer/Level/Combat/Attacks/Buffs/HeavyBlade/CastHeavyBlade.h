...
class CastHeavyBlade : public PlatformerAttack
{
public:
	static CastHeavyBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastHeavyBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastHeavyBlade();
