...
class CastFocus : public PlatformerAttack
{
public:
	static CastFocus* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastFocus(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastFocus();
