...
class CastFury : public PlatformerAttack
{
public:
	static CastFury* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastFury(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastFury();
