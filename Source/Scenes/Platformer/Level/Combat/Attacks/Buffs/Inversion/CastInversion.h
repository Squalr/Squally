...
class CastInversion : public PlatformerAttack
{
public:
	static CastInversion* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastInversion(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastInversion();
