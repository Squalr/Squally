...
class CastVampirism : public PlatformerAttack
{
public:
	static CastVampirism* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastVampirism(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastVampirism();
