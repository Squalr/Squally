...
class CastEnflame : public PlatformerAttack
{
public:
	static CastEnflame* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastEnflame(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastEnflame();
