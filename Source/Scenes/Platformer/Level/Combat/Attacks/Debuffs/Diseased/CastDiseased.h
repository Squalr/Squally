...
class CastDiseased : public PlatformerAttack
{
public:
	static CastDiseased* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastDiseased(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastDiseased();
