...
class CastUnholyBlade : public PlatformerAttack
{
public:
	static CastUnholyBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastUnholyBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastUnholyBlade();
