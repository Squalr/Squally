...
class CastBloodletting : public PlatformerAttack
{
public:
	static CastBloodletting* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastBloodletting(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastBloodletting();
