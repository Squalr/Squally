...
class CastBrokenBlade : public PlatformerAttack
{
public:
	static CastBrokenBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastBrokenBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastBrokenBlade();
