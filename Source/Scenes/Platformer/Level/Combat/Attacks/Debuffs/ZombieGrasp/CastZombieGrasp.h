...
class CastZombieGrasp : public PlatformerAttack
{
public:
	static CastZombieGrasp* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastZombieGrasp(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastZombieGrasp();
