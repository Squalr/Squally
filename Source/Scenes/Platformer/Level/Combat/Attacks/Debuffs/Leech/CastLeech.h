...
class CastLeech : public PlatformerAttack
{
public:
	static CastLeech* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastLeech(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastLeech();
