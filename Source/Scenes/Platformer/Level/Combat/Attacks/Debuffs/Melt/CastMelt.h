...
class CastMelt : public PlatformerAttack
{
public:
	static CastMelt* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastMelt(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastMelt();
