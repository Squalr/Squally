...
class CastHex : public PlatformerAttack
{
public:
	static CastHex* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastHex(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastHex();
