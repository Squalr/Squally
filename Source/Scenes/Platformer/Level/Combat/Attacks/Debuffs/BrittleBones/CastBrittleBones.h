...
class CastBrittleBones : public PlatformerAttack
{
public:
	static CastBrittleBones* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastBrittleBones(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastBrittleBones();
