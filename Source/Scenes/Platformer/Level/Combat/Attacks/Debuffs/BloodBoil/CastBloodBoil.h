...
class CastBloodBoil : public PlatformerAttack
{
public:
	static CastBloodBoil* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastBloodBoil(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastBloodBoil();
