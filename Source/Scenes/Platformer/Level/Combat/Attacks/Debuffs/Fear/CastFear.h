...
class CastFear : public PlatformerAttack
{
public:
	static CastFear* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastFear(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastFear();
