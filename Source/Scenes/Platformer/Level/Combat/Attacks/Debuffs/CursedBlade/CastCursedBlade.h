...
class CastCursedBlade : public PlatformerAttack
{
public:
	static CastCursedBlade* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastCursedBlade(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastCursedBlade();
