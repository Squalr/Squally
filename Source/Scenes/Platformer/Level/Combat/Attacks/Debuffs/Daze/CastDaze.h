...
class CastDaze : public PlatformerAttack
{
public:
	static CastDaze* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastDaze(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastDaze();
