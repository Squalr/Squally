...
class CastPoisonedArrows : public PlatformerAttack
{
public:
	static CastPoisonedArrows* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastPoisonedArrows(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastPoisonedArrows();
