...
class CastDeadGrasp : public PlatformerAttack
{
public:
	static CastDeadGrasp* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastDeadGrasp(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastDeadGrasp();
