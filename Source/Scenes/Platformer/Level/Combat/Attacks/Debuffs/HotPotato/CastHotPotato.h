...
class CastHotPotato : public PlatformerAttack
{
public:
	static CastHotPotato* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastHotPotato(float attackDuration, float recoverDuration, Priority priority);
	virtual ~CastHotPotato();
