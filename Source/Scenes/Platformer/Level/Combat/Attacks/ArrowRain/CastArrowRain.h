...
{
public:
	static CastArrowRain* create(float attackDuration, float recoverDuration, Priority priority);
...
protected:
	CastArrowRain(float attackDuration, float recoverDuration, Priority priority);
