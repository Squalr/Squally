...
#include "Scenes/Platformer/Level/Combat/Attacks/Debuffs/PoisonedArrows/CastPoisonedArrows.h"
...
void HunterCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastPoisonedArrows::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
