...
#include "Scenes/Platformer/Level/Combat/Attacks/Abilities/MultiShot2/MultiShot2.h"
...
void HunterCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(MultiShot2::create(3, 5, 0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
