#include "ZombieElricCombatBehavior.h"
...
const std::string ZombieElricCombatBehavior::MapKey = "zombie-elric-combat";

ZombieElricCombatBehavior* ZombieElricCombatBehavior::create(GameObject* owner)
{
	ZombieElricCombatBehavior* instance = new ZombieElricCombatBehavior(owner);
...
ZombieElricCombatBehavior::ZombieElricCombatBehavior(GameObject* owner) : super(owner)
{
...
ZombieElricCombatBehavior::~ZombieElricCombatBehavior()
{
}

void ZombieElricCombatBehavior::initializePositions()
{
}

void ZombieElricCombatBehavior::onLoad()
{
	super::onLoad();
