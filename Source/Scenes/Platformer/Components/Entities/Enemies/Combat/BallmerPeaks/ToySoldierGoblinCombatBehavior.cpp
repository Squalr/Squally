#include "ToySoldierGoblinCombatBehavior.h"
...
const std::string ToySoldierGoblinCombatBehavior::MapKey = "toy-soldier-goblin-combat";

ToySoldierGoblinCombatBehavior* ToySoldierGoblinCombatBehavior::create(GameObject* owner)
{
	ToySoldierGoblinCombatBehavior* instance = new ToySoldierGoblinCombatBehavior(owner);
...
ToySoldierGoblinCombatBehavior::ToySoldierGoblinCombatBehavior(GameObject* owner) : super(owner)
{
...
ToySoldierGoblinCombatBehavior::~ToySoldierGoblinCombatBehavior()
{
}

void ToySoldierGoblinCombatBehavior::initializePositions()
{
}

void ToySoldierGoblinCombatBehavior::onLoad()
{
	super::onLoad();
