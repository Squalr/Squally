#include "VikingCombatBehavior.h"
...
const std::string VikingCombatBehavior::MapKey = "viking-combat";

VikingCombatBehavior* VikingCombatBehavior::create(GameObject* owner)
{
	VikingCombatBehavior* instance = new VikingCombatBehavior(owner);
...
VikingCombatBehavior::VikingCombatBehavior(GameObject* owner) : super(owner)
{
...
VikingCombatBehavior::~VikingCombatBehavior()
{
}

void VikingCombatBehavior::initializePositions()
{
}

void VikingCombatBehavior::onLoad()
{
	super::onLoad();
