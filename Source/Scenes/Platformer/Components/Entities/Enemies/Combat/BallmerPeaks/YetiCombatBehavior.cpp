...
const std::string YetiCombatBehavior::MapKey = "yeti-combat";

YetiCombatBehavior* YetiCombatBehavior::create(GameObject* owner)
{
	YetiCombatBehavior* instance = new YetiCombatBehavior(owner);
...
YetiCombatBehavior::YetiCombatBehavior(GameObject* owner) : super(owner)
{
...
YetiCombatBehavior::~YetiCombatBehavior()
{
}

void YetiCombatBehavior::initializePositions()
{
}

void YetiCombatBehavior::onLoad()
{
	super::onLoad();
