#include "GorillaCombatBehavior.h"
...
const std::string GorillaCombatBehavior::MapKey = "gorilla-combat";

GorillaCombatBehavior* GorillaCombatBehavior::create(GameObject* owner)
{
	GorillaCombatBehavior* instance = new GorillaCombatBehavior(owner);
...
GorillaCombatBehavior::GorillaCombatBehavior(GameObject* owner) : super(owner)
{
...
GorillaCombatBehavior::~GorillaCombatBehavior()
{
}

void GorillaCombatBehavior::initializePositions()
{
}

void GorillaCombatBehavior::onLoad()
{
	super::onLoad();
