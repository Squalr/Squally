#include "ScarecrowCombatBehavior.h"
...
const std::string ScarecrowCombatBehavior::MapKey = "scarecrow-combat";

ScarecrowCombatBehavior* ScarecrowCombatBehavior::create(GameObject* owner)
{
	ScarecrowCombatBehavior* instance = new ScarecrowCombatBehavior(owner);
...
ScarecrowCombatBehavior::ScarecrowCombatBehavior(GameObject* owner) : super(owner)
{
...
ScarecrowCombatBehavior::~ScarecrowCombatBehavior()
{
}

void ScarecrowCombatBehavior::initializePositions()
{
}

void ScarecrowCombatBehavior::onLoad()
{
	super::onLoad();
