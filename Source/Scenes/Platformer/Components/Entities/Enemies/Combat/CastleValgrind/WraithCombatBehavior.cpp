...
#include "Scenes/Platformer/Level/Combat/Attacks/Debuffs/Manifest/CastManifest.h"
...
void WraithCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastManifest::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
