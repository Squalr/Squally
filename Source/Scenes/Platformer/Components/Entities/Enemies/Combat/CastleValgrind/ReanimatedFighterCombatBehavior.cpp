...
#include "Scenes/Platformer/Level/Combat/Attacks/Debuffs/Diseased/CastDiseased.h"
...
void ReanimatedFighterCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastDiseased::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
