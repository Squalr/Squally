...
#include "Scenes/Platformer/Level/Combat/Attacks/Buffs/InnerFire/CastInnerFire.h"
...
void DemonGhostCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastInnerFire::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
