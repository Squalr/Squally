...
#include "Scenes/Platformer/Level/Combat/Attacks/Debuffs/BloodBoil/CastBloodBoil.h"
...
void DemonRogueCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastBloodBoil::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
