...
#include "Scenes/Platformer/Level/Combat/Attacks/Buffs/ArcaneProtection/CastArcaneProtection.h"
...
void WarlockCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastArcaneProtection::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
