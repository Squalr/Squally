...
#include "Scenes/Platformer/Level/Combat/Attacks/Buffs/BlessingOfTheAncients/CastBlessingOfTheAncients.h"
...
void SkeletalWarriorCombatBehavior::onLoad()
{
	...
	{
		attackBehavior->registerAttack(CastBlessingOfTheAncients::create(0.7f, EntityAttackBehavior::DefaultRecoverSpeed, PlatformerAttack::Priority::Guaranteed));
