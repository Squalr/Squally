...
#include "Strings/Menus/Hacking/ClippyHelp/SpeedGainMul.h"
...
void SpeedGainClippy::onEnterTransitionDidFinish()
{
	...
	this->speechBubble->runDialogue(Strings::Menus_Hacking_ClippyHelp_SpeedGainMul::create(), SoundResources::Platformer_Entities_Droid_DroidChatter, SpeechBubble::InfiniteDuration);
}
