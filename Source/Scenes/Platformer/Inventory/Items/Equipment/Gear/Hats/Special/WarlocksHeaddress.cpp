...
#include "Scenes/Platformer/Inventory/Items/Recipes/Gear/Hats/Special/WarlocksHeaddressPlans.h"
...
{
	return ItemResources::Equipment_Gear_Hats_Special_WarlocksHeaddress;
}
