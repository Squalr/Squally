...
#include "Scenes/Platformer/Inventory/Items/Recipes/Gear/Hats/Special/TheGoldenEaglePlans.h"
...
{
	return ItemResources::Equipment_Gear_Hats_Special_TheGoldenEagle;
}
