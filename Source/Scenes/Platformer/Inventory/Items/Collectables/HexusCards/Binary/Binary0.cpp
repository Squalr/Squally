...
Binary0::Binary0() : super(CurrencyInventory::create({{ IOU::getIOUIdentifier(), 2 }}), ItemMeta(3, 3))
{
}
...
const std::string& Binary0::getItemName()
{
...
const std::string& Binary0::getSerializationKey()
{
	return Binary0::SaveKey;
}
