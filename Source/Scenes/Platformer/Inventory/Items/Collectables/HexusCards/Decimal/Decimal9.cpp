...
Decimal9::Decimal9() : super(CurrencyInventory::create({{ IOU::getIOUIdentifier(), 11 }}), ItemMeta(3, 3))
{
}
...
const std::string& Decimal9::getItemName()
{
...
const std::string& Decimal9::getSerializationKey()
{
	return Decimal9::SaveKey;
}
