...
Decimal5::Decimal5() : super(CurrencyInventory::create({{ IOU::getIOUIdentifier(), 6 }}), ItemMeta(3, 3))
{
}
...
const std::string& Decimal5::getItemName()
{
...
const std::string& Decimal5::getSerializationKey()
{
	return Decimal5::SaveKey;
}
