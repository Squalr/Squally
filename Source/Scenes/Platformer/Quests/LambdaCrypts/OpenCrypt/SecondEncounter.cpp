...
const std::string SecondEncounter::MapKeyQuest = "second-encounter";

SecondEncounter* SecondEncounter::create(GameObject* owner, QuestLine* questLine)
{
	SecondEncounter* instance = new SecondEncounter(owner, questLine);
...
SecondEncounter::SecondEncounter(GameObject* owner, QuestLine* questLine) : super(owner, questLine, SecondEncounter::MapKeyQuest, false)
{
...
void SecondEncounter::onLoad(QuestState questState)
{
...
void SecondEncounter::onComplete()
{
}

void SecondEncounter::onSkipped()
{
	this->removeAllListeners();
}

void SecondEncounter::runCinematicSequenceStrikeZone()
{
	if (this->perceptron != nullptr)
	{
