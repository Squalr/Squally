...
TutorialEBehavior::TutorialEBehavior(GameObject* owner) : super(owner, SoundResources::Platformer_Entities_Generic_ChatterShort6, Strings::Platformer_Quests_EndianForest_HexusGauntlet_ComeToLearn::create())
{
}
