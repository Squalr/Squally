...
TutorialBBehavior::TutorialBBehavior(GameObject* owner) : super(owner, SoundResources::Platformer_Entities_Generic_ChatterShort2, false, Strings::Platformer_Quests_EndianForest_HexusGauntlet_ComeToLearn::create())
{
}
