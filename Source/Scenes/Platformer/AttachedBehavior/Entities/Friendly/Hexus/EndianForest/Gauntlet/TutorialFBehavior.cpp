...
TutorialFBehavior::TutorialFBehavior(GameObject* owner) : super(owner, SoundResources::Platformer_Entities_Generic_ChatterShort7, Strings::Platformer_Quests_EndianForest_HexusGauntlet_ComeToLearn::create())
{
}
