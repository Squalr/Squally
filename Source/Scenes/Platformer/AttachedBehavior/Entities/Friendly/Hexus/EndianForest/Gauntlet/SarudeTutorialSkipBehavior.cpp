...
SarudeTutorialSkipBehavior::SarudeTutorialSkipBehavior(GameObject* owner) : super(owner, SoundResources::Platformer_Entities_Generic_ChatterShort1, false, Strings::Platformer_Quests_EndianForest_HexusGauntlet_Sarude_IAcceptYourChallengeSkip::create())
{
}
