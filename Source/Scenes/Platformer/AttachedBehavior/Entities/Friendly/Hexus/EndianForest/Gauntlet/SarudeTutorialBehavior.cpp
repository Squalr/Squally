...
SarudeTutorialBehavior::SarudeTutorialBehavior(GameObject* owner) : super(owner, SoundResources::Platformer_Entities_Generic_ChatterShort1, Strings::Platformer_Dialogue_Hexus_IAcceptYourChallenge::create())
{
}
