#include "IceGolemCombatBehavior.h"
...
const std::string IceGolemCombatBehavior::MapKey = "ice-golem-combat";

IceGolemCombatBehavior* IceGolemCombatBehavior::create(GameObject* owner)
{
	IceGolemCombatBehavior* instance = new IceGolemCombatBehavior(owner);
...
IceGolemCombatBehavior::IceGolemCombatBehavior(GameObject* owner) : super(owner)
{
...
IceGolemCombatBehavior::~IceGolemCombatBehavior()
{
}

void IceGolemCombatBehavior::initializePositions()
{
}

void IceGolemCombatBehavior::onLoad()
{
	super::onLoad();
