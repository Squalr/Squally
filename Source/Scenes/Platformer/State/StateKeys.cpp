...
const std::string StateKeys::Eq = "STATE_KEY_EQ";
...
const std::string StateKeys::NotifyNewHelper = "STATE_KEY_NOTIFY_NEW_HELPER";
...
const std::string StateKeys::MovementX = "STATE_KEY_MOVEMENT_X";
