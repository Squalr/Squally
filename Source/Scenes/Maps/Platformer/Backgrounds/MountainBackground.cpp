...
{
	this->background = Sprite::create(BackgroundResources::Platformer_Day_Sky);
	this->clouds = InfiniteParallaxNode::create(BackgroundResources::Platformer_Day_Clouds_01);
	...
	Sprite* mountainSprite = Sprite::create(BackgroundResources::Platformer_Day_Mountains_01);
	...
	Sprite* mountainSprite2 = Sprite::create(BackgroundResources::Platformer_Day_Mountains_02);
	...
	Sprite* treesSprite1 = Sprite::create(BackgroundResources::Platformer_Day_Trees_01);
	...
	Sprite* treesSprite2 = Sprite::create(BackgroundResources::Platformer_Day_Trees_02);
	...
	Sprite* treesSprite3 = Sprite::create(BackgroundResources::Platformer_Day_Trees_03);
...
void MountainBackground::update(float dt)
{
	...
	this->mountains->runAction(MoveTo::create(0.0f, Vec2(-cameraPosition.x / 100.0f, this->mountains->getPosition().y)));
	this->mountains2->runAction(MoveTo::create(0.0f, Vec2(-cameraPosition.x / 80.0f, this->mountains2->getPosition().y)));
	this->trees1->runAction(MoveTo::create(0.0f, Vec2(-cameraPosition.x / 60.0f, this->trees1->getPosition().y)));
	this->trees2->runAction(MoveTo::create(0.0f, Vec2(-cameraPosition.x / 40.0f, this->trees2->getPosition().y)));
	this->trees3->runAction(MoveTo::create(0.0f, Vec2(-cameraPosition.x / 20.0f, this->trees3->getPosition().y)));
}
