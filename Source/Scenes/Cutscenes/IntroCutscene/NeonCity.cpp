...
NeonCity::NeonCity(NeonCityScene neonCityScene)
{
	...
	switch (this->activeScene)
	{
		...
		{
			//this->dialogue = DialogueLabel::create(StringResources::Dialogue_CutsceneNeonCity, LocalizedLabel::create(LocalizedLabel::FontStyle::Pixel, LocalizedLabel::FontSize::H3, Strings::Common_Constant::create()), Size(visibleSize.width - 48.0f, 256.0f - 48.0f));
			break;
		}
		case NeonCityScene::Return:
		{
			//this->dialogue = DialogueLabel::create(StringResources::Dialogue_CutsceneNeonCityReturn, LocalizedLabel::create(LocalizedLabel::FontStyle::Pixel, LocalizedLabel::FontSize::H3, Strings::Common_Constant::create()), Size(visibleSize.width - 48.0f, 256.0f - 48.0f));
			break;
		}
		case NeonCityScene::Singularity:
		{
			//this->dialogue = DialogueLabel::create(StringResources::Dialogue_CutsceneNeonCitySingularity, LocalizedLabel::create(LocalizedLabel::FontStyle::Pixel, LocalizedLabel::FontSize::H3, Strings::Common_Constant::create()), Size(visibleSize.width - 48.0f, 256.0f - 48.0f));
			break;
		}
	}
