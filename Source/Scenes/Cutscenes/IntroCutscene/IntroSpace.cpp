...
IntroSpace::IntroSpace()
{
	...
	//this->dialogue = DialogueLabel::create(StringResources::Dialogue_CutsceneIntroSpace, LocalizedLabel::create(LocalizedLabel::FontStyle::Pixel, LocalizedLabel::FontSize::H3, Strings::Common_Constant::create()), Size(visibleSize.width - 48.0f, 256.0f - 48.0f));
