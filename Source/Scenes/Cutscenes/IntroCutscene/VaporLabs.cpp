...
VaporLabs::VaporLabs()
{
	...
	this->dialogue = DialogueLabel::create(StringResources::Dialogue_CutsceneVaporLabs, LocalizedLabel::create(LocalizedLabel::FontStyle::Pixel, LocalizedLabel::FontSize::H3), Size(visibleSize.width - 48.0f, 256.0f - 48.0f));
