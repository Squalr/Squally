...
namespace MapResources
{
	...
	extern const std::string DaemonsHallow_Combat_Lava;
	...
	extern const std::string DaemonsHallow_Town_Inn;
	extern const std::string DaemonsHallow_Town_Inn_Upstairs;
	extern const std::string DaemonsHallow_Town_Main;
	...
	extern const std::string DaemonsHallow__Deprecated_Zone_1_1;
	extern const std::string DaemonsHallow__Deprecated_Zone_1_1_a;
	extern const std::string DaemonsHallow__Deprecated_Zone_2_4_idk;
