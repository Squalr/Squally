...
const std::string MapResources::DataMines_Home_Alder = "Public/Platformer/Maps/DataMines/Home_Alder.tmx";
...
const std::string MapResources::DataMines_Home_Mildred = "Public/Platformer/Maps/DataMines/Home_Mildred.tmx";
