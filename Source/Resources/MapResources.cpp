...
const std::string MapResources::EndianForest_Mages_Gauntlet_5 = "Public/Platformer/Maps/EndianForest/Mages_Gauntlet_5.tmx";
...
const std::string MapResources::EndianForest_Zone_2_6_old = "Public/Platformer/Maps/EndianForest/Zone_2_6_old.tmx";
