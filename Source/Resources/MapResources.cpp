...
const std::string MapResources::UnderflowRuins_Home_Geryon = "Public/Platformer/Maps/UnderflowRuins/Home_Geryon.tmx";
const std::string MapResources::UnderflowRuins_Home_Griffin = "Public/Platformer/Maps/UnderflowRuins/Home_Griffin.tmx";
