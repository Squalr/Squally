...
const std::string MapResources::FirewallFissure_Mages_Warp = "Public/Platformer/Maps/FirewallFissure/Mages_Warp.tmx";
...
const std::string MapResources::UnderflowRuins_Mages_Warp = "Public/Platformer/Maps/UnderflowRuins/Mages_Warp.tmx";
