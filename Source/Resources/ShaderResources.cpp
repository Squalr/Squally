...
const std::string ShaderResources::Fragment_Glow = "Shaders/Fragment/Glow.frag";
...
const std::string ShaderResources::Vertex_GrayBlur = "Shaders/Vertex/GrayBlur.vert";
const std::string ShaderResources::Vertex_Inverse = "Shaders/Vertex/Inverse.vert";
const std::string ShaderResources::Vertex_PassThrough = "Shaders/Vertex/PassThrough.vert";
