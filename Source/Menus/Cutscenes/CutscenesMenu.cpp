...
CutscenesMenu::CutscenesMenu()
{
	...
	this->credits->insert(this->buildEntry(ConstantString::create("AudibleScience")));
	this->credits->insert(this->buildEntry(ConstantString::create("Audioheart")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("Cooltello")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("Ghetty")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("jabameister")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("Mega_Loop")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("SatyrSound")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("SoundDD")));
	...
	this->credits->insert(this->buildEntry(ConstantString::create("Top-Up-Sounds")));
