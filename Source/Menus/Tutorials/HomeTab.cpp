...
HomeTab::HomeTab()
{
	this->disclaimer = LocalizedLabel::create(LocalizedLabel::FontStyle::Main, LocalizedLabel::FontSize::P, Strings::Menus_Tutorials_Home_Disclaimer::create(), CSize(640.0f, 0.0f));
