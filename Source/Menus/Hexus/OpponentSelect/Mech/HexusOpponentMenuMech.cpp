...
HexusOpponentMenuMech::HexusOpponentMenuMech() : super(NavigationEvents::NavigateHexusOpponentSelectArgs::Chapter::Mech, HexusChapterPreviewMech::SaveKeyChapterName)
{
