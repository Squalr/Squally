...
public:
  ...
  ASMJIT_INLINE bool isLabelValid(const AsmLabel& label) const noexcept {
  ...
  ASMJIT_INLINE bool isLabelBound(const AsmLabel& label) const noexcept {
  ...
  ASMJIT_INLINE intptr_t getLabelOffset(const AsmLabel& label) const noexcept {
  ...
  ASMJIT_INLINE LabelEntry* getLabelEntry(const AsmLabel& label) const noexcept {
